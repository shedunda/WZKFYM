...
namespace YSCMS.PlugIn.Passport
{
    /// <summary>
    /// 响应整合
    /// </summary>
    public class DPO_Reponse
    {
        ...
        void reguser()
        {
            ...
            YSCMS.Model.UserParam upi = User.UserParam("0");
            ...
            {
                ui.isMobile = 0;
                ui.MobileCode = YSCMS.CMS.YSSecurity.FDESEncrypt(Common.Rand.Str(8), 1);
            }
            else
            {
                ui.isMobile = 1;
        ...
        {
            GlobalUserInfo info;
            EnumLoginState state = new YSCMS.CMS.UserLogin().PersonLogin(username, password, out info);
        ...
        void update()
        {
            YSCMS.CMS.UserMisc userMisc = new UserMisc();
        ...
        void checkname()
        {
            YSCMS.IDAL.IUser dal =  DataAccess.CreateUser();
