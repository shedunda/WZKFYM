...
namespace YSCMS.Config
{
    ...
    {
        //public static readonly string CmsConString = ConfigurationManager.ConnectionStrings["yscms"].ConnectionString;
        ...
        public static string CmsConString
        {
            get
            {
                string tstr = ConfigurationManager.ConnectionStrings["yscms"].ConnectionString;
                if (YSCMS.Config.UIConfig.WebDAL.ToLower() == "yscms.accessdal")
                {
        ...
        public static readonly string TableNamePrefix = YSCMS.Config.UIConfig.dataRe;
    }
}
