...
namespace YSCMS.SQLServerDAL
{
	public class Pagination : DbBase, IPagination
	{
		...
		//频道管理列表
		protected string[] manage_news_site_list = { "Id", "Id,ChannelID,CName,EName,ChannCName,IsURL,isLock,Domain,ContrTF,ShowNaviTF", "News_site where isRecyle=0 and (ParentID='" + YSCMS.Global.Current.SiteID + "' or ChannelID='" + YSCMS.Global.Current.SiteID + "')", "order by Id desc" };
		...
		//protected string[] user_friend_friendmanage ={ "a.id", "a.id,a.HailFellow,a.FriendName,a.CreatTime,(select count(id) from " + YSCMS.Config.UIConfig.dataRe + "user_Friend b where b.HailFellow=a.UserNum) as CNT", "User_FriendClass a where a.UserNum=@UserNum or a.gdfz='1'", "order by a.Id desc" };
		...
		protected string[] manage_Sys_admin_list = { "a.Id", "a.Id,a.UserNum,b.RealName,b.Email,a.isSuper,a.isLock", "sys_admin a left join sys_User b  on a.UserNum=b.UserNum Where b.isAdmin=1 and a.SiteID='" + YSCMS.Global.Current.SiteID + "'", "order by a.Id desc" };
		...
		//地区管理
		protected string[] manage_user_arealist = { "id", "id,Cid,cityName,creatTime", "Sys_City where Pid='0' and SiteID='" + YSCMS.Global.Current.SiteID + "'", "order by OrderId desc,ID desc" };

		protected string[] manage_user_arealist_City = { "id", "id,Cid,cityName,creatTime", "Sys_City where Pid=@Cid and SiteID='" + YSCMS.Global.Current.SiteID + "'", "order by Id desc" };
		...
		//投稿后台
		protected string[] manage_Contribution_Constrchicklist = { "id", "id,ConID,Title,creatTime,UserNum,Source,Tags,Author,ispass,Contrflg", "User_Constr where substring(Contrflg,3,1) = '1' and isadmidel=0 and isCheck=1 and ispass=0 and SiteID='" + YSCMS.Global.Current.SiteID + "'", "order by Id desc" };

		protected string[] manage_Contribution_ConstrList = { "id", "id,ConID,Title,creatTime,Source,Tags,Contrflg,Author,ispass", "User_Constr where substring(Contrflg,3,1) = '1' and isadmidel=0 and isCheck=0 and ispass=0 and SiteID='" + YSCMS.Global.Current.SiteID + "'", "order by Id desc" };
		...
		//公告
		protected string[] manage_user_announce = { "id", "id,title,Content,creatTime,islock,getPoint,GroupNumber,SiteID", "user_news where SiteID='" + YSCMS.Global.Current.SiteID + "'", "order by Id Desc" };

		//好友验证
		protected string[] user_Requestinformation = { "id", "id,qUsername,bUsername,datatime,Content,ischick", "user_Requestinformation where bUsername='" + YSCMS.Global.Current.UserName + "' and ischick=1", "order by Id Desc" };
		...
		//稿酬级别
		protected string[] manage_Contribution_Constr_SetParamlist = { "id", "id,PCId,ConstrPayName,gPoint,iPoint,money,Gunit", "sys_ParmConstr where SiteID='" + YSCMS.Global.Current.SiteID + "'", "order by Id Desc" };

		//稿酬
		protected string[] manage_Contribution_paymentannals = { "id", "id,constrPayID,userNum,Money,payTime,PayAdmin", "user_constrPay where SiteID='" + YSCMS.Global.Current.SiteID + "'", "order by id Desc" };

		//logs 
		protected string[] user_manage_logs_1 = { "id", "id,logID,Title,Content,creatTime,dateNum,LogDateTime,UserNum,SiteID", "user_userlogs Where UserNum='" + YSCMS.Global.Current.UserNum + "'", "order by creatTime desc,id desc" };

		//网址收藏
		protected string[] user_info_url = { "id", "id,ClassID,URLName,URL,URLColor,CreatTime,Content", "user_URL where UserNum='" + YSCMS.Global.Current.UserNum + "'", "order by id desc" };

		protected string[] user_info_url_1 = { "id", "id,ClassID,URLName,URL,URLColor,CreatTime,Content", "user_URL where ClassID=@ClassID and UserNum='" + YSCMS.Global.Current.UserNum + "'", "order by id desc" };
		...
		protected string[] manage_user_discussclass_3 = { "id", "id,DcID,Cname,Content", "User_DiscussClass where indexnumber='0' and Cname like cast(@titlem as nvarchar) and SiteID='" + YSCMS.Global.Current.SiteID + "'", "order by Id desc" };
		...
		protected string[] manage_user_discuss_2 = { "id", "id,DisID,Cname,UserName,Creatime,Authoritymoney", "user_Discuss where Cname like cast(@titlem as nvarchar) and SiteID='" + YSCMS.Global.Current.SiteID + "'", "order by Id desc" };
		...
		protected string[] General_manage_1 = { "id", "id,Cname,gType,URL,EmailURL,isLock,SiteID", "news_Gen where SiteID='" + YSCMS.Global.Current.SiteID + "'", "order by ID desc" };

		protected string[] General_manage_2 = { "id", "id,Cname,gType,URL,EmailURL,isLock,SiteID", "news_Gen where SiteID='" + YSCMS.Global.Current.SiteID + "' and gType=@gType", "order by ID desc" };
		...
		//自由标签
		protected string[] manage_label_FreeLabel_List = { "id", "id,LabelID,LabelName,LabelSQL,StyleContent,Description,CreatTime,SiteID", "sys_LabelFree where SiteID='" + YSCMS.Global.Current.SiteID + "'", "order by ID desc" };
		//PSF
		protected string[] manage_publish_psf = { "id", "id,psfID,psfName,LocalDir,RemoteDir,isSub,CreatTime,isRecyle,SiteID", "sys_PSF where isRecyle=0 and SiteID='" + YSCMS.Global.Current.SiteID + "'", "order by ID desc" };
		//计划任务
		protected string[] manage_publish_siteTask = { "id", "id,taskID,TaskName,isIndex,ClassID,News,TimeSet,CreatTime,SiteID", "sys_SiteTask where SiteID='" + YSCMS.Global.Current.SiteID + "'", "order by ID desc" };

		protected string[] Manage_Stat_View_1 = { "id", "id,statid,classname", "stat_class where SiteID='" + YSCMS.Global.Current.SiteID + "'", "order by ID desc" };
		...
		//常规列表 
		protected string[] configuration_system_Genlist_1 = { "id", "Cname", "News_Gen where gType=@gType and isLock=0 and SiteID='" + YSCMS.Global.Current.SiteID + "'", "order by Id desc" };
		//友情连接------------------后台分类
		protected string[] manage_Friend_Friend_List_1 = { "id", "id,ClassID,ClassCName,Content", "friend_class where ParentID='0' and SiteID='" + YSCMS.Global.Current.SiteID + "'", "order by ID desc" };

		protected string[] manage_Friend_Friend_List_2 = { "id", "id,Name,ClassID,Type,Author,Url,Lock,isAdmin", "friend_link where SiteID='" + YSCMS.Global.Current.SiteID + "'", "order by ID desc" };
		//友情连接------------------前台
		protected string[] user_friend_friend = { "id", "id,Name,ClassID,Type,Author,Url,Lock,isAdmin", "friend_link where Author='" + YSCMS.Global.Current.UserNum + "'", "order by ID desc" };
		//归档
		...
		//调查
		protected string[] manage_survey_ManageVote = { "Rid", "Rid,IID,TID,OtherContent,VoteIp,VoteTime,UserNumber,SiteID", "vote_Manage where SiteID='" + YSCMS.Global.Current.SiteID + "'", "order by RID desc" };

		protected string[] manage_survey_setClass_1 = { "vid", "vid,ClassName,Description", "vote_Class WHERE SiteID='" + YSCMS.Global.Current.SiteID + "'", "order by vid desc" };

		protected string[] manage_survey_setClass_2 = { "vid", "vid,ClassName,Description", "vote_Class where VID like cast(@VID as nvarchar) and SiteID='" + YSCMS.Global.Current.SiteID + "'", "order by vid desc" };

		protected string[] manage_survey_setClass_3 = { "vid", "vid,ClassName,Description", "vote_Class where ClassName like cast(@ClassName as nvarchar) and SiteID='" + YSCMS.Global.Current.SiteID + "'", "order by vid desc" };

		protected string[] manage_survey_setClass_4 = { "vid", "vid,ClassName,Description", "vote_Class where Description like cast(@Description as nvarchar) and SiteID='" + YSCMS.Global.Current.SiteID + "'", "order by vid desc" };
		//调查选项
		protected string[] manage_survey_setItem_1 = { "TID", "TID,IID,ItemName,ItemValue,ItemMode,PicSrc,DisColor,VoteCount,ItemDetail", "vote_Item where TID like cast(@TID as nvarchar) and SiteID='" + YSCMS.Global.Current.SiteID + "'", "order by TID desc" };

		protected string[] manage_survey_setItem_2 = { "IID", "IID,TID,ItemName,ItemValue,ItemMode,PicSrc,DisColor,VoteCount,ItemDetail", "vote_Item where SiteID='" + YSCMS.Global.Current.SiteID + "'", "order by TID desc" };

		protected string[] manage_survey_setItem_3 = { "TID", "TID,IID,ItemName,ItemValue,ItemMode,PicSrc,DisColor,VoteCount,ItemDetail", "vote_Item where ItemName like cast(@ItemName as nvarchar) and SiteID='" + YSCMS.Global.Current.SiteID + "'", "order by TID desc" };

		protected string[] manage_survey_setItem_4 = { "TID", "TID,IID,ItemName,ItemValue,ItemMode,PicSrc,DisColor,VoteCount,ItemDetail", "vote_Item where ItemValue like cast(@ItemValue as nvarchar) and SiteID='" + YSCMS.Global.Current.SiteID + "'", "order by TID desc" };

		protected string[] manage_survey_setItem_5 = { "TID", "TID,IID,ItemName,ItemValue,ItemMode,PicSrc,DisColor,VoteCount,ItemDetail", "vote_Item where PicSrc like cast(@PicSrc as nvarchar) and SiteID='" + YSCMS.Global.Current.SiteID + "'", "order by TID desc" };

		protected string[] manage_survey_setItem_6 = { "TID", "TID,IID,ItemName,ItemValue,ItemMode,PicSrc,DisColor,VoteCount,ItemDetail", "vote_Item where DisColor like cast(@DisColor as nvarchar) and SiteID='" + YSCMS.Global.Current.SiteID + "'", "order by TID desc" };

		protected string[] manage_survey_setItem_7 = { "TID", "TID,IID,ItemName,ItemValue,ItemMode,PicSrc,DisColor,VoteCount,ItemDetail", "vote_Item where VoteCount like cast(@VoteCount as nvarchar) and SiteID='" + YSCMS.Global.Current.SiteID + "'", "order by TID desc" };

		protected string[] manage_survey_setItem_8 = { "TID", "TID,IID,ItemName,ItemValue,ItemMode,PicSrc,DisColor,VoteCount,ItemDetail", "vote_Item where ItemDetail like cast(@ItemDetail as nvarchar) and SiteID='" + YSCMS.Global.Current.SiteID + "'", "order by TID desc" };
		//多步投票管理
		protected string[] manage_survey_setSteps_1 = { "SID", "SID,TIDS,Steps,TIDU", "vote_Steps where SiteID='" + YSCMS.Global.Current.SiteID + "'", "order by sid desc" };

		protected string[] manage_survey_setSteps_2 = { "SID", "SID,TIDS,Steps,TIDU", "vote_Steps where SID like cast(@SID as nvarchar) and SiteID='" + YSCMS.Global.Current.SiteID + "'", "order by sid desc" };

		protected string[] manage_survey_setSteps_3 = { "SID", "SID,TIDS,Steps,TIDU", "vote_Steps where TIDS like cast(@TIDS as nvarchar) and SiteID='" + YSCMS.Global.Current.SiteID + "'", "order by sid desc" };

		protected string[] manage_survey_setSteps_4 = { "SID", "SID,TIDS,Steps,TIDU", "vote_Steps where Steps like cast(@Steps as nvarchar) and SiteID='" + YSCMS.Global.Current.SiteID + "'", "order by sid desc" };

		protected string[] manage_survey_setSteps_5 = { "SID", "SID,TIDS,Steps,TIDU", "vote_Steps where TIDU like cast(@TIDU as nvarchar) and SiteID='" + YSCMS.Global.Current.SiteID + "'", "order by sid desc" };
		//投票主题
		protected string[] manage_survey_setTitle_1 = { "TID", "TID,VID,Title,Type,MaxNum,DisMode,StartDate,EndDate,ItemMode", "vote_Title where SiteID='" + YSCMS.Global.Current.SiteID + "'", "order by TID desc" };

		protected string[] manage_survey_setTitle_2 = { "TID", "TID,VID,Title,Type,MaxNum,DisMode,StartDate,EndDate,ItemMode", "vote_Title where Title like cast(@Title as nvarchar) and SiteID='" + YSCMS.Global.Current.SiteID + "'", "order by TID desc" };

		protected string[] manage_survey_setTitle_3 = { "TID", "TID,VID,Title,Type,MaxNum,DisMode,StartDate,EndDate,ItemMode", "vote_Title where VID like cast(@VID as nvarchar) and SiteID='" + YSCMS.Global.Current.SiteID + "'", "order by TID desc" };

		protected string[] manage_survey_setTitle_4 = { "TID", "TID,VID,Title,Type,MaxNum,DisMode,StartDate,EndDate,ItemMode", "vote_Title where MaxNum like cast(@MaxNum as nvarchar) and SiteID='" + YSCMS.Global.Current.SiteID + "'", "order by TID desc" };

		protected string[] manage_survey_setTitle_5 = { "TID", "TID,VID,Title,Type,MaxNum,DisMode,StartDate,EndDate,ItemMode", "vote_Title where StartDate like cast(@StartDate as nvarchar) and SiteID='" + YSCMS.Global.Current.SiteID + "'", "order by TID desc" };

		protected string[] manage_survey_setTitle_6 = { "TID", "TID,VID,Title,Type,MaxNum,DisMode,StartDate,EndDate,ItemMode", "vote_Title where EndDate like cast(@EndDate as nvarchar) and SiteID='" + YSCMS.Global.Current.SiteID + "'", "order by TID desc" };

		protected string[] manage_survey_setTitle_7 = { "TID", "TID,VID,Title,Type,MaxNum,DisMode,StartDate,EndDate,ItemMode", "vote_Title where ItemMode like cast(@ItemMode as nvarchar) and SiteID='" + YSCMS.Global.Current.SiteID + "'", "order by TID desc" };
		//自定义字段
		protected string[] manage_Sys_DefineTable_Manage = { "DefineId", "DefineId,DefineInfoId,DefineName,ParentInfoId", "define_class where ParentInfoId='0' and SiteID='" + YSCMS.Global.Current.SiteID + "'", "order by DefineId desc" };
		//前台显示文章
		...
		public DataTable GetPage(string PageName, int PageIndex, int PageSize, out int RecordCount, out int PageCount, params SQLConditionInfo[] SqlCondition)
		{
			...
			string _dirName = YSCMS.Config.UIConfig.dirMana.ToLower();
