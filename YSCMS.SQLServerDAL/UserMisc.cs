...
namespace YSCMS.SQLServerDAL
{
    public class UserMisc : DbBase, IUserMisc
    {
        ...
        public DataTable calendar(string UserNum)
        {
            ...
            string Sql = "Select id,logID,Title,Content,userNum,LogDateTime From " + Pre + "user_userlogs Where (DATEDIFF(d, LogDateTime, getdate())<=datenum) and Usernum=@UserNum and SiteID='" + YSCMS.Global.Current.SiteID + "'";
...
new SqlParameter("@UserNum", UserNum)
        ...
        /// <returns></returns>
        private SqlParameter[] InsertManageMenuParameters2(YSCMS.Model.UserInfo7 uc1)
        {
        ...
        /// <param name="uc1"></param>
        /// <returns></returns>
        private SqlParameter[] InsertQMenuParameters(YSCMS.Model.UserInfo8 uc1)
        {
        ...
        /// <param name="uc1"></param>
        /// <returns></returns>
        private SqlParameter[] InsertQMenuParameters1(YSCMS.Model.UserInfo8 uc1)
        {
            SqlParameter[] param = new SqlParameter[4];
        ...
        /// <param name="uc"></param>
        /// <returns></returns>
        private SqlParameter[] GetUserInfoParameters(YSCMS.Model.UserInfo uc)
        {
        ...
        /// <param name="uc1"></param>
        /// <returns></returns>
        private SqlParameter[] GetUserInfoParameters1(YSCMS.Model.UserInfo1 uc1)
        {
        ...
        private SqlParameter[] GetUserInfoContactParameters1(YSCMS.Model.UserInfo2 uc1)
        {
        ...
        private SqlParameter[] GetUserInfoBaseStatParameters1(YSCMS.Model.UserInfo3 uc1)
        {
        ...
        /// <param name="uc1"></param>
        /// <returns></returns>
        private SqlParameter[] InsertGroupParameters(YSCMS.Model.UserInfo4 uc1)
        {
        ...
        /// <param name="uc1"></param>
        /// <returns></returns>
        private SqlParameter[] updateGroupEditParameters(YSCMS.Model.UserInfo4 uc1)
        {
        ...
        /// <param name="uc1"></param>
        /// <returns></returns>
        private SqlParameter[] GetAnnounceParameters(YSCMS.Model.UserInfo5 uc1)
        {
            SqlParameter[] param = new SqlParameter[9];
        ...
        /// <param name="uc1"></param>
        /// <returns></returns>
        private SqlParameter[] UpdateAnnounceParameters(YSCMS.Model.UserInfo5 uc1)
        {
        ...
        /// <param name="uc1"></param>
        /// <returns></returns>
        private SqlParameter[] insertCardRParameters(YSCMS.Model.IDCARD uc1)
        {
        ...
        /// <param name="uc1"></param>
        /// <returns></returns>
        private SqlParameter[] UpdateCardRParameters(YSCMS.Model.IDCARD uc1)
        {
            SqlParameter[] param = new SqlParameter[8];
        ...
        /// <param name="uc1"></param>
        /// <returns></returns>
        private SqlParameter[] UpdateOnlinePayParameters(YSCMS.Model.UserInfo6 uc1)
        {
            SqlParameter[] param = new SqlParameter[9];
