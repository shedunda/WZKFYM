...
namespace YSCMS.SQLServerDAL
{
    ...
    public partial class NewsGen : DbBase,INewsGen
    {
        ...
        public bool Exists(int id)
        {
            ...
            strSql.Append("select count(1) from ys_news_Gen");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into ys_news_Gen(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update ys_news_Gen set ");
        ...
        public bool Delete(int id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from ys_news_Gen ");
            strSql.Append(" where Id=@Id");
            SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
        ...
        public YSCMS.Model.NewsGen GetModel(int id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 Id,Cname,gType,URL,EmailURL,isLock,SiteID from ys_news_Gen ");
            strSql.Append(" where Id=@Id");
            SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
            ...
            YSCMS.Model.NewsGen model = new YSCMS.Model.NewsGen();
        ...
        public DataTable GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM ys_news_Gen ");
            if (strWhere.Trim() != "")
            {
