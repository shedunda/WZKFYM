...
namespace YSCMS.SQLServerDAL
{
    ...
    public partial class News : DbBase, INews
    {
        ...
        public void Copy_news(string ClassID, string sOrgNews, string NewsID, string FileName)
        {
            ...
            YSCMS.SQLServerDAL.NewsClass sNewclass = new NewsClass();
       ...
       /// <param name="NewsID">新闻的NewsID</param>
        ...
        /// <param name="uc"></param>
        /// <returns></returns>
        private SqlParameter[] insertNewsContentParameters(YSCMS.Model.News uc)
        {
        ...
        /// <param name="uc"></param>
        /// <returns></returns>
        private SqlParameter[] intsertTTParameters(YSCMS.Model.NewsContentTT uc)
        {
