...
namespace YSCMS.SQLServerDAL
{
    ...
    public partial class NewsClass : DbBase, INewsClass
    {
        ...
        {
            List<string> sqlArray = new List<string>();
            sqlArray.Add("delete from " + Pre + "news where SiteID=" + YSCMS.Global.Current.SiteID);
            sqlArray.Add("delete from " + Pre + "news_class where SiteID=" + YSCMS.Global.Current.SiteID);
            return DbHelper.ExecuteSqlTran(sqlArray);
        }
        ...
        public int SetClassAttribute(string classId, string classTemplet, string readNewTemplet, bool isUpdate)
        {
            ...
            if (classId.IndexOf(",") > -1)
            {
                ...
                {
                    sqlArray.Add("update " + Pre + "news_class set ClassTemplet='" + classTemplet + "',ReadNewsTemplet='" + readNewTemplet + "' where ClassId='" + id + "' and SiteID=" + YSCMS.Global.Current.SiteID);
                }
            }
            else
            {
                sqlArray.Add("update " + Pre + "news_class set ClassTemplet='" + classTemplet + "',ReadNewsTemplet='" + readNewTemplet + "' where ClassId='" + classId + "' and SiteID=" + YSCMS.Global.Current.SiteID);
            }
            return DbHelper.ExecuteSqlTran(sqlArray);
        }
        ...
        public int SetLock(string classId)
        {
            ...
            if (classId.IndexOf(",") > -1)
            {
                ...
                foreach (string id in classIds)
                {
                    sqlArray.Add("update " + Pre + "news_class set isLock=(case isLock when 1 then 0 when 0 then 1 end) where ClassId='" + id + "' and SiteID=" + YSCMS.Global.Current.SiteID);
                }
            }
            else
            {
                sqlArray.Add("update " + Pre + "news_class set isLock=(case isLock when 1 then 0 when 0 then 1 end) where ClassId='" + classId + "' and SiteID=" + YSCMS.Global.Current.SiteID);
            }
            return DbHelper.ExecuteSqlTran(sqlArray);
        }
        ...
        public int SetRecyle(string classId)
        {
            ...
            if (classId.IndexOf(",") > -1)
            {
                ...
                foreach (string id in classIds)
                {
                    sqlArray.Add("update " + Pre + "news_class set isRecyle=(case isRecyle when 1 then 0 when 0 then 1 end) where ClassId='" + id + "' and SiteID=" + YSCMS.Global.Current.SiteID);
                }
            }
            else
            {
                sqlArray.Add("update " + Pre + "news_class set isRecyle=(case isRecyle when 1 then 0 when 0 then 1 end) where ClassId='" + classId + "' and SiteID=" + YSCMS.Global.Current.SiteID);
            }
            return DbHelper.ExecuteSqlTran(sqlArray);
        }
        ...
        public int ClearNews(string classId)
        {
            ...
            if (classId.IndexOf(",") > -1)
            {
                ...
                foreach (string id in classIds)
                {
                    sqlArray.Add("delete from " + Pre + "news where ClassId='" + id + "' and SiteID=" + YSCMS.Global.Current.SiteID);
                }
            }
            else
            {
                sqlArray.Add("delete from " + Pre + "news where ClassId='" + classId + "' and SiteID=" + YSCMS.Global.Current.SiteID);
            }
            return DbHelper.ExecuteSqlTran(sqlArray);
        }
