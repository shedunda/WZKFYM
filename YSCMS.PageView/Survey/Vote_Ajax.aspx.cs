...
namespace YSCMS.PageView.Survey
{
    public partial class Vote_Ajax : YSCMS.PageBasic.BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            for (int k = 0; k < tids.Length; k++)
            {
                ...
                if (IsReg == 1 && YSCMS.Global.Current.IsTimeout())//是否注册判断
                {
                ...
                else
                {
                    ...
                    {
                        VuserNum = YSCMS.Global.Current.UserNum;
                    }
                    else
                    {
                        VuserNum = "guest";
