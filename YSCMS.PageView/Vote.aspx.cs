...
{
    public partial class Vote : YSCMS.PageBasic.BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (NewsID != string.Empty && NewsID != null)
            {
                ...
                {
                    string RandStr = YSCMS.Common.Rand.Number(3);
                    votelist += "<form id=\"VoteForm" + RandStr + "\" name=\"VoteForm\" method=\"post\" action=\"" + YSCMS.Common.Public.GetSiteDomain() + "/vote.aspx\">";
                    ...
                    votelist += "        $.get('" + YSCMS.Common.Public.GetSiteDomain() + "/vote.aspx?no-cache=' + Math.random() + '&' + Action, function(returnvalue){\r";
