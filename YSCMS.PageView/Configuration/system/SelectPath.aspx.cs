...
{
    public partial class SelectPath : YSCMS.PageBasic.DialogPage
    {
        public SelectPath()
        {
        ...
        private string str_dirFile = YSCMS.Config.UIConfig.dirHtml;  //获取图片或者文件路径
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (YSCMS.Global.Current.SiteID.Trim() == "0")
            {
                str_FilePath = Server.MapPath(str_dirMana + "\\" + str_dirFile);
            }
            else
            {
                string _sitePath = str_dirMana + "\\" + YSCMS.Config.UIConfig.dirSite + "\\" + YSCMS.Global.Current.SiteID.Trim() + "\\" + str_dirFile;
        ...
        protected string GetDirFile(string dir, string ParPath)
        {
            ...
            else
            {
                ...
                {
                    _str_dirFileTF = str_dirMana + "\\" + YSCMS.Config.UIConfig.dirSite + "\\" + YSCMS.Global.Current.SiteID.Trim() + "\\" + str_dirFile;
                }
