<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreateLabelClass.aspx.cs" Inherits="YSCMS.PageView.Configuration.system.CreateLabelClass" %>
...
<script language="javascript" type="text/javascript">
    ...
    function ReturnDivValue() {
        var CheckStr = true;
        var rvalue = "[YS:unLoop,YS:SiteID=<%Response.Write(APIID); %>,YS:LabelType=ReadClass";
        if ($('#ClassId').val() != '') {
            rvalue += ",YS:ClassID=" + $('#ClassId').val();
        }
