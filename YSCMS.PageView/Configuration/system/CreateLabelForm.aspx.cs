...
{
    public partial class CreateLabelForm : YSCMS.PageBasic.ManagePage
    {
        ...
        {
            int nRCount, nPCount;
            DataTable tb = YSCMS.CMS.Pagination.GetPage("manage_label_style_add.aspx", PageIndex, 20, out nRCount, out nPCount);
            //表单列表中表单类型绑定
