<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreateLabelSpecial.aspx.cs" Inherits="YSCMS.PageView.Configuration.system.CreateLabelSpecial" %>
...
<script language="javascript" type="text/javascript">
    ...
    function ReturnDivValue() {
        var CheckStr = true;
        var rvalue = "[YS:unLoop,YS:SiteID=<%Response.Write(APIID); %>,YS:LabelType=ReadSpecial";
        if ($('#ClassId').val() != '') {
            rvalue += ",YS:SpecialID=" + $('#ClassId').val();
        }
