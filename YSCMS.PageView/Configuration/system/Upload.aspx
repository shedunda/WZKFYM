<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Upload.aspx.cs" Inherits="YSCMS.PageView.Configuration.system.Upload" %>
...
<body>
	...
	<table width="100%" align="center" border="0" class="upload_tabtop" cellpadding="0" cellspacing="0" background="../../sysImages/<%Response.Write(YSCMS.Config.UIConfig.CssPath()); %>/admin/reght_1_bg_1.gif">
		<tr>
