<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreateLabelUltimate.aspx.cs" Inherits="YSCMS.PageView.Configuration.system.CreateLabelUltimate" %>
...
<script language="javascript" type="text/javascript">
    ...
    function ReturnDivValue() {
        ...
        var rvalue = "[YS:Loop,YS:SiteID=<%Response.Write(APIID); %>,YS:LabelType=ClassList";
        if (ListLabel.Root.value == "true")
        { temproot = "[#YS:StyleID=" + ListLabel.StyleID.value + "]"; }
        else {
            temproot = editor.html();
        }
        rvalue += ",YS:ListType=" + ListLabel.ListType.value;
        ...
        if (ListLabel.brTF.value == "true") {
            rvalue += ",YS:bfStr=" + ListLabel.bfstr.value;
        }
        ...
        //分页链接样式
        if (ListLabel.Current_txt_style.value != "" && ListLabel.Other_txt_style.value != "") { rvalue += ",YS:PageLinksCSS=" + ListLabel.Current_txt_style.value + "|" + ListLabel.Other_txt_style.value; }
        if(ListLabel.isPage.value=="true")
        { 
        if (ListLabel.PageID.value != "") { rvalue += "," + ListLabel.PageID.value; }
        }
        rvalue += "]";
        rvalue += temproot;
        rvalue += "[/YS:Loop]";
