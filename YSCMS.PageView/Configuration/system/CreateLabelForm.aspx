<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreateLabelForm.aspx.cs" Inherits="YSCMS.PageView.Configuration.system.CreateLabelForm" %>
        ...
        switch (document.ListForm.FormType.value) {
            case "SubForm":
                if (document.ListForm.FormType.value == "")
                    CheckStr = false;
                rvalue = "[YS:Loop,YS:SiteID=<%Response.Write(APIID); %>,YS:LabelType=" + document.ListForm.FormType.value;
                if (document.ListForm.FormID.value != "") { rvalue += ",YS:FormID=" + document.ListForm.FormID.value + ""; }
                if (document.ListForm.FormID.value == "")
                    CheckStr = false;
                if (document.ListForm.StyleID.value != "") {
                    temproot = "[#YS:StyleID=" + document.ListForm.StyleID.value + "]";
                }
                else {
                    CheckStr = false;
                }
            ...
            case "FormList":
                ...
                if (document.ListForm.FormType.value == "")
                    CheckStr = false;
                rvalue = "[YS:Loop,YS:SiteID=<%Response.Write(APIID); %>,YS:LabelType=" + document.ListForm.FormType.value;
                if (document.ListForm.FormNumber.value != "") { rvalue += ",YS:PageSize=" + document.ListForm.FormNumber.value + ""; }
                if (document.ListForm.FormTableName.value != "") { rvalue += ",YS:FormTableName=" + document.ListForm.FormTableName.value + ""; }
