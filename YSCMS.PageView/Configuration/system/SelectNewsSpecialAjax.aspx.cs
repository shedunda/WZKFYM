...
{
    public partial class SelectNewsSpecialAjax : YSCMS.PageBasic.DialogPage
    {
        ...
        string spstr()
        {
            ...
            while (rd.Read())
            {
                ...
                else
                {
                    ...
                    if (Validate_Session())
                    {
                        state = _UserLogin.CheckAdminAuthority("C019", rd["SpecialID"].ToString(), "", YSCMS.Global.Current.SiteID.Trim(), YSCMS.Global.Current.adminLogined);
                    }
