<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectPageStyle.aspx.cs" Inherits="YSCMS.PageView.Configuration.system.SelectPageStyle" %>
...
<script language="javascript" type="text/javascript">
    ...
    function ReturnPageValue() {
        ...
        rvalue = "";
        rvalue += "YS:PageStyle=" + document.PageInfo.PageStyle.value;
