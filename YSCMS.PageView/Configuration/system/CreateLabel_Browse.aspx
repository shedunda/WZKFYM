<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreateLabel_Browse.aspx.cs" Inherits="YSCMS.PageView.Configuration.system.CreateLabel_Browse" %>
...
<script language="javascript" type="text/javascript">
    ...
    function ReturnDivValue() {
        ...
        var rvalue = "[YS:unLoop,YS:SiteID=<%Response.Write(APIID); %>,YS:LabelType=ReadNews";
        if (ListLabel.Root.value == "true")
