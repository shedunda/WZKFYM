<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreateLabelLists.aspx.cs" Inherits="YSCMS.PageView.Configuration.system.CreateLabelLists" %>
...
<script type="text/javascript" language="javascript">
    ...
    function ReturnDivValue() {
        spanClear();
        var CheckStr = true;
        if (ListLabel.NewsType.value == "Special") {
            if (checkIsNull(ListLabel.SpecialID, document.getElementById("spanSpecialID"), "请选择专题栏目"))
                CheckStr = false;
        }
        ...
        if (checkIsNumber(ListLabel.Number, document.getElementById("spanNumber"), "循环数目只能为正整数"))
            CheckStr = false;
        if (checkIsNumber(ListLabel.ClickNumber, document.getElementById("spanClickNumber"), "点击次数只能为正整数"))
            CheckStr = false;
        ...
        if (checkIsNumber(ListLabel.Cols, document.getElementById("spanCols"), "每行显示条数只能为正整数"))
            CheckStr = false;
        if (checkIsNumber(ListLabel.MarqSpeed, document.getElementById("sapnMarqSpeed"), "滚动速度只能为正整数"))
            CheckStr = false;
        if (checkIsNumber(ListLabel.Marqwidth, document.getElementById("sapnMarqwidth"), "滚动宽度只能为正整数"))
            CheckStr = false;
        if (checkIsNumber(ListLabel.ColumnNumber, document.getElementById("SpanColumnNumber"), "条数只能为正整数"))
            CheckStr = false;
        ...
        if (checkIsNumber(ListLabel.ContentNumber, document.getElementById("spanContentNumber"), "内容截取字数只能为正整数"))
            CheckStr = false;
        if (checkIsNumber(ListLabel.NaviNumber, document.getElementById("spanNaviNumber"), "导读截取字数只能为正整数"))
            CheckStr = false;
        if (ListLabel.Root.value == "true") {
            if (checkIsNull(ListLabel.StyleID, document.getElementById("sapnStyleID"), "请选择样式"))
                CheckStr = false;
        }
        if (ListLabel.NewsType.value == "SubNews" && checkIsNull(ListLabel.ClassStyleID, document.getElementById("spanClassStyleID"), "请选择栏目样式"))
            CheckStr = false;
        //--------------------返回标签值
        var temproot = "";
        var rvalue = "[YS:Loop,YS:SiteID=<%Response.Write(SiteID); %>,YS:LabelType=List";
        ...
        rvalue += ",YS:NewsType=" + ListLabel.NewsType.value;
        if (ListLabel.NewsType.value == "Special")
        { rvalue += ",YS:SpecialID=" + ListLabel.SpecialID.value; }
        else
        { if (ListLabel.ClassId.value != "") { rvalue += ",YS:ClassID=" + ListLabel.ClassId.value } }
        if (ListLabel.SubNews.value != "") {
            rvalue += ",YS:SubNews=" + ListLabel.SubNews.value;
            if (ListLabel.SubNaviCSS.value != "") {
                rvalue += ",YS:SubNaviCSS=" + ListLabel.SubNaviCSS.value;
            }
        }
        ...
        if (ListLabel.tabCss.value != "") { rvalue += ",YS:TabCSS=" + ListLabel.tabCss.value; }
        ...
        if (ListLabel.HashNaviContent.value != "") { rvalue += ",YS:HashNaviContent=" + ListLabel.HashNaviContent.value; }
        ...
        if (ListLabel.ClickNumber.value != "") { rvalue += ",YS:ClickNumber=" + ListLabel.ClickNumber.value; }
        if (ListLabel.ShowDateNumer.value != "") { rvalue += ",YS:ShowDateNumer=" + ListLabel.ShowDateNumer.value; }
        if (ListLabel.ShowColumnNumber.value == "1") {
            if (ListLabel.ColumnNumber.value != "") {
                rvalue += ",YS:ColumnNumber=" + ListLabel.ColumnNumber.value;
            }
        }
        if (ListLabel.ShowColumn.value == "1") {
            if (ListLabel.ColumnCss.value != "") {
                rvalue += ",YS:ColumnCss=" + ListLabel.ColumnCss.value;
            }
            if (ListLabel.ColumnNewsCss.value != "") {
                rvalue += ",YS:ColumnNewsCss=" + ListLabel.ColumnNewsCss.value;
            }
        }
        ...
        if (ListLabel.css1.value != "" && ListLabel.css2.value != "") { rvalue += ",YS:ColbgCSS=" + ListLabel.css1.value + "|" + ListLabel.css2.value; }
        if (ListLabel.More.value != "") {
            rvalue += ",YS:More=" + ListLabel.More.value;
        }
        if (ListLabel.NewsType.value == "SubNews") {
            rvalue += ",YS:ClassStyleID=" + document.getElementById("ClassStyleID").value;
        }
        rvalue += "]";
        rvalue += temproot;
        rvalue += "[/YS:Loop]";
