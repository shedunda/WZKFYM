...
{
    public partial class Upload : YSCMS.PageBasic.DialogPage
    {
        public Upload()
        {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Type == "Upload")
            {
                ...
                string localSavedir = YSCMS.Config.UIConfig.dirFile;
                ...
                string localtemplet = YSCMS.Config.UIConfig.dirTemplet;
                string dimmdir = YSCMS.Config.UIConfig.dirDumm;
                string _Tmpdimmdir = "";
                string UDir = "";
                ...
                {
                    YSCMS.CMS.UpLoad tt = new YSCMS.CMS.UpLoad();   //实例化上传类
                    YSCMS.CMS.RootPublic up = new YSCMS.CMS.RootPublic();
                    ...
                    if (ReturnStr[1] == "1")
                    {
                        ...
                        if (upfiletype != "templets" && upfiletype != "DropTemplets")
                        {
                            ...
                            {
                                UDir = _Tmpdimmdir + "/" + YSCMS.Config.UIConfig.dirSite + "/" + YSCMS.Global.Current.SiteID + "/" + localSavedir + "/" + Server.UrlDecode(Request.QueryString["Path"]);
                            }
                            else
                            {
                            ...
                            //实现水印、缩图
                            YSCMS.CMS.YSImage fd = new YSCMS.CMS.YSImage(0, 0, Server.MapPath(_fileNamePath));
                            //判断是否生成缩略图
