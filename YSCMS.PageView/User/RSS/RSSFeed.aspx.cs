...
namespace YSCMS.PageView.User.RSS
{
    public partial class RSSFeed : YSCMS.PageBasic.BasePage
    {
        YSCMS.CMS.Rss rs = new YSCMS.CMS.Rss();
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                string Str_dirMana = YSCMS.Config.UIConfig.dirDumm;//虚拟目录
        ...
        protected void Showu_friendmanage(int PageIndex)
        {
            ...
            if (ParentID == "0" || ParentID == null)
            {
                ...
                dts = YSCMS.CMS.Pagination.GetPage("user_Rss_RssFeed_1_aspx", PageIndex, 20, out i, out j, st1);
            }
            else
            {
                ...
                dts = YSCMS.CMS.Pagination.GetPage("user_Rss_RssFeed_2_aspx", PageIndex, 20, out i, out j, st);
            }
