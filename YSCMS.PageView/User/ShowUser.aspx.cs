...
{
    public partial class ShowUser : YSCMS.PageBasic.BasePage
    {
        public string URL = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    string uID = pd.GetUserNameUserNum(YSCMS.Common.Input.Filter(u_name.ToString()));
                    if (uID == "0")
                    {
        ...
        protected string getinfo()
        {
            ...
            if (YSCMS.Global.Current.UserNum != "" && YSCMS.Global.Current.UserNum != null)
            {
                if (rd.getisAdmin() == 1)
                {
                    manageControl = "&nbsp;&nbsp;┊&nbsp;&nbsp;<a href=\"../" + YSCMS.Config.UIConfig.dirMana + "/index.aspx\" target=\"_top\" class=\"list_link\">管理中心</a>";
                }
                _STR += "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;欢迎您!&nbsp;<font color=\"red\">" + YSCMS.Global.Current.UserName + "</font>&nbsp;&nbsp;┊&nbsp;&nbsp;" + messageChar() + "&nbsp;&nbsp;┊&nbsp;&nbsp;<a href=\"index.aspx\" class=\"list_link\" target=\"_top\">会员中心</a>" + manageControl;
            }
            else
            {
