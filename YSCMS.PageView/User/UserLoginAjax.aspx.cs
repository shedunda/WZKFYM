...
{
    public partial class UserLoginAjax : YSCMS.PageBasic.BasePage
    {
        ...
        protected void UserOp()
        {
            ...
            switch (str_Type)
            {
                ...
                case "checkuser":
                    ...
                    Response.Write("1$$$" + YSCMS.Global.Current.UserName);
                    Response.End();
                    break;
                case "checkLogin":
                    checkLogin();
        ...
        protected string UserLoginTrue()
        {
            ...
            if (styleContent != null && styleContent != "")
            {
                try
                {
                    ...
                    User_Name = YSCMS.Global.Current.UserName;
                    guanli = "<a href=\"" + YSCMS.Common.Public.GetSiteDomain() + "/" + YSCMS.Config.UIConfig.dirUser + "/Index.aspx\" target=\"_blank\">会员中心</a>";
                    guanliAdr = YSCMS.Common.Public.GetSiteDomain() + "/" + YSCMS.Config.UIConfig.dirUser + "/Index.aspx";
                    if (str_LoginP != "true")
                    {
                        guanli = "<a href=\"" + YSCMS.Common.Public.GetSiteDomain() + "/" + YSCMS.Config.UIConfig.dirUser + "/Index.aspx\" target=\"_blank\">管理</a>";
                        guanliAdr = YSCMS.Common.Public.GetSiteDomain() + "/" + YSCMS.Config.UIConfig.dirUser + "/Index.aspx";
                    }
                    ziliao = "<a href=\"" + YSCMS.Common.Public.GetSiteDomain() + "/" + YSCMS.Config.UIConfig.dirUser + "/index.aspx?urls=" + YSCMS.Common.Public.GetSiteDomain() + "/" + YSCMS.Config.UIConfig.dirUser + "/info/userinfo.aspx\" target=\"_blank\">资料</a>";
                    ziliaoAdr = YSCMS.Common.Public.GetSiteDomain() + "/" + YSCMS.Config.UIConfig.dirUser + "/index.aspx?urls=" + YSCMS.Common.Public.GetSiteDomain() + "/" + YSCMS.Config.UIConfig.dirUser + "/info/userinfo.aspx";
                    taolunzu = "<a href=\"" + YSCMS.Common.Public.GetSiteDomain() + "/" + YSCMS.Config.UIConfig.dirUser + "/index.aspx?urls=" + YSCMS.Common.Public.GetSiteDomain() + "/" + YSCMS.Config.UIConfig.dirUser + "/discuss/discussManageestablish_list.aspx\" target=\"_blank\">讨论组</a>";
                    taolunzuAdr = YSCMS.Common.Public.GetSiteDomain() + "/" + YSCMS.Config.UIConfig.dirUser + "/index.aspx?urls=" + YSCMS.Common.Public.GetSiteDomain() + "/" + YSCMS.Config.UIConfig.dirUser + "/discuss/discussManageestablish_list.aspx";
            ...
            if (str_LoginP == "true")
            {
                ...
                str_UserLogin += "       欢迎 <span style=\"font-weight:bold;\">" + YSCMS.Global.Current.UserName + "</span> 再次登录！";
                str_UserLogin += "       <a href=\"" + YSCMS.Common.Public.GetSiteDomain() + "/" + YSCMS.Config.UIConfig.dirUser + "/Index.aspx\" target=\"_blank\">会员中心</a>";
                str_UserLogin += "       &nbsp;<a href=\"" + YSCMS.Common.Public.GetSiteDomain() + "/" + YSCMS.Config.UIConfig.dirUser + "/index.aspx?urls=" + YSCMS.Common.Public.GetSiteDomain() + "/" + YSCMS.Config.UIConfig.dirUser + "/info/userinfo.aspx\" target=\"_blank\">资料</a>";
                str_UserLogin += "       &nbsp;<a href=\"" + YSCMS.Common.Public.GetSiteDomain() + "/" + YSCMS.Config.UIConfig.dirUser + "/index.aspx?urls=" + YSCMS.Common.Public.GetSiteDomain() + "/" + YSCMS.Config.UIConfig.dirUser + "/message/Message_box.aspx?Id=1\" target=\"_blank\">消息</a>";
                str_UserLogin += "       &nbsp;<a href=\"" + YSCMS.Common.Public.GetSiteDomain() + "/" + YSCMS.Config.UIConfig.dirUser + "/index.aspx?urls=" + YSCMS.Common.Public.GetSiteDomain() + "/" + YSCMS.Config.UIConfig.dirUser + "/discuss/discussManageestablish_list.aspx\" target=\"_blank\">讨论组</a>";
            ...
            else
            {
                ...
                str_UserLogin += "   </div>" + newLine;
                str_UserLogin += "   <div style=\"text-align:center;\">" + newLine;
                str_UserLogin += "       &nbsp;<a href=\"" + YSCMS.Common.Public.GetSiteDomain() + "/" + YSCMS.Config.UIConfig.dirUser + "/Index.aspx\" target=\"_blank\">管理</a>";
                str_UserLogin += "       &nbsp;<a href=\"" + YSCMS.Common.Public.GetSiteDomain() + "/" + YSCMS.Config.UIConfig.dirUser + "/index.aspx?urls=" + YSCMS.Common.Public.GetSiteDomain() + "/" + YSCMS.Config.UIConfig.dirUser + "/info/userinfo.aspx\" target=\"_blank\">资料</a>";
                str_UserLogin += "       &nbsp;<a href=\"" + YSCMS.Common.Public.GetSiteDomain() + "/" + YSCMS.Config.UIConfig.dirUser + "/index.aspx?urls=" + YSCMS.Common.Public.GetSiteDomain() + "/" + YSCMS.Config.UIConfig.dirUser + "/message/Message_box.aspx?Id=1\" target=\"_blank\">消息</a>";
                str_UserLogin += "       &nbsp;<a href=\"" + YSCMS.Common.Public.GetSiteDomain() + "/" + YSCMS.Config.UIConfig.dirUser + "/index.aspx?urls=" + YSCMS.Common.Public.GetSiteDomain() + "/" + YSCMS.Config.UIConfig.dirUser + "/discuss/discussManageestablish_list.aspx\" target=\"_blank\">讨论组</a>";
                str_UserLogin += "       &nbsp;<a href=\"javascript:LoginOut();\">退出</a>";
        ...
        protected void UserLoginForm()
        {
            ...
            {
                RegstrCss = YSCMS.Common.Input.URLDecode(str_RegCSS);
            }
            string Passstr = "忘记密码";
            string PassstrCss = "";
            if (str_PassCSS != string.Empty && str_PassCSS != null)
            {
                PassstrCss = YSCMS.Common.Input.URLDecode(str_PassCSS);
            }
            ...
            if (styleContent != "")
            {
                try
                {
                    ...
                    RegLinkStr = "<span class=\"" + RegstrCss + "\"><a href=\"" + YSCMS.Common.Public.GetSiteDomain() + "/" + YSCMS.Config.UIConfig.dirUser + "/Register.aspx\" title=\"注册新用户\">" + Regstr + "</a></span>";
                    GetPassStr = "<span class=\"" + PassstrCss + "\"><a href=\"" + YSCMS.Common.Public.GetSiteDomain() + "/" + YSCMS.Config.UIConfig.dirUser + "/info/getPassword.aspx\" title=\"找回密码\">" + Passstr + "</a></span>"; ;
                    RegLinkAdrStr = YSCMS.Common.Public.GetSiteDomain() + "/" + YSCMS.Config.UIConfig.dirUser + "/Register.aspx";
                    GetPassAdrStr = YSCMS.Common.Public.GetSiteDomain() + "/" + YSCMS.Config.UIConfig.dirUser + "/info/getPassword.aspx";
            ...
            else
            {
                ...
                if (str_LoginCSS != string.Empty && str_LoginCSS != null)
                {
                    if (str_LoginCSS.IndexOf(".") > -1)
                    {
                        ...
                        {
                            imgsrc = YSCMS.Common.Public.GetSiteDomain() + "/" + str_LoginCSS;
                        }
                ...
                if (str_LoginP == "true")
                {
                    ...
                    str_UserLogin += "       <a href=\"" + YSCMS.Common.Public.GetSiteDomain() + "/" + YSCMS.Config.UIConfig.dirUser + "/info/getPassword.aspx\">" + Passstr + "</a>&nbsp;&nbsp;";
                    str_UserLogin += "       <a href=\"" + YSCMS.Common.Public.GetSiteDomain() + "/" + YSCMS.Config.UIConfig.dirUser + "/Register.aspx\">" + Regstr + "</a>";
                }
                else
                {
                    str_UserLogin += "   <div>" + newLine;
                    str_UserLogin += "       帐号：<input name=\"UserNum\" " + formCSS + " type=\"text\" size=\"10\" maxlength=\"20\" /> " + formlogin + " <span class=\"" + RegstrCss + "\"><a href=\"" + YSCMS.Common.Public.GetSiteDomain() + "/" + YSCMS.Config.UIConfig.dirUser + "/info/getPassword.aspx\">" + Passstr + "</a></span>";
                    str_UserLogin += "   </div>" + newLine;
                    str_UserLogin += "   <div>" + newLine;
                    str_UserLogin += "       密码：<input name=\"UserPwd\" " + formCSS + " type=\"password\" id=\"UserPwd\" size=\"10\" /> " + resetlogin + " <span class=\"" + PassstrCss + "\"><a href=\"" + YSCMS.Common.Public.GetSiteDomain() + "/" + YSCMS.Config.UIConfig.dirUser + "/Register.aspx\">" + Regstr + "</a></span>";
                    str_UserLogin += "   </div>" + newLine;
                }
                str_UserLogin += "</form>" + newLine;
