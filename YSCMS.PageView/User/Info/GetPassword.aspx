<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GetPassword.aspx.cs" Inherits="YSCMS.PageView.User.Info.GetPassword" %>
...
<head>
    ...
    <title>
<%Response.Write(YSCMS.Config.UIConfig.HeadTitle); %>__取回密码</title>
</head>
...
<div style="width:100%" id="topshow">
    ...
    <tr>
        <td style="width:30%;"><a href="http://www.yuesisoft.com" target="_blank"><img src="../images/conn_03.gif" border="0" /></a></td>
