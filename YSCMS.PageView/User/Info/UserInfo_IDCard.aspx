<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserInfo_IDCard.aspx.cs" Inherits="YSCMS.PageView.User.Info.UserInfo_IDCard" %>
 ...
 <script language="javascript" type="text/javascript">
     ...
     function setpic() {
         if ($('#f_IDcardFiles').val() == '') {
             ...
             $('#imgsrc').attr("src", $('#f_IDcardFiles').val().toLowerCase().replace('{@userdirfile}', '<% Response.Write(YSCMS.Config.UIConfig.UserdirFile); %>'));
            }
        }
