...
{
    public partial class Friend : YSCMS.PageBasic.UserPage
    {
        public DataTable dt_class;
        YSCMS.CMS.Info fl = new YSCMS.CMS.Info();
        ...
        {
            int i, j;
            DataTable dt = YSCMS.CMS.Pagination.GetPage("user_friend_friend_aspx", PageIndex, PAGESIZE, out i, out j, null);
        ...
        protected void StartPram()
        {
            ...
            {
                string Str_Content = YSCMS.Common.Input.ToTxt(dt_pram.Rows[0]["Content"].ToString());
...
public partial class user_friend_friend : YSCMS.PageBasic.UserPage
{
