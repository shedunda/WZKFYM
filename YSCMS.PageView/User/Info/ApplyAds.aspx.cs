...
{
    public partial class ApplyAds : YSCMS.PageBasic.UserPage
    {
        ...
        {
            int i, j;
            SQLConditionInfo st = new SQLConditionInfo("@CusID", YSCMS.Global.Current.UserNum);
            DataTable dt = YSCMS.CMS.Pagination.GetPage(this.GetType().Name, PageIndex, 20, out i, out j, st);
