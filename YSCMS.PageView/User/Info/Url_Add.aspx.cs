...
{
    public partial class Url_Add : YSCMS.PageBasic.UserPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (ID != null && ID != string.Empty)
                {
                    ...
                    DataTable dts = rd.getClassList(YSCMS.Global.Current.UserNum);
                    if (dts != null)
                    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            if (IsPostBack)
            {
                string URLName = YSCMS.Common.Input.Htmls(this.URLName.Text);
