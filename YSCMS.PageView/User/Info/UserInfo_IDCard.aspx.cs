...
{
    public partial class UserInfo_IDCard : YSCMS.PageBasic.UserPage
    {
        public UserInfo_IDCard()
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (dt != null)
                {
                    ...
                    if (typestr != "" && typestr != null)
                    {
                        ...
                        {
                            f1 = "1";
                            isCertstat.InnerHtml = "<table width=\"98%\" border=\"0\" cellpadding=\"8\" cellspacing=\"0\" class=\"table\" align=\"center\"><tr><td align=\"center\"><img src=\"" + dt.Rows[0]["IDcardFiles"].ToString().ToLower().Replace("{@userdirfile}", YSCMS.Config.UIConfig.UserdirFile) + "\" border=\"0\" /></td></tr></table>";
                        }
                        else
                        {
        ...
        {
            string f_IDcardFiles = YSCMS.Common.Input.Htmls(Request.Form["f_IDcardFiles"]);
