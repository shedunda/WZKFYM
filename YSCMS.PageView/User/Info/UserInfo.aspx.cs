...
{
    public partial class UserInfo : YSCMS.PageBasic.UserPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string strUserNum = "";
            if (u_sql != "" && u_sql != null) { strUserNum = YSCMS.Common.Input.Filter(u_sql.ToString()); }
            else { strUserNum = YSCMS.Global.Current.UserNum; }
            ...
            if (dt != null)
            {
                ...
                {
                    #region 基本资料--------------------------------------
                    string userflag = pd.GetGroupNameFlag(YSCMS.Global.Current.UserNum);
                    ...
                    {
                        this.UserFacex.ImageUrl = dt.Rows[0]["UserFace"].ToString().Replace("{@userdirfile}", YSCMS.Config.UIConfig.UserdirFile);//头像 
