...
{
    public partial class GetPoint : YSCMS.PageBasic.UserPage
    {
        ...
        protected void insert_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                ...
                string Number = YSCMS.Common.Input.Filter(Request.Form["CardNumber"].ToString());

                string passwords = YSCMS.Common.Input.Filter(Request.Form["CardPassWord"].ToString());
                string password = YSCMS.CMS.YSSecurity.FDESEncrypt(passwords, 1);
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    if ((CardNumber == Number) && (CardPassWord == password))
                                    {
                                        ...
                                        this.cz.Text = YSCMS.Common.Input.Filter(Request.Form["CardNumber"]);
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string GhID = YSCMS.Common.Rand.Number(12);
