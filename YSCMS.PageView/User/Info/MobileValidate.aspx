<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MobileValidate.aspx.cs" Inherits="YSCMS.PageView.User.Info.MobileValidate" %>
...
<head>
    ...
    <title>
<%Response.Write(YSCMS.Config.UIConfig.HeadTitle); %>__验证手机</title>
