...
{
    public partial class MyCom : YSCMS.PageBasic.UserPage
    {
        YSCMS.CMS.Info inf = new YSCMS.CMS.Info();
        YSCMS.CMS.Mycom my = new YSCMS.CMS.Mycom();
        ...
        protected void StartLoad(int PageIndex, string title, string Um, string dtm1, string dtm2, string isCheck, string islock)
        {
            ...
            if (Request.QueryString["UserNum"] != null && Request.QueryString["UserNum"] != "")
            {
                ...
                if (getName != YSCMS.Global.Current.UserName)
                {
                    UserNum = YSCMS.Global.Current.UserName;
                }
                else
                {
                    UserNum = getName;
            ...
            string UserNums1 = YSCMS.Global.Current.UserNum;
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                ...
                foreach (DataRow h in dt.Rows)
                {
                    ...
                    if ((h["UserNum"].ToString() == YSCMS.Global.Current.UserName))
                    {
            ...
            {
                string UserNums = YSCMS.Global.Current.UserNum;
        ...
        protected void PDel()
        {
            DataTable dt3 = my.sel_4(my.sel_3(YSCMS.Global.Current.UserNum).ToString());
        ...
        string Show_scs()
        {
            string scs = "<a href=\"mycom.aspx\" class=\"topnavichar\">全部评论</a>&nbsp;&nbsp;&nbsp;<a href=\"mycom.aspx?UserNum=" + YSCMS.Global.Current.UserNum + "\" class=\"topnavichar\">我的评论</a>&nbsp;&nbsp;&nbsp;<a href=\"javascript:opencats()\" class=\"topnavichar\">搜　索</a>&nbsp;&nbsp;&nbsp;<a href=\"javascript:PDel();\" class=\"topnavichar\">批量删除</a>";
            return scs;
        }
        string Show_sc()
        {
            string sc = "<a href=\"mycom.aspx\" class=\"topnavichar\">全部评论</a>&nbsp;&nbsp;&nbsp;<a href=\"mycom.aspx?UserNum=" + YSCMS.Global.Current.UserNum + "\" class=\"topnavichar\">我的评论</a>&nbsp;&nbsp;&nbsp;<a href=\"javascript:opencats()\" class=\"topnavichar\">搜　索</a>";
            return sc;
        }
        /// <summary>
        /// 固顶
