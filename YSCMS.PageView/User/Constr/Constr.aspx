<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Constr.aspx.cs" Inherits="YSCMS.PageView.User.Constr.Constr" %>
...
<script src="/controls/kindeditor/lang/zh_CN.js" type="text/javascript"></script>
	<script type="text/javascript">
	    ...
	    function ivurl() {
	        ...
	        if (gvalur != "") {
	            if (gvalur.indexOf(".") > -1) {
	                gvalur = gvalur.toLowerCase().replace('{@dirfile}', '<% Response.Write(YSCMS.Config.UIConfig.dirFile); %>')
				    ...
				    content = content.replace('{@dirfile}', '<% Response.Write(YSCMS.Config.UIConfig.dirFile); %>');
					content = content.replace('{@userdirfile}', '<% Response.Write(YSCMS.Config.UIConfig.UserdirFile); %>');
...
<div  class="main_big">
			...
			<td class="list_link" colspan="5" style="width: 750px; height: 250px; padding:10px;">
				...
				<script type="text/javascript" language="JavaScript">
				    function insertHTMLEdit(url) {
					    ...
					    urls = url.replace('{@userdirfile}', '<% Response.Write(YSCMS.Config.UIConfig.UserdirFile); %>')
	...
	<table width="100%" height="74" border="0" cellpadding="0" cellspacing="0" class="copyright_bg">
		<tr>
			<td>
				<div align="center">
					<%Response.Write(this.CopyRight); %></div>
			</td>
		</tr>
	</table>
	</form>
