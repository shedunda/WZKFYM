...
{
    public partial class Index : YSCMS.PageBasic.BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (adConfig.isAdapt)
                {
                    ...
                    //else
                    //{
                    //    checkveriframe.InnerHtml = "<iframe style=\"width:98%;height:20px;\" frameborder=\"no\" border=\"0\" marginwidth=\"0\" marginheight=\"0\" scrolling=\"no\" src=\"" + YSCMS.Config.verConfig.getyuesiURL + "\"></iframe>";
                    //}
