...
{
    public partial class DiscussPhoto_UP : YSCMS.PageBasic.UserPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (dt_photo.Rows[0]["UserNum"].ToString() != YSCMS.Global.Current.UserNum)
                {
                ...
                no.InnerHtml = Show_no(dt_photo.Rows[0]["PhotoUrl"].ToString().Replace("{@UserdirFile}", YSCMS.Config.UIConfig.dirDumm + "/" + YSCMS.Config.UIConfig.UserdirFile));
            }
        }
        protected void server_Click(object sender, EventArgs e)
        {
            ...
            string PhotoIDsa = YSCMS.Common.Input.Filter(Request.QueryString["PhotoID"].ToString());
        ...
        {
            string nos = "<td class=\"list_link\" ><img src=\"" + YSCMS.Common.Public.GetSiteDomain() + pURL + "\" width=\"90\" height=\"90\" id=\"pic_p_1\" /></td>";
            return nos;
        }
