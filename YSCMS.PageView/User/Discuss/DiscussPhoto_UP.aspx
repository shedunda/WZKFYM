<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DiscussPhoto_UP.aspx.cs" Inherits="YSCMS.PageView.User.Discuss.DiscussPhoto_UP" %>
...
<script type="text/javascript" language="javascript">
    ...
    function pics_1() {
        if ($('pic_p_1url').value == '') {
            ...
            $('pic_p_1').src = "<% Response.Write(YSCMS.Common.Public.GetSiteDomain()); %>" + $('pic_p_1url').value.replace('{@UserdirFile}', '<% Response.Write(YSCMS.Config.UIConfig.UserdirFile); %>')
			}
        }
        function dels_1() {
