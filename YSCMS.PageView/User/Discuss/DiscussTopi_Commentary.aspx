<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DiscussTopi_Commentary.aspx.cs" Inherits="YSCMS.PageView.User.Discuss.DiscussTopi_Commentary" %>
...
<td class="list_link">
 ...
 <script type="text/javascript" language="JavaScript">
     window.onload = function () {
         ...
         oFCKeditor.ToolbarSet = 'YSCMS_User';
