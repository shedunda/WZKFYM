...
{
    public partial class DiscussPhotoAlbum_UP : YSCMS.PageBasic.UserPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string DisIDs = YSCMS.Common.Input.Filter(Request.QueryString["DisID"].ToString());
            string PhotoalbumIDsa = YSCMS.Common.Input.Filter(Request.QueryString["PhotoalbumID"].ToString());
            if (dis.sel_28(PhotoalbumIDsa) != YSCMS.Global.Current.UserNum)
            {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                ...
                string PhotoalbumIDs = YSCMS.Common.Input.Filter(Request.QueryString["PhotoalbumID"].ToString());
                string PhotoalbumName = YSCMS.Common.Input.Filter(Request.Form["PhotoalbumName"].ToString());
                string DisIDs = YSCMS.Common.Input.Filter(Request.QueryString["DisID"].ToString());
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            {
                oldpwds = YSCMS.Common.Input.MD5(YSCMS.Common.Input.Filter(Request.Form["oldpwd"].ToString()), true);
            }
            newpwds = YSCMS.Common.Input.MD5(YSCMS.Common.Input.Filter(Request.Form["newpwd"].ToString()), true);
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            {
                newpwds = YSCMS.Common.Input.MD5(YSCMS.Common.Input.Filter(Request.Form["pwd"].ToString()), true);
            }
            if (pho.Update_2(newpwds, PhotoalbumIDs) != 0)
            {
                PageRight("修改成功", "discussPhotoalbumlist.aspx?DisID=" + DisIDs + "");
