<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DiscussPhotoAlbum.aspx.cs" Inherits="YSCMS.PageView.User.Discuss.DiscussPhotoAlbum" %>
...
<table width="98%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF" class="table" id="insert">
  ...
  <tr class="TR_BG_list">
    ...
    <td class="list_link" width="25%" style="text-align: right" >
        密码：</td>
    <td class="list_link" width="75%">
        <asp:TextBox ID="TextBox1" runat="server" Width="242px" Height="18px" TextMode="Password" CssClass="form"></asp:TextBox>&nbsp;
    ...
    <td class="list_link" width="25%" style="text-align: right">
        确认密码：</td>
    <td class="list_link" width="75%">
        <asp:TextBox ID="TextBox2" runat="server" Width="242px" Height="18px" TextMode="Password" CssClass="form"></asp:TextBox>&nbsp;
