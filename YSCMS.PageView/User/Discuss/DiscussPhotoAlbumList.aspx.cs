...
{
    public partial class DiscussPhotoAlbumList : YSCMS.PageBasic.UserPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataTable dt = dis.sel(YSCMS.Global.Current.UserNum);
        ...
        protected void Show_cjlist(int PageIndex2)
        {
            ...
            DataTable cjlistdts = YSCMS.CMS.Pagination.GetPage(this.GetType().Name, PageIndex2, 10, out ib, out jb, st);
            ...
            else
            {
                ...
                for (int i = 0; i < chSplit.Length; i++)
                {
                    if (chSplit[i] != "on")
                    {
                        ...
                        if (dt_pu.Rows[0]["UserName"].ToString() == YSCMS.Global.Current.UserNum)
                        {
...
public partial class user_discuss_discussPhotoalbumlist : YSCMS.PageBasic.UserPage
{
