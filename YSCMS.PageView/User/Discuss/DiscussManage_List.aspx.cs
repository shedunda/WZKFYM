...
{
    public partial class DiscussManage_List : YSCMS.PageBasic.UserPage
    {
        ...
        {
            int i, j;
            DataTable dts = YSCMS.CMS.Pagination.GetPage(this.GetType().Name, PageIndex, 10, out i, out j, null);
