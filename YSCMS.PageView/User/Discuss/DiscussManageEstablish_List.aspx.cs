...
{
    public partial class DiscussManageEstablish_List : YSCMS.PageBasic.UserPage
    {
        ...
        {
            int i, j;
            string cjUserName = YSCMS.Global.Current.UserName;
            SQLConditionInfo sts = new SQLConditionInfo("@UserName", cjUserName);
            DataTable cjlistdts = YSCMS.CMS.Pagination.GetPage(this.GetType().Name, PageIndex2, 10, out i, out j, sts);
