...
{
    public partial class DiscussPhotoClass : YSCMS.PageBasic.UserPage
    {
        ...
        protected void Show_jrlist(int PageIndex1)
        {
            ...
            DataTable jrlistdts = YSCMS.CMS.Pagination.GetPage(this.GetType().Name, PageIndex1, 10, out ia, out ja, st);
        ...
        protected void PDel()
        {
            ...
            else
            {
                ...
                for (int i = 0; i < chSplit.Length; i++)
                {
                    if (chSplit[i] != "on")
                    {
                        if (dis.sel_32(YSCMS.Global.Current.UserNum, chSplit[i]) != 0)
                        {
        ...
        {
            if (dis.sel_32(YSCMS.Global.Current.UserNum, ID) != 0)
            {
