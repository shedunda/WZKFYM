...
{
    public partial class DiscussActiJoin_List : YSCMS.PageBasic.UserPage
    {
        ...
        {
            int i, j;
            DataTable jrlistdts = YSCMS.CMS.Pagination.GetPage(this.GetType().Name, PageIndex1, 10, out i, out j, null);
