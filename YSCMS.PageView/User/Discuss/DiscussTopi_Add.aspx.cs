...
{
    public partial class DiscussTopi_Add : YSCMS.PageBasic.UserPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (dis.sel_30(DisIDs) != pd.GetUserName(YSCMS.Global.Current.UserNum))
                {
                    if (Authority1 == 0)
                    {
        ...
        protected void but1_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                ...
                if (YSCMS.Common.Input.IsDate(this.voteTime.Text))
                {
