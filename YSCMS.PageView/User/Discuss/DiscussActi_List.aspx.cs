...
{
    public partial class DiscussActi_List : YSCMS.PageBasic.UserPage
    {
        //联接数据库
        ...
        {
            int ig, js;
            DataTable dts = YSCMS.CMS.Pagination.GetPage(this.GetType().Name, PageIndex, 10, out ig, out js, null);
