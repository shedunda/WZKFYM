...
{
    public partial class UP_DiscussManage : YSCMS.PageBasic.UserPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                string DID = YSCMS.Common.Input.Filter(Request["DisID"].ToString());
        ...
        protected void but1_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                string Did = YSCMS.Common.Input.Filter(Request.QueryString["DisID"].ToString());
                string Cname = YSCMS.Common.Input.Htmls(Request.Form["CnameBox"].ToString());
                DateTime Creatime = DateTime.Now;

                string D_Content = YSCMS.Common.Input.Htmls(Request.Form["D_ContentBox"].ToString());
                string D_anno = YSCMS.Common.Input.Filter(Request.Form["D_annoBox"].ToString());
                string Authority = "";
                ...
                string gPoint = YSCMS.Common.Input.Filter(Request.Form["gPointBox"].ToString());
                string iPoint = YSCMS.Common.Input.Filter(Request.Form["iPointBox"].ToString());
