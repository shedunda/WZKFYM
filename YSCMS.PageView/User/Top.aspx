<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Top.aspx.cs" Inherits="YSCMS.PageView.User.Top" %>
  ...
  <div class="top">
    ...
    <div class="top_right">
      <div class="top_right_top">
        ...
        您好：<strong><%=YSCMS.Global.Current.UserName %></strong>！ | <a href="main.aspx" target="sys_main">用户中心</a> | 
