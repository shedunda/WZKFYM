<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShowPhoto.aspx.cs" Inherits="YSCMS.PageView.User.Show.ShowPhoto" %>
...
<head>
	...
	<title>
<%Response.Write(YSCMS.Config.UIConfig.HeadTitle); %>__相册</title>
	<link href="../../sysImages/<%Response.Write(YSCMS.Config.UIConfig.CssPath()); %>/css/divcss.css" rel="stylesheet" type="text/css" />
	<link href="../../sysImages/<%Response.Write(YSCMS.Config.UIConfig.CssPath()); %>/css/thickbox.css" rel="stylesheet" type="text/css" />
