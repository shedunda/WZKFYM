...
{
    public partial class ShowPhoto : YSCMS.PageBasic.BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                DataTable dt_phopwd = pho.sel(YSCMS.Common.Input.Filter(PhotoalbumID.ToString()));
        ...
        protected void Show_cjlist(int PageIndex2)
        {
            ...
            if (cjlistdts.Rows.Count > 0)
            {
                ...
                foreach (DataRow r in cjlistdts.Rows)
                {
                    ...
                    r["PhotoUrls"] = r["PhotoUrl"].ToString().Replace("{@userdirfile}", _dirDumm + YSCMS.Config.UIConfig.UserdirFile);
                }
