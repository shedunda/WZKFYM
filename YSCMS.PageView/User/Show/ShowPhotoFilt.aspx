<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShowPhotoFilt.aspx.cs" Inherits="YSCMS.PageView.User.Show.ShowPhotoFilt" %>
...
<title>
<%Response.Write(YSCMS.Config.UIConfig.HeadTitle); %>__幻灯</title>
</head>
