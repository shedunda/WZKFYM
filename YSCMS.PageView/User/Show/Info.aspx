<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Info.aspx.cs" Inherits="YSCMS.PageView.User.Show.Info" %>
...
<head>
    ...
    <title>
<%Response.Write(YSCMS.Config.UIConfig.HeadTitle); %>__用户查看</title>
