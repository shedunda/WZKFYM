<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShowContent.aspx.cs" Inherits="YSCMS.PageView.User.Show.ShowContent" %>
...
<head>
    ...
    <title>
<%Response.Write(YSCMS.Config.UIConfig.HeadTitle); %>__文章</title>
