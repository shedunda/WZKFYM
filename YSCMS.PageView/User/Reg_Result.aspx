<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Reg_Result.aspx.cs" Inherits="YSCMS.PageView.User.Reg_Result" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
	<title><%Response.Write(YSCMS.Config.UIConfig.HeadTitle); %>__注册结束</title>
...
<div style="width:100%" id="topshow">
    ...
    <tr>
        <td style="width:30%;"><a href="http://www.YSCMS.net" target="_blank"><img src="../sysImages/user/userlogo.gif" border="0" /></a></td>
