...
{
    public partial class Friend_Add : YSCMS.PageBasic.UserPage
    {
        ...
        protected void addfriend_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                ...
                //获取请求信息
                string Contentx = YSCMS.Common.Input.Filter(Request.Form["AddfriendContent"]);
                ...
                //获取被添加的好友用户名
                string bUserName = YSCMS.Common.Input.Filter(Request.Form["usernameBox"].ToString());
