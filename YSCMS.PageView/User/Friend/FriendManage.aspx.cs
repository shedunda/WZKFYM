...
{
    public partial class FriendManage : YSCMS.PageBasic.UserPage
    {
        ...
        protected void Showu_friendmanage(int PageIndex)
        {
            ...
            DataTable dts = YSCMS.CMS.Pagination.GetPage(this.GetType().Name, PageIndex, 10, out i, out j, sts);
            this.PageNavigator1.PageCount = j;
            this.PageNavigator1.PageIndex = PageIndex;
            this.PageNavigator1.RecordCount = i;
            YSCMS.CMS.Friend fr = new YSCMS.CMS.Friend();
            if (dts.Rows.Count > 0)
            {
