<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Main.aspx.cs" Inherits="YSCMS.PageView.User.Main" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title>
<%Response.Write(YSCMS.Config.UIConfig.HeadTitle); %>
</title>
...
<form id="Form1" runat="server">
  <table width="100%" height="30" class="matop_tab" border="0" cellpadding="0" cellspacing="0" background="../sysImages/<%Response.Write(YSCMS.Config.UIConfig.CssPath()); %>/admin/reght_1_bg.gif">
    <tr>
