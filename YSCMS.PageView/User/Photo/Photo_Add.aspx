<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Photo_Add.aspx.cs" Inherits="YSCMS.PageView.User.Photo.Photo_Add" %>
...
<script type="text/javascript" language="javascript">
    ...
    function pics_1() {
        if ($('pic_p_1url').value == '') {
            ...
            $('pic_p_1').src = $('pic_p_1url').value.replace('{@UserdirFile}', '<% Response.Write(UdirDumm); %><% Response.Write(YSCMS.Config.UIConfig.UserdirFile); %>');
			}
        }
        ...
        function pics_2() {
            if ($('pic_p_1ur2').value == '') {
                ...
                $('pic_p_2').src = $('pic_p_1ur2').value.replace('{@UserdirFile}', '/<% Response.Write(YSCMS.Config.UIConfig.dirDumm); %>/<% Response.Write(YSCMS.Config.UIConfig.UserdirFile); %>');
			}
        }
        ...
        function pics_3() {
            if ($('pic_p_1ur3').value == '') {
                ...
                $('pic_p_3').src = $('pic_p_1ur3').value.replace('{@UserdirFile}', '/<% Response.Write(YSCMS.Config.UIConfig.dirDumm); %>/<% Response.Write(YSCMS.Config.UIConfig.UserdirFile); %>');
			}
        }
