<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SendMail.aspx.cs" Inherits="YSCMS.PageView.SendMail" %>
...
<title><%Response.Write(YSCMS.Config.UIConfig.HeadTitle); %>发送给好友</title>
<style type="text/css">
/* CSS Document */
body {
	margin:10;
...
<div style="background-color:#EEEEEE;"><a href="http://www.yscms.net" target="_blank"><img src="sysImages/normal/logo.jpg" alt="powered by YSCMS Inc." width="207" border="0" /></a></div>
...
<div style="font-family:Verdana, Arial, Helvetica, sans-serif;font-size:10px;height:50px;text-align:center;"> Powered by 月思信息管理系统 v3.0 for Yuesi Information Technology Co., Ltd. website:www.yscmssoft.com </div>
</body>
</html>
