...
{
    public partial class Collect_NewsModify : YSCMS.PageBasic.ManagePage
    {
        ...
        protected void BtnOK_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                ...
                {
                    YSCMS.Common.MessageBox.Show(this, "标题不能为空!");
                }
                if (TxtLink.Text.Trim().Equals(""))
                {
                    YSCMS.Common.MessageBox.Show(this, "链接地址不能为空!");
                }
                if (this.EdtContent.Value.Trim().Equals(""))
                {
                    YSCMS.Common.MessageBox.ShowAndRedirect(this, "新闻内容不能为空!", "Collect_News.aspx");
                }
                if (this.HidClassID.Value.Trim().Equals(""))
                {
                    YSCMS.Common.MessageBox.ShowAndRedirect(this, "新闻入库后的栏目不能为空!", "Collect_News.aspx");
                }
                ...
                if (!this.TxtDate.Text.Trim().Equals(""))
                {
                    ...
                    {
                        YSCMS.Common.MessageBox.ShowAndRedirect(this, "采集日期格式不正确!", "Collect_News.aspx");
                    }
                }
                else
                {
                ...
                YSCMS.Common.MessageBox.ShowAndRedirect(this, "修改新闻成功!", "Collect_News.aspx");
            }
        }
    }
}