...
{
    public partial class Collect_News : YSCMS.PageBasic.ManagePage
    {
        public Collect_News()
        {
            Authority_Code = "S012";
        ...
        protected void RptNews_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                System.Web.UI.WebControls.Label lbl = (System.Web.UI.WebControls.Label)e.Item.FindControl("LblState");
                if (lbl != null)
                {
                    try
                    {
        ...
        private bool deleteNews(string delID)
        {
            ...
            YSCMS.Model.CollectNewsInfo collectNews = null;
        ...
        private bool deleteImageFile(ArrayList arr)
        {
            try
            {
                foreach (string s in arr)
                {
                    ...
                    YSCMS.Common.Public.DelFile(null, Server.MapPath(imageFileSrc));
                }
                return true;
            }
            catch
