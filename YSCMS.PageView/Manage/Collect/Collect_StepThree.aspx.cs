...
{
    public partial class Collect_StepThree : YSCMS.PageBasic.ManagePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                else
                {
                    ...
                    {
                        YSCMS.Common.MessageBox.ShowAndRedirect(this, "传送的参数无效,没有找到该站点的信息!", "Collect_StepTwo.aspx?id=" + n);
                    }
                    ...
                    {
                        YSCMS.Common.MessageBox.ShowAndRedirect(this, "采集不到任何网页,请返回检查页址是否正确,编码方式是否正确!", "Collect_Add.aspx?Type=Site&ID=" + n);
                    }
                }
            }
        }
        protected void BtnNext_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                ...
                {
                    YSCMS.Common.MessageBox.Show(this, "列表URL没有设置或设置不正确!");
                }
