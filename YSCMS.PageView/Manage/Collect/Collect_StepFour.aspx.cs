...
{
    public partial class Collect_StepFour : YSCMS.PageBasic.ManagePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                {
                    YSCMS.Common.MessageBox.ShowAndRedirect(this, "没有传送必要的参数", "Collect_List.aspx");
                }
                else
                {
                    ...
                    {
                        YSCMS.Common.MessageBox.ShowAndRedirect(this, "传送的参数无效,没有找到该站点的记录", "Collect_List.aspx");
                    }
                    DataRow r = tb.Rows[0];
        ...
        protected void BtnNext_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                ...
                {
                    YSCMS.Common.MessageBox.ShowAndRedirect(this, "新闻标题没有设置或设置不正确", "Collect_List.aspx");
                }
                if (this.EdtContent.Text.IndexOf("[内容]") < 0)
                {
                    YSCMS.Common.MessageBox.ShowAndRedirect(this, "新闻内容没有设置或设置不正确", "Collect_List.aspx");
                }
                YSCMS.Model.CollectSiteInfo nf = new YSCMS.Model.CollectSiteInfo();
                ...
                if (this.ChbAuthor.Checked)
                {
                    ...
                    {
                        YSCMS.Common.MessageBox.ShowAndRedirect(this, "作者没有设置,请设置新闻作者(手动)", "Collect_List.aspx");
                    }
                    else
                    {
                ...
                else
                {
                    ...
                    {
                        YSCMS.Common.MessageBox.ShowAndRedirect(this, "作者没有设置,请设置作者(自动匹配项)", "Collect_List.aspx");
                    }
                    else
                    {
                ...
                if (this.ChbSource.Checked)
                {
                    ...
                    {
                        YSCMS.Common.MessageBox.ShowAndRedirect(this, "来源没有设置,请设置新闻来源(手动)", "Collect_List.aspx");
                    }
                    else
                    {
                ...
                else
                {
                    ...
                    {
                        YSCMS.Common.MessageBox.ShowAndRedirect(this, "来源没有设置,请设置新闻来源(自动匹配项)", "Collect_List.aspx");
                    }
                    else
                    {
                ...
                if (this.ChbTime.Checked)
                {
                    ...
                    {
                        YSCMS.Common.MessageBox.ShowAndRedirect(this, "时间没有设置,请设置新闻时间(手动)", "Collect_List.aspx");
                    }
                    else
                    {
                        try
                        ...
                        {
                            YSCMS.Common.MessageBox.ShowAndRedirect(this, "手动时间格式错误!正确的格式如:2007-12-12 15:16:35.系统错误" + fex.ToString(), "Collect_List.aspx");
                        }
                        nf.AddDateSetting = "";
                    }
                }
                else
                {
                    ...
                    {
                        YSCMS.Common.MessageBox.ShowAndRedirect(this, "时间没有设置,请设置新闻时间(自动匹配项)", "Collect_List.aspx");
                    }
                    else
                    {
                ...
                if (this.RadPageOther.Checked)
                {
                    ...
                    {
                        YSCMS.Common.MessageBox.ShowAndRedirect(this, "您已选择了分页，请设置分页新闻", "Collect_List.aspx");
                        return;
                    }
                }
