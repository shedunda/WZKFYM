<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Collect_Add.aspx.cs" Inherits="YSCMS.PageView.Manage.Collect.Collect_Add" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <meta http-equiv="Content-Type"<%=DateTime.Today.AddDays(1).ToString()%> content="text/html; charset=gb2312" />
    <title>月思内容管理系统 For .NET v3.0.0</title>
