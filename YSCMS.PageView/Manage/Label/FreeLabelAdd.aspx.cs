...
{
    public partial class FreeLabelAdd : YSCMS.PageBasic.ManagePage
    {
        public FreeLabelAdd()
        {
            Authority_Code = "T009";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                YSCMS.CMS.FreeLabel freelbl = new YSCMS.CMS.FreeLabel();
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (Request.QueryString["id"] != null && !Request.QueryString["id"].Trim().Equals(""))
                {
                    ...
                    lblsql = ln.LabelSQL;
                    lblname = ln.LabelName.Replace("{YS_FREE_", "").Replace("}", "");
        ...
        private string GetFields(YSCMS.CMS.FreeLabel fb, string tabnm, string fdlst, string cond, string ordr, bool dbflag, string jnfld, out string opt)
        {
            string ret = "";
            opt = "";
