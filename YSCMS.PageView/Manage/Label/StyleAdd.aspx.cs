...
{
    public partial class StyleAdd : YSCMS.PageBasic.ManagePage
    {
        public StyleAdd()
        {
            Authority_Code = "T018";
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            else if (Page.IsValid)
            {
                ...
                {
                    StContent = YSCMS.Common.Input.RemovePor(StContent);
                }
                ...
                stClass.isRecyle = 0;
                //清除样式缓存
                //YSCMS.Publish.LabelStyle.CatchClear();
        ...
        {
            int nRCount, nPCount;
            DataTable tb = YSCMS.CMS.Pagination.GetPage("manage_label_style_add_aspx", PageIndex, 20, out nRCount, out nPCount);
        ...
        {
            YSCMS.CMS.CustomForm Customform = new YSCMS.CMS.CustomForm();
