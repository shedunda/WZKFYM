<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FreeLabelAdd.aspx.cs" Inherits="YSCMS.PageView.Manage.Label.FreeLabelAdd" %>
...
<form id="Form1" name="Form1" method="post" action="FreeLabelAddEnd.aspx">
  <div  class="mian_body">
    ...
    <div class="lanlie_lie">
      <div class="newxiu_base">
        <table width="98%" cellpadding="5" cellspacing="1" align="center"  class="nxb_table">
          <tr>
            <td width="50%"><span class="span1">标签名称：</span><span style="font-weight:bold;color:Red">{YS_FREE</span>
    ...
    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="copyright_bg"
                style="height: 76px">
      <tr>
        <td align="center"><%Response.Write(this.CopyRight);%></td>
      </tr>
    </table>
  </div>
