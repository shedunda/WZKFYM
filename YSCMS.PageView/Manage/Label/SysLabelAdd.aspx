<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SysLabelAdd.aspx.cs" Inherits="YSCMS.PageView.Manage.Label.SysLabelAdd" %>
         ...
         <div class="newxiu_base">
           <table class="nxb_table">
             <tr>
               ...
               <td>
                   	<b class="font1">{YS_</b><input type="text" id="LabelName" runat="server" name="q" value="" class="input7" /><b style="color:#F00;">} </b>
