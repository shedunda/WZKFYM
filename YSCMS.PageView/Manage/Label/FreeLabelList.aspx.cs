...
{
    public partial class FreeLabelList : YSCMS.PageBasic.ManagePage
    {
        ...
        {
            int nRCount, nPCount;
            DataTable tb = YSCMS.CMS.Pagination.GetPage("manage_label_FreeLabel_List.aspx", PageIndex, PAGESIZE, out nRCount, out nPCount);
