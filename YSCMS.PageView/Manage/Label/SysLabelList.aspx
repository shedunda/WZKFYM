<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SysLabelList.aspx.cs" Inherits="YSCMS.PageView.Manage.Label.SysLabelList" %>
...
<script language="javascript" type="text/javascript">
    function Update(type, id) {
        switch (type) {
            case "Label":
                self.location = "syslabeladd.aspx?LabelID=" + id;
                break;
            case "LabelClass":
    ...
    function reload() {
        if (confirm('您确认要重新从月思(Yuesisoft.com)下载 [系统内置标签] 吗?\n重新下载标签，将把您系统内置标签全部清空。\n特别注意：下载的是xml文件，把xml文件通过导入标签功能导入!\n如果您确认。请点[确定]按钮')) {
            var ifm = document.getElementById("reloadfromyscms");
   ...
   <div class="nwelie">
      <div class="lanlie">
         <ul>
            ...
            <li><a href="syslabeladd.aspx"> 新建标签</a>┊</li>
      ...
      <div class="lanlie_lie">
        ...
        <div class="fanye">
          ...
          <iframe id="reloadfromyscms" src="about:blank" border="0" height="0" width="0" style="visibility: hidden"></iframe>
          </div>
      </div>
   </div>
</div>
