...
{
    public partial class TempletEditor : YSCMS.PageBasic.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                string SitePath = DirMana + "\\" + Templet + "\\siteTemplets\\" + YSCMS.Global.Current.SiteID;
        ...
        {
            this.ContentTextBox.Value = YSCMS.Common.FileAction.ShowFileContet(filepath);
        }
        ...
        protected void Button1_ServerClick(object sender, EventArgs e)
        {
            ...
            Result = YSCMS.Common.FileAction.SaveFile(Path, Content);
