...
namespace YSCMS.PageView.Manage.Templet
{
    public partial class TempletManageList : YSCMS.PageBasic.ManagePage
    {
        public TempletManageList()
        {
            Authority_Code = "T001";
        }
        private string DirMana = YSCMS.Config.UIConfig.dirDumm;
        private string Templet = YSCMS.Config.UIConfig.dirTemplet;  //获取模板路径
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                YSCMS.Common.MessageBox.Show(this, "发生异常!");
            }
        ...
        protected void ShowFile(string defaultpath, string path, string parentPath)
        {
            ...
            {
                YSCMS.Common.MessageBox.Show(this, "目录不存在!");
            }
        ...
        protected string GetDirFile(string dir, string ParPath)
        {
            ...
            else
            {
                ...
                {
                    TempletTF = DirMana + "\\" + YSCMS.Config.UIConfig.dirSite + "\\" + YSCMS.Global.Current.SiteID + "\\" + Templet;
                }
        ...
        string PathPre()
        {
            string Path = YSCMS.Common.FileAction.GetParentPathByPath(FilePath + Request.QueryString["Path"], Templet);
            return Path;
        }
        ...
        protected void EidtDirName(string path)
        {
            ...
            int result = YSCMS.Common.FileAction.EidtName(path, OldName, NewName, 0);
            if (result == 1)
                YSCMS.Common.MessageBox.Show(this, "更改文件夹名成功!");
            else
                YSCMS.Common.MessageBox.Show(this, "参数传递错误!");
        }
        ...
        protected void EidtFileName(string path)
        {
            ...
            int result = YSCMS.Common.FileAction.EidtName(path, OldName, NewName, 1);
            if (result == 1)
                YSCMS.Common.MessageBox.Show(this, "更改文件名成功!");
            else
                YSCMS.Common.MessageBox.Show(this, "参数传递错误!");
        }
        ...
        {
            int result = 0;
            result = YSCMS.Common.FileAction.DeleteFile(path, "", 0);
            if (result == 1)
                YSCMS.Common.MessageBox.Show(this, "删除文件夹成功!");
            else
                YSCMS.Common.MessageBox.Show(this, "参数错误!");
        }
        ...
        protected void DelFile(string path)
        {
            ...
            int result = 0;
            result = YSCMS.Common.FileAction.DeleteFile(path, str_FileName, 1);
            if (result == 1)
                YSCMS.Common.MessageBox.Show(this, "删除文件夹成功!");
            else
                YSCMS.Common.MessageBox.Show(this, "参数错误!");
        ...
        protected void AddDir(string path)
        {
            ...
            int result = 0;
            result = YSCMS.Common.FileAction.AddDir(path, str_DirName);
            if (result == 1)
                YSCMS.Common.MessageBox.Show(this, "添加文件夹成功!");
            else
                YSCMS.Common.MessageBox.Show(this, "未知错误!");
        }
