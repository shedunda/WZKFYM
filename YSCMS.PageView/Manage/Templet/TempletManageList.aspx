<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TempletManageList.aspx.cs" Inherits="YSCMS.PageView.Manage.Templet.TempletManageList" %>
...
<script language="javascript" type="text/javascript">
    function ListGo(Path, ParentPath) {
        ...
        var url = "";
        var dirDumm = "<% Response.Write(YSCMS.Config.UIConfig.dirDumm); %>";
