<%@ Page Language="C#" AutoEventWireup="true" ResponseEncoding="utf-8" CodeBehind="TempletEditor.aspx.cs" Inherits="YSCMS.PageView.Manage.Templet.TempletEditor" %>
                ...
                <div class="lanlie_lie">
                    ...
                    <input id="Button8" type="button" class="insubt1" value="插入" onclick="javascript: getValue(document.fromeditor.classlist.value);" />
                                    ...
                                    <div class="mo_bi">
                                        ...
                                        自定义标签格式：{YS_xx}<br />
                                        (内置)系统标签：{YS_S_xx}<br />
                                        (内置)动态栏目标签：{YS_Class*_xx}(不调用子类)，{YS_Class*C_xx}(调用子类)，xx为栏目的ClassID<br />
                                        (内置)动态专题标签：{YS_Special*_xx}，xx为专题的SpecialID<br />
                                        自由标签：{YS_FREE_xx}<br />
