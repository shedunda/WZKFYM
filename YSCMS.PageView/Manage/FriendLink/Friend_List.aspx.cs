...
namespace YSCMS.PageView.Manage.FriendLink
{
    public partial class Friend_List : YSCMS.PageBasic.ManagePage
    {
        public Friend_List()
        {
            Authority_Code = "S014";
        ...
        void ParamStartLoad()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                if (YSCMS.Config.UIConfig.Linktagert.Equals("_blank"))
                {
                ...
                if (YSCMS.Config.UIConfig.Linktagertimg.Equals("_blank"))
                {
                ...
                Content.Value = YSCMS.Common.Input.ToTxt(dt.Rows[0]["Content"].ToString());
        ...
        protected void SavePram_ServerClick(object sender, EventArgs e)
        {
            if (SiteID != "0")
            {
                YSCMS.Common.MessageBox.Show(this, "你没有此项的操作权限.");
            }
            if (Page.IsValid)//判断页面是否通过验证
            {
                ...
                {
                    YSCMS.Config.UIConfig.Linktagert = "_blank";
                }
                else
                {
                    YSCMS.Config.UIConfig.Linktagert = "";
                }
                if (isImgBlank.Checked == true)
                {
                    YSCMS.Config.UIConfig.Linktagertimg = "_blank";
                }
                else
                {
                    YSCMS.Config.UIConfig.Linktagertimg = "";
                }
                string Str_ArrSize = YSCMS.Common.Input.Filter(this.ArrSize.Text.Trim());//图片尺寸
                string Str_Content = YSCMS.Common.Input.Filter(this.Content.Value.Trim());//注册须知;
                #endregion
                ...
                if (up_pram != 0)
                {
                    ...
                    YSCMS.Common.MessageBox.ShowAndRedirect(this, "友情连接参数设置成功", "Friend_List.aspx?type=pram");
                }
                else
                {
                    YSCMS.Common.MessageBox.ShowAndRedirect(this, "意外错误：未知错误", "Friend_List.aspx");
                }
                #endregion
            }
        }
        ...
        {
            int i, j;
            DataTable dt = YSCMS.CMS.Pagination.GetPage("manage_Friend_Friend_List_1_aspx", PageIndex, PAGESIZE, out i, out j, null);
        ...
        {
            int i, j;
            DataTable dt = YSCMS.CMS.Pagination.GetPage("manage_Friend_Friend_List_2_aspx", PageIndex, PAGESIZE, out i, out j, null);
                ...
                if (dt != null)//判断如果dt里面没有内容，将不会显示
                {
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        for (int k = 0; k < dt.Rows.Count; k++)
                        {
                            ...
                            dt.Rows[k]["author"] = isadmin == "1" ? "管理员:<a href=\"../../" + YSCMS.Config.UIConfig.dirUser + "/showUser.aspx?uid=" + AdminName + "\" target=\"_blank\" class=\"xa3\">" + AdminName + "</a>" : "会员:<a href=\"../../" + YSCMS.Config.UIConfig.dirUser + "/showUser.aspx?uid=" + AdminName + "\" target=\"_blank\" class=\"xa3\">" + AdminName + "</a>";
                            #endregion
        ...
        protected void SaveAddClass_ServerClick(object sender, EventArgs e)
        {
            if (Page.IsValid)//判断页面是否通过验证
            {
                ...
                string Str_ClassCName = YSCMS.Common.Input.Filter(this.ClassCName.Text.Trim());//类别名称
                string Str_ClassEName = YSCMS.Common.Input.Filter(this.ClassEName.Text.Trim());//英文名称
                string Str_Description = YSCMS.Common.Input.Filter(this.Content_Class.Value.Trim());//说明
                #region 检查重复数据
            check: string Str_ClassID = YSCMS.Common.Rand.Number(12);
                ...
                {
                    YSCMS.Common.MessageBox.ShowAndRedirect(this, "对不起，该类别已经存在", "Friend_List.aspx?type=class");
                }
                //判断类别名称是否为空
                if (Str_ClassCName == null || Str_ClassCName == string.Empty)
                {
                    YSCMS.Common.MessageBox.ShowAndRedirect(this, "对不起，类别名称不能为空，请返回继续添加", "Friend_List.aspx?type=class");
                }
                //向数据库中写入添加的类别信息
                ...
                if (iclass != 0)
                {
                    ...
                    YSCMS.Common.MessageBox.ShowAndRedirect(this, "友情连接系统新增类别成功", "Friend_List.aspx?type=class");
                }
                else
                {
                    YSCMS.Common.MessageBox.ShowAndRedirect(this, "意外错误：未知错误<br />", "Friend_List.aspx");
                }
        ...
        protected void DelOne_Class()
        {
            ...
            if (FID == null)
            {
                YSCMS.Common.MessageBox.Show(this, "错误的参数传递!");
            }
            else
            {
                try
                {
                    ...
                    YSCMS.Common.MessageBox.ShowAndRedirect(this, "删除成功。", "Friend_List.aspx?type=class");
                }
                catch { }
            }
            YSCMS.Common.MessageBox.Show(this, "意外错误：未知错误");
        }
        #endregion
        ...
        protected void DelOne_Link()
        {
            ...
            try
            {
                ...
                {
                    YSCMS.Common.MessageBox.ShowAndRedirect(this, "删除成功。", "Friend_List.aspx?type=link");
                }
            }
            catch { }
        }
        ...
        protected void Suo()
        {
            ...
            try
            {
                ...
                {
                    YSCMS.Common.MessageBox.ShowAndRedirect(this, "锁定成功。", "Friend_List.aspx?type=link");
                }
            }
            catch { }
        }
        ...
        protected void Unsuo()
        {
            ...
            try
            {
                ...
                {
                    YSCMS.Common.MessageBox.ShowAndRedirect(this, "解锁成功!!", "Friend_List.aspx?type=link");
                }
            }
            catch { }
        }
        ...
        protected void EditClass_Start()
        {
            ...
            {
                YSCMS.Common.MessageBox.ShowAndRedirect(this, "未知错误,异常错误", "Friend_List.aspx?type=class");
            }
        }
        #endregion
        ...
        protected void UpdateClass_ServerClick(object sender, EventArgs e)
        {
            if (Page.IsValid)//判断页面是否通过验证
            {
                string FID = Request.QueryString["ID"];
                //取得添加中的表单信息
                string Str_ClassNameE = YSCMS.Common.Input.Filter(this.ClassCNameEdit.Text.Trim());//类别名称
                string Str_EnglishE = YSCMS.Common.Input.Filter(this.ClassENameEdit.Text.Trim());//英文
                string Str_Descript = YSCMS.Common.Input.Filter(this.DescriptionE.Value.Trim());//说明

                //判断类别名称是否为空
                if (Str_ClassNameE == null || Str_ClassNameE == string.Empty)
                {
                    YSCMS.Common.MessageBox.ShowAndRedirect(this, "对不起，类别名称不能为空，请返回继续修改", "Friend_List.aspx?type=class");
                }
                ...
                if (updat != 0)
                {
                    YSCMS.Common.MessageBox.ShowAndRedirect(this, "修改成功", "Friend_List.aspx?type=class");
                }
                else
                {
                    YSCMS.Common.MessageBox.ShowAndRedirect(this, "意外错误：未知错误<br>", "Friend_List.aspx?type=class");
                }
                #endregion
            }
        }
        ...
        protected void delP_class_Click(object sender, EventArgs e)
        {
            ...
            {
                YSCMS.Common.MessageBox.Show(this, "请先选择批量操作的内容!");
            }
            else
            {
                ...
                YSCMS.Common.MessageBox.ShowAndRedirect(this, "删除数据成功,请返回继续操作!", "Friend_List.aspx?type=class");
            }
            YSCMS.Common.MessageBox.Show(this, "删除数据失败,请与管理联系!");
        }
        #endregion
        ...
        protected void delall_class_Click(object sender, EventArgs e)
        {
            ...
            if (dall != 0)
            {
                YSCMS.Common.MessageBox.ShowAndRedirect(this, "删除全部成功。", "Friend_List.aspx?type=class");
            }
            else
            {
                YSCMS.Common.MessageBox.Show(this, "删除数据失败,请与管理联系!");
        ...
        protected void SuoP_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                for (int i = 0; i < CheckboxArray.Length; i++)
                {
                    ...
                    if (link_lock == 0)
                    {
                        YSCMS.Common.MessageBox.Show(this, "锁定数据失败,请与管理联系!");
                        break;
                    }
                }
                YSCMS.Common.MessageBox.ShowAndRedirect(this, "锁定数据成功!", "Friend_List.aspx?type=link");
            }
        }
        #endregion
        ...
        protected void UnsuoP_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                for (int i = 0; i < CheckboxArray.Length; i++)
                {
                    ...
                    if (unlockk == 0)
                    {
                        YSCMS.Common.MessageBox.Show(this, "锁定数据失败!");
                        break;
                    }
                }
                YSCMS.Common.MessageBox.ShowAndRedirect(this, "解锁数据成功!", "Friend_List.aspx?type=link");
            }
        }
        #endregion
        ...
        protected void delP_link_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                for (int i = 0; i < CheckboxArray.Length; i++)
                {
                    ...
                    if (delpl == 0)
                    {
                        YSCMS.Common.MessageBox.Show(this, "删除数据失败,可能是没找到记录!");
                        break;
                    }
                }
                YSCMS.Common.MessageBox.ShowAndRedirect(this, "删除数据成功,请返回继续操作!", "Friend_List.aspx?type=link");
            }
        }
        #endregion
        ...
        protected void delall_link_Click(object sender, EventArgs e)
        {
            ...
            {
                YSCMS.Common.MessageBox.ShowAndRedirect(this, "删除全部成功。", "Friend_List.aspx?type=link");
            }
        }
        #endregion
        ...
        protected void SaveLink_ServerClick(object sender, EventArgs e)
        {
            ...
            else if (Page.IsValid)//判断页面是否通过验证
            {
                ...
                string Str_Name = YSCMS.Common.Input.Filter(this.Name.Text.Trim());//站点名称
                string Str_Type = this.Type.Text.Trim();//连接类型
                string Str_Url = YSCMS.Common.Input.Filter(this.Url.Text.Trim());//连接地址
                string Str_Content = YSCMS.Common.Input.Filter(this.ContentFri.Value.Trim());//站点说明
                string Str_PicUrl = YSCMS.Common.Input.Filter(this.PicUrl.Text);//图片地址
                string Str_Author = YSCMS.Common.Input.Filter(this.Author.Text.Trim());//申请人作者
                string Str_Mail = YSCMS.Common.Input.Filter(this.Mail.Text.Trim());//邮件
                string Str_ContentFor = YSCMS.Common.Input.Filter(this.ContentFor.Value.Trim());//申请理由
                string Str_LinkContent = YSCMS.Common.Input.Filter(this.LinkContent.Value.Trim());//其他联系方式
                ...
                {
                    YSCMS.Common.MessageBox.ShowAndRedirect(this, "对不起，该连接已经存在", "Friend_List.aspx?type=link");
                }
                if (Str_Name == null || Str_Name == string.Empty)
                {
                    YSCMS.Common.MessageBox.ShowAndRedirect(this, "对不起，连接名称不能为空", "Friend_List.aspx?type=link");
                }
                #endregion
                ...
                if (lsa != 0)
                {
                    ...
                    YSCMS.Common.MessageBox.ShowAndRedirect(this, "" + tip + "成功", "Friend_List.aspx?type=link");
                }
                else
                {
                    YSCMS.Common.MessageBox.ShowAndRedirect(this, "意外错误：未知错误<br />", "Friend_List.aspx");
        ...
        protected void Edit_Link_Start()
        {
            ...
            {
                YSCMS.Common.MessageBox.ShowAndRedirect(this, "未知错误,异常错误", "Friend_List.aspx?type=link");
            }
        }
        ...
        protected void EditFriend_ServerClick(object sender, EventArgs e)
        {
            if (Page.IsValid)//判断页面是否通过验证
            {
                ...
                string Str_Name = YSCMS.Common.Input.Filter(this.SiteName.Text.Trim());//站点名称
                string Str_Type = this.LinkType.Text;//连接类型
                string Str_Url = YSCMS.Common.Input.Filter(this.linkUrl.Text.Trim()) + "";//连接地址
                string Str_Content = this.siteDesc.Value + "";//站点说明
                string Str_PicUrl = YSCMS.Common.Input.Filter(this.PicUrll.Text.Trim()) + "";//图片地址
                int Isuser = 0, isLok = 0;
                ...
                string Str_Author = YSCMS.Common.Input.Filter(this.Authorr.Text.Trim()) + "";//申请人作者
                string Str_Mail = YSCMS.Common.Input.Filter(this.Emaill.Text.Trim()) + "";//邮件
                string Str_ContentFor = YSCMS.Common.Input.Filter(this.forfor.Value.Trim()) + "";//申请理由
                string Str_LinkContent = YSCMS.Common.Input.Filter(this.otherl.Value.Trim()) + "";//其他联系方式
                ...
                if (Str_Name == null || Str_Name == string.Empty)
                {
                    YSCMS.Common.MessageBox.ShowAndRedirect(this, "对不起，名称不能为空，请返回继续修改", "Friend_List.aspx?type=link");
                }
                ...
                if (elink != 0)
                {
                    YSCMS.Common.MessageBox.ShowAndRedirect(this, "修改成功", "Friend_List.aspx?type=link");
                }
                else
                {
                    YSCMS.Common.MessageBox.Show(this, "意外错误：未知错误<br>");
                }
                #endregion
            }
        }
        ...
        protected void GetParentValue()
        {
            ...
            {
                this.ParentID.Text = YSCMS.Common.Input.Filter(parentid);
            }
        }
