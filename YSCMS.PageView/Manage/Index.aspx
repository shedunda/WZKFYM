<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="YSCMS.PageView.Manage.Index" %>
...
<head id="Head1" runat="server">
 <title>
		<%Response.Write(YSCMS.Config.UIConfig.HeadTitle); %>--后台管理</title>
