...
namespace YSCMS.PageView.Manage.Attachments
{
    public partial class PicManage : System.Web.UI.Page
    {
        YSCMS.CMS.Attachments AttachmentsCMS = new YSCMS.CMS.Attachments();
        ...
        protected void ListDataBind(int pageIndex)
        {
            ...
            int RecordCount = 0;
            int PageCount = 0;
            dt = AttachmentsCMS.GetPage("2", this.txtBeginDate.Text.Trim(), this.txtEndDate.Text.Trim(), pageIndex, YSCMS.Config.UIConfig.GetPageSize(), out RecordCount, out PageCount);
