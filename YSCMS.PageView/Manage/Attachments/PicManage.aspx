<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PicManage.aspx.cs" Inherits="YSCMS.PageView.Manage.Attachments.PicManage" %>
        ...
        <div class="mian_cont">
            <div class="nwelie">
                <div class="tugli_lan">
                    ...
                    <asp:Button ID="Button1" runat="server" CssClass="inpsublit" onclick="Button1_Click" OnClientClick="checktime()" /><a href='PicManage.aspx?Action=del&ids=<%# Eval("Id")%>'>批量删除</a>
                </div>
                <div class="jslie_lie">
                    <table class="jstable">
