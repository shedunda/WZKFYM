<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FileManage.aspx.cs" Inherits="YSCMS.PageView.Manage.Attachments.FileManage" %>
                        ...
                        <asp:Repeater ID="rpt_list" runat="server">
                            ...
                            <ItemTemplate>
                                <tr class="off" onmouseover="this.className='on'" onmouseout="this.className='off'">
                                    ...
                                    <td align="center">
                                        <%# YSCMS.Common.FileAction.GetFileType(Eval("FileName").ToString())%>
                                    </td>
                                    <td align="center">
                                        <%# Eval("UploadDate")%>
                                    </td>
