<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Top.aspx.cs" Inherits="YSCMS.PageView.Manage.Top" %>
...
<div class="top_body">
  <div class="top_big">
    <div class="top_left"><img src="images/logo.png" alt="" /></div> 
    <div class="top_right">
       <ul id="menus">
         <li><a id="menu1" href="javascript:menuClick(1)" class="nav_bj"><div class="toprig"><img src="images/lie_08.png" alt="" /><br />首页</div></a></li>
         <li><a id="menu2" href="javascript:menuClick('2')"><div class="toprig"><img src="images/lie_07.png" alt="" /><br />快捷方式</div></a></li>
         <li><a id="menu3" href="javascript:menuClick('3')"><div class="toprig"><img src="images/lie_06.png" alt="" /><br />内容管理</div></a></li>
         <li><a id="menu4" href="javascript:menuClick('4')"><div class="toprig"><img src="images/lie_05.png" alt="" /><br />发布管理</div></a></li>
         <li><a id="menu5" href="javascript:menuClick('5')"><div class="toprig"><img src="images/lie_04.png" alt="" /><br />会员管理</div></a></li>
         <li><a id="menu6" href="javascript:menuClick('6')"><div class="toprig"><img src="images/lie_03.png" alt="" /><br />插件管理</div></a></li>
         <li><a id="menu7" href="javascript:menuClick('7')"><div class="toprig"><img src="images/lie_02.png" alt="" /><br />控制面板</div></a></li>
       </ul>
    </div>
    <div class="clear"></div>
  ...
  <div class="top_lan">
      <div class="top_lan_left">
         <div class="top_lan_admin">您好<span><%=YSCMS.Global.Current.UserName %></span>
         <%--<a target="sys_main" href="sys/AdminEdit.aspx?Type=Update&ID=<%= YSCMS.Global.Current.UserNum%>">[修改密码]</a>--%>
         </div>
