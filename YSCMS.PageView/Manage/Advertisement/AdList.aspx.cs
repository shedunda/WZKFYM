...
{
    public partial class AdList : YSCMS.PageBasic.ManagePage
    {
        public AdList()
        {
            Authority_Code = "S006";
        }
        public string DirMana = YSCMS.Config.UIConfig.dirDumm;//获取用户虚拟路径
        ...
        protected string CheckID(string idlist)
        {
            ...
            idlist = YSCMS.Common.Input.CutComma(idlist);
            return idlist;
        }
        ...
        protected void GetList(string type)
        {
            ...
            else
            {
                ...
                {
                    YSCMS.Common.MessageBox.ShowAndRedirect(this, "参数错误！" + e.ToString() + "!", "AdList.aspx");
                }
            }
        ...
        {
            YSCMS.Model.AdsListInfo ali = new YSCMS.Model.AdsListInfo();

            ali.type = type;
            if (Request.QueryString["SiteID"] != null && Request.QueryString["SiteID"] != string.Empty)
            {
                ali.showSiteID = YSCMS.Common.Input.Filter(Request.QueryString["SiteID"]);
            }
            ...
            {
                ali.adsType = YSCMS.Common.Input.Filter(Request.QueryString["adsType"]);
            }
            ...
            {
                ali.SearchKey = YSCMS.Common.Input.Filter(Request.QueryString["SearchKey"]);
            }
            ...
            switch (type)
            {
                case "Ads":
                    ...
                    for (i = (page - 1) * pageSize, j = 1; i < Cnt && j <= pageSize; i++, j++)
                    {
                        ...
                        string adsCusID = "<a target=\"_blank\" href=\"../../" + YSCMS.Config.UIConfig.dirUser + "/" +
        ...
        protected void adsLock(string adsID)
        {
            YSCMS.CMS.Ads ac = new YSCMS.CMS.Ads();
            ac.Lock(adsID);
            YSCMS.Common.MessageBox.ShowAndRedirect(this, "锁定广告成功!", "AdList.aspx");
        }
        ...
        protected void adsUnLock(string adsID)
        {
            YSCMS.CMS.Ads ac = new YSCMS.CMS.Ads();
            ac.UnLock(adsID);
            YSCMS.Common.MessageBox.ShowAndRedirect(this, "解锁广告成功!", "AdList.aspx");
        }
        ...
        protected void adsDelAll()
        {
            YSCMS.CMS.Ads ac = new YSCMS.CMS.Ads();
            ac.DelAllAds();
            YSCMS.Common.MessageBox.ShowAndRedirect(this, "删除全部广告成功!", "AdList.aspx");
        }
        ...
        protected void adsDel(string idStr)
        {
            YSCMS.CMS.Ads ac = new YSCMS.CMS.Ads();
            ac.DelPAds(idStr);
            YSCMS.Common.MessageBox.ShowAndRedirect(this, "批量删除广告成功!", "AdList.aspx");
        }
        ...
        protected void classDelAll()
        {
            YSCMS.CMS.Ads ac = new YSCMS.CMS.Ads();
            ac.DelAllAdsClass();
            YSCMS.Common.MessageBox.ShowAndRedirect(this, "删除全部栏目成功!", "AdList.aspx");
        }
        ...
        protected void classDel(string idStr)
        {
            ...
            YSCMS.Common.MessageBox.ShowAndRedirect(this, "批量删除栏目成功!", "AdList.aspx");
        }
        ...
        protected void StatDelAll()
        {
            YSCMS.CMS.Ads ac = new YSCMS.CMS.Ads();
            ac.statDelAll();
            YSCMS.Common.MessageBox.ShowAndRedirect(this, "重置全部统计信息成功!", "AdList.aspx");
        }
        ...
        protected void StatDel(string idStr)
        {
            YSCMS.CMS.Ads ac = new YSCMS.CMS.Ads();
            ac.statDel(idStr);
            YSCMS.Common.MessageBox.ShowAndRedirect(this, "批量重置统计信息成功!", "AdList.aspx");
        }
