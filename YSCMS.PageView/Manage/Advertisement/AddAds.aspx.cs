...
{
    public partial class AddAds : YSCMS.PageBasic.ManagePage
    {
        public AddAds()
        {
            Authority_Code = "S007";
        ...
        public string str_dirMana = YSCMS.Config.UIConfig.dirDumm;
        ...
        protected void AdsAdd()
        {
            ...
            if (result == 1)
                YSCMS.Common.MessageBox.ShowAndRedirect(this, "添加广告成功!", "AdList.aspx");
            else
                YSCMS.Common.MessageBox.Show(this, "添加广告失败!");
        }
    }
}