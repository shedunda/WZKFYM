...
{
    public partial class EditAds : YSCMS.PageBasic.ManagePage
    {
        public EditAds()
        {
            Authority_Code = "S007";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    str_ID = YSCMS.Common.Input.checkID(str_ID);
                    GetAdsInfo(str_ID);
                }
            }
            //------------------------修改广告-----------------------------
        ...
        {
            YSCMS.Model.AdsInfo ai = new YSCMS.Model.AdsInfo();
            ai.AdID = YSCMS.Common.Input.checkID(Request.Form["H_AdsID"]);
            ...
            if (result == 1)
                YSCMS.Common.MessageBox.ShowAndRedirect(this, "修改广告成功!", "AdList.aspx");
            else
                YSCMS.Common.MessageBox.Show(this, "修改广告失败!");
        }
    }
}
