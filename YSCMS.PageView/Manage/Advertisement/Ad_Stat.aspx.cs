...
{
    public partial class Ad_Stat : YSCMS.PageBasic.ManagePage
    {
        public Ad_Stat()
        {
            Authority_Code = "S006";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            str_adsID = YSCMS.Common.Input.checkID(Request.QueryString["adsID"]);
        ...
        protected string get24HourStat(string type)
        {
            ...
            str_VCount = YSCMS.Common.Input.CutComma(str_VCount);
            ...
            str_Vsize = YSCMS.Common.Input.CutComma(str_Vsize);
        ...
        protected DataTable CipDb(string sql)
        {
            ...
            string str_dirMana = YSCMS.Config.UIConfig.dirDumm;//获取用户虚拟路径
