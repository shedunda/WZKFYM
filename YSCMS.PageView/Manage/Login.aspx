<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="YSCMS.PageView.Manage.Login" %>
...
<title><%Response.Write(YSCMS.Config.UIConfig.HeadTitle); %>用户登录</title>
