<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserMyCom.aspx.cs" Inherits="YSCMS.PageView.Manage.User.UserMyCom" %>
      ...
      <div class="userquery">
         <table width="99%" align="center" cellpadding="0" cellspacing="0" id="searchuserID" style="display:none">
            ...
            <tr>
               ...
               <td><input id="Button1" type="button" value="搜索" name="" runat="server" class="xsubmit1" onserverclick="Button8_ServerClick"/></td>
            </tr>
         </table>
      </div>
      <div class="jslie_lie">
