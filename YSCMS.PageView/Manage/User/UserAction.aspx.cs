...
{
    public partial class UserAction : YSCMS.PageBasic.ManagePage
    {
        ...
        {
            if (UL.Update(YSCMS.Common.Input.Filter(uid), "iPoint", "iPoint+" + sPoint) == 0)
            {
        ...
        {
            if (UL.Update(YSCMS.Common.Input.Filter(uid), "gPoint", "gPoint+" + sPoint) == 0)
            {
