...
{
    public partial class AreaList_Add : YSCMS.PageBasic.ManagePage
    {
        public AreaList_Add()
        {
            Authority_Code = "U032";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                {
                    string Cid = YSCMS.Common.Input.Filter(Request.QueryString["Cid"].ToString());
        ...
        protected void but1_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                ...
                string cityName = YSCMS.Common.Input.Filter(Request.Form["cityName"].ToString());
                ...
                if (Request.QueryString["Cid"] != null)
                {
                    ...
                    string Cids = YSCMS.Common.Input.Filter(Request.QueryString["Cid"].ToString());
                ...
                {
                    string Cid = YSCMS.Common.Rand.Number(12);
                    DateTime creatTime = DateTime.Now;
