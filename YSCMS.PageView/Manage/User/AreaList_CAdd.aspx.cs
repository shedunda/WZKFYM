...
{
    public partial class AreaList_CAdd : YSCMS.PageBasic.ManagePage
    {
        public AreaList_CAdd()
        {
            Authority_Code = "U032";
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                string pname = YSCMS.Common.Input.Filter(Request.QueryString["Cid"].ToString());
        ...
        protected void but1_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                ...
                if (!YSCMS.Common.Input.IsInteger(OrderID))
                {
