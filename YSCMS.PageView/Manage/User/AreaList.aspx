<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AreaList.aspx.cs" Inherits="YSCMS.PageView.Manage.User.AreaList" %>
     ...
     <asp:Repeater ID="DataList1" runat="server" >
		<HeaderTemplate>
         <table class="jstable">
            ...
            <ItemTemplate>
           <%#((System.Data.DataRowView)Container.DataItem)["cm"]%>
            </ItemTemplate>
            <FooterTemplate>
         </table>
         </FooterTemplate>
