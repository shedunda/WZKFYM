...
{
    public partial class AnnounceAdd : YSCMS.PageBasic.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["id"] != null && Request.QueryString["id"].ToString() != "")
                {
                    ...
                    try
                    {
                        aId = int.Parse(YSCMS.Common.Input.Filter(Request.QueryString["id"]));
        ...
        protected void sumbitsave(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                ...
                if (TxtTitle.ToString() != "" && TxtTitle.ToString() != null)
                {
                    ...
                    YSCMS.Model.UserInfo5 uc = new YSCMS.Model.UserInfo5();
                    ...
                    uc.SiteId = YSCMS.Global.Current.SiteID;
