<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserGroupAdd.aspx.cs" Inherits="YSCMS.PageView.Manage.User.UserGroupAdd" %>
         ...
         <div class="newxiu_base">
           <table class="nxb_table">
             ...
             <tr>
               ...
               <td>
                 <asp:TextBox  class="input8" ID="UserFlag" runat="server" Text="YS_"></asp:TextBox>
