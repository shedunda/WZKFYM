<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserInfo.aspx.cs" Inherits="YSCMS.PageView.Manage.User.UserInfo" %>
                ...
                <div class="newxiu_base">
                   <table class="nxb_table">
                      ...
                      <tr>
                         ...
                         <td>
                            <div class="textdiv">
                                <asp:TextBox ID="UserInfos" runat="server" class="textarea1" MaxLength="3000" TextMode="MultiLine"></asp:TextBox>
