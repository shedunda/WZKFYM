...
{
    public partial class ManageVote : YSCMS.PageBasic.ManagePage
    {
        public ManageVote()
        {
            Authority_Code = "S005";
        ...
        {
            int i, j;
            DataTable dt = YSCMS.CMS.Pagination.GetPage(this.GetType().Name, PageIndex, PAGESIZE, out i, out j, null);
            ...
            else
            {
                ...
                for (int i = 0; i < CheckboxArray.Length; i++)
                {
                    if (sur.Delete(CheckboxArray[i]) == 0)
                    {
                        ...
                        YSCMS.Common.MessageBox.ShowAndRedirect(this, "删除数据失败,请与管理联系!", "ManageVote.aspx");
                        break;
                    }
                }
                rd.SaveUserAdminLogs(1, 1, UserNum, "投票管理", "删除数据成功");
                YSCMS.Common.MessageBox.ShowAndRedirect(this, "删除数据成功,请返回继续操作!", "ManageVote.aspx");
            }
        }
        ...
        protected void DelAll_Click(object sender, EventArgs e)
        {
            ...
            {
                rd.SaveUserAdminLogs(1, 1, UserNum, "投票管理", "删除数据成功");
                YSCMS.Common.MessageBox.ShowAndRedirect(this, "删除全部成功。", "ManageVote.aspx");
            }
        }
        ...
        void DelOneClick()
        {
            ...
            else
            {
                ...
                {
                    rd.SaveUserAdminLogs(1, 1, UserNum, "投票管理", "删除数据成功");
                    YSCMS.Common.MessageBox.ShowAndRedirect(this, "删除成功。", "ManageVote.aspx");
                }
            }
        }
