...
{
    public partial class JSAdd : YSCMS.PageBasic.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                else
                {
                    ...
                    title = "新增JS";
                    YSCMS.CMS.NewsJSTemplet jt = new YSCMS.CMS.NewsJSTemplet();
                    ...
                    if (Request.QueryString["ID"] != null && !Request.QueryString["ID"].Trim().Equals(""))
                    {
                        ...
                        YSCMS.CMS.NewsJS nj = new YSCMS.CMS.NewsJS();
                        YSCMS.Model.NewsJS jf = nj.GetModel(id);
        ...
        protected string templets(string tid)
        {
            ...
            YSCMS.CMS.NewsJSTemplet rd = new YSCMS.CMS.NewsJSTemplet();
            if (tid != "" && tid != null)
            {
        ...
        protected void BtnOK_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                YSCMS.Model.NewsJS info = new YSCMS.Model.NewsJS();
                ...
                if (info.Id > 0)
                {
                    ...
                    if (YSCMS.Common.Input.IsInteger(result))
                    {
                        message = "修改JS成功!";
                        YSCMS.Publish.UltiPublish.PublishSingleJsFile(info.Id);
                ...
                else
                {
                    ...
                    {
                        message = "新增JS成功!";
                        YSCMS.Publish.UltiPublish.PublishSingleJsFile(Convert.ToInt32(result));
                        PageRight(message, "JSList.aspx");
                    }
                    else
                    {
