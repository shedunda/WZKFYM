...
{
    public partial class JsTemplet : YSCMS.PageBasic.ManagePage
    {
        public JsTemplet()
        {
            Authority_Code = "C055";
        }
        YSCMS.CMS.NewsJSTemplet cjs = new CMS.NewsJSTemplet();
        YSCMS.CMS.NewsJSTempletClass cjssclass = new CMS.NewsJSTempletClass();
