...
{
    public partial class JSTempletClass : YSCMS.PageBasic.ManagePage
    {
        ...
        private int id;
        YSCMS.CMS.NewsJSTempletClass cNewsJS = new CMS.NewsJSTempletClass();
        public string title = "";
        ...
        protected void BtnOK_Click(object sender, EventArgs e)
        {
            ...
            {
                YSCMS.Model.NewsJSTempletClass mJS = new Model.NewsJSTempletClass();
