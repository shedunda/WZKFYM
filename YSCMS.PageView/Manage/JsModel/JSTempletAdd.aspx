<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JSTempletAdd.aspx.cs" Inherits="YSCMS.PageView.Manage.JsModel.JSTempletAdd" %>
...
<script type="text/javascript" language="javascript">
    ...
    function setValue(value) {
        document.getElementById("content").value = '{#YS:define=' + value + '}';
    }
