...
namespace YSCMS.PageView.Manage.JsModel
{
    public partial class JSTempletAdd : YSCMS.PageBasic.ManagePage
    {
        public JSTempletAdd()
        {
            Authority_Code = "C056";
        }
        private YSCMS.CMS.NewsJSTemplet jt;
        YSCMS.CMS.NewsJSTempletClass jsClass = new CMS.NewsJSTempletClass();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            APIID = SiteID;
            jt = new YSCMS.CMS.NewsJSTemplet();
            if (!IsPostBack)
            {

                string _dirdumm = YSCMS.Config.UIConfig.dirDumm;
                if (_dirdumm.Trim() != "") { _dirdumm = "/" + _dirdumm; }
                style_base.InnerHtml = YSCMS.Common.Public.getxmlstylelist("DdlViewStyle", _dirdumm + "/xml/cuslabeStyle/cstylebase.xml");
                style_class.InnerHtml = YSCMS.Common.Public.getxmlstylelist("DdlFixStyle", _dirdumm + "/xml/cuslabeStyle/cstyleclass.xml");
                style_special.InnerHtml = YSCMS.Common.Public.getxmlstylelist("DdlSpcStyle", _dirdumm + "/xml/cuslabeStyle/cstylespecial.xml");
                this.HidID.Value = "-1";
                getDefine();
        ...
        protected void BtnOK_Click(object sender, EventArgs e)
        {
            ...
            {
                YSCMS.Model.NewsJSTemplet mjs=new Model.NewsJSTemplet ();
