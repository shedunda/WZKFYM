...
{
    public partial class JSList : YSCMS.PageBasic.ManagePage
    {
        public JSList()
        {
            Authority_Code = "C051";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request.Form["JSID"] != null && !Request.Form["JSID"].Trim().Equals(""))
            {
                ...
                else if (Request.Form["Option"] != null && Request.Form["Option"].Equals("GetCode"))
                {
                    ...
                    YSCMS.CMS.NewsJS nj = new YSCMS.CMS.NewsJS();
                    YSCMS.Model.NewsJS info = nj.GetModel(id);
                    Response.Write("<textarea name=\"textfield\" id=\"codecontent\" style=\"width: 99%; height: 110px\"><script language=\"javascript\" type=\"text/javascript\" src=\"" + YSCMS.Common.ServerInfo.GetRootURI(Request) + info.jssavepath + "/" + info.jsfilename + ".js\"></script></textarea>");
                    Response.End();
                    return;
        ...
        protected void DataListBind(int PageIndex)
        {
            ...
            YSCMS.CMS.NewsJS nj = new YSCMS.CMS.NewsJS();
            YSCMS.CMS.NewsJSFile cnjf = new CMS.NewsJSFile();
