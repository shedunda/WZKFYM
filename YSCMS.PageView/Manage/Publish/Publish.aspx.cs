...
{
    public partial class Publish : YSCMS.PageBasic.ManagePage
    {
        ...
        public void ReplaceTemp()
        {
            ...
            if (BakIndex == "true")
            {
                string sourceFile = "~/" + YSCMS.Common.Public.readparamConfig("IndexFileName");
                string str_dirPige = YSCMS.Config.UIConfig.dirPige;
        ...
        private void LabelPublish()
        {
            ...
            YSCMS.Publish.UltiPublish puli = new YSCMS.Publish.UltiPublish(true);
            puli.newsFlag = 0;
