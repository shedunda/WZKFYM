...
namespace YSCMS.PageView.Manage.Publish
{
    public partial class PublishSpecial : System.Web.UI.Page
    {
        ...
        YSCMS.CMS.NewsSpecial SpecialCMS = new YSCMS.CMS.NewsSpecial();
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                dataSpecialTable = SpecialCMS.GetList("isRecyle<>1 and SiteID='" + YSCMS.Global.Current.SiteID + "' and isLock=0");
