...
{
    public partial class Main : YSCMS.PageBasic.ManagePage
    {
        public DataTable dt;
        ...
        protected string GetMenus(string parentId)
        {
            ...
            content += " <li><a href=\"Addmenu.aspx?ClassID=" + parentId + "\"><img src='/CSS/imges/27.png'  width='120' height='116'/></a></li>";
            return content;
        }
    }
}