...
{
    public partial class ConstrList : YSCMS.PageBasic.ManagePage
    {
        public ConstrList()
        {
            Authority_Code = "C042";
        }
        YSCMS.CMS.Constr con = new CMS.Constr();
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                ID = YSCMS.Common.Input.Filter(Request.Form["ID"]);  //取得需要操作的稿件ID
            }
        ...
        protected void Showu_discusslist(int PageIndex)//显示所有讨论组列表
        {
            ...
            if (type == null)
            {
                dts = YSCMS.CMS.Pagination.GetPage("manage_Contribution_ConstrList_aspx", PageIndex, 10, out i, out j, null);
            }
            else
            {
                dts = YSCMS.CMS.Pagination.GetPage("manage_Contribution_Constrchicklist_aspx", PageIndex, 10, out i, out j, null);
            }
