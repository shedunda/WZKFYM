...
namespace YSCMS.PageView.Manage.Contribution
{
    public partial class ConstrEdit : YSCMS.PageBasic.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (!string.IsNullOrEmpty(classid))
                {
                    ...
                    YSCMS.CMS.NewsClass cm = new NewsClass();
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                ...
                string ConIDp = YSCMS.Common.Input.Filter(Request.QueryString["ConID"].ToString());
                ...
                string strfileName = "constr-" + YSCMS.Common.Rand.Number(5) + "";
                ...
                string NewsID = YSCMS.Common.Rand.Number(12);//产生12位随机字符
                ...
                else
                {
                    ...
                    YSCMS.CMS.News cm = new YSCMS.CMS.News();
                    if (!string.IsNullOrEmpty(fileURL))
