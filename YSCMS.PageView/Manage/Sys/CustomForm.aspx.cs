...
{
    public partial class CustomForm : YSCMS.PageBasic.ManagePage
    {
        ...
        {
            int nRCount, nPCount;
            DataTable tb = YSCMS.CMS.Pagination.GetPage(this.GetType().Name, PageIndex, 20, out nRCount, out nPCount);
