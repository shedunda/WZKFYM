...
{
    public partial class CustomForm_Add : YSCMS.PageBasic.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                if (Request.QueryString["id"] != null && Request.QueryString["id"].Trim() != string.Empty)
                {
                    ...
                    YSCMS.CMS.CustomForm customfm = new YSCMS.CMS.CustomForm();
                ...
                else
                {
                    ...
                    this.TxtFolder.Text = "/" + YSCMS.Config.UIConfig.UserdirFile + "/CustomForm/";
                    this.HidID.Value = "0";
