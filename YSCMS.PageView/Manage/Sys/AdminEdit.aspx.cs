...
{
    public partial class AdminEdit : YSCMS.PageBasic.ManagePage
    {
        public AdminEdit()
        {
            Authority_Code = "Q012";
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                YSCMS.Common.DataCache.DelCache("userinfo-" + Request.QueryString["ID"]);
                YSCMS.Common.DataCache.DelCache("AdminDataInfo-" + Request.QueryString["ID"]);
                YSCMS.Model.AdminInfo aci = new YSCMS.Model.AdminInfo();

                aci.UserNum = YSCMS.Common.Input.checkID(Request.QueryString["ID"]);
                ...
                if (aci.UserPassword != null && aci.UserPassword != "" && aci.UserPassword != string.Empty)
                    aci.UserPassword = YSCMS.Common.Input.MD5(aci.UserPassword, true);
                ...
                if (result == 1)
                    YSCMS.Common.MessageBox.Show(this, "更新管理员信息成功");
                else
                    YSCMS.Common.MessageBox.Show(this, "更新管理员信息失败");
            }
        }
    }
}