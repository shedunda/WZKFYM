...
{
    public partial class AdminiGroupList : YSCMS.PageBasic.ManagePage
    {
        ...
        protected void StartLoad(int PageIndex)
        {
            ...
            DataTable dt = YSCMS.CMS.Pagination.GetPage("manage_Sys_admin_group.aspx", PageIndex, 20, out i, out j, st);
        ...
        protected void Del(string ID)
        {
            ...
            agc.Del(ID);
            YSCMS.Common.MessageBox.ShowAndRedirect(this, "删除管理员组成功!", "AdminiGroupList.aspx");
        }
    }
}