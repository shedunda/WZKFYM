...
{
    public partial class AdminAdd : YSCMS.PageBasic.ManagePage
    {
        public AdminAdd()
        {
            Authority_Code = "Q011";
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            if (Page.IsValid == true)                       //判断是否验证成功
            {
                ...
                aci.UserPassword = YSCMS.Common.Input.MD5(Request.Form["UserPwd"].ToString(), true);
                ...
                result = ac.Add(aci);
                if (result == 1)
                    YSCMS.Common.MessageBox.ShowAndRedirect(this, "添加管理员成功!", "AdminList.aspx");
                else if (result == 2)
                    YSCMS.Common.MessageBox.Show(this, "管理员已经存在!");
                else
                    YSCMS.Common.MessageBox.Show(this, "添加管理员失败!");
            }
        }
