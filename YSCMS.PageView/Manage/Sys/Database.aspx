<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Database.aspx.cs" Inherits="YSCMS.PageView.Manage.Sys.Database" %>
...
<div class="mian_wei">
  ...
  <div class="mian_cont">
    ...
    <ul class="tab_zzjs_" id="tab_zzjs_">
          ...
          <li id="tab_zzjs_2" class="nor_zzjs" onclick="ChangeDiv(2);" style="cursor:hand;<% if (YSCMS.Config.UIConfig.WebDAL == "YSCMS.AccessDAL"){ Response.Write("display:none;");}%>">数据库备份 </li>
          <li id="tab_zzjs_3" class="nor_zzjs" onclick="ChangeDiv(3);"> 数据库批量替换</li>
          <li id="tab_zzjs_4" class="nor_zzjs" onclick="ChangeDiv(4);" style="cursor:hand;<% if (YSCMS.Config.UIConfig.WebDAL == "YSCMS.SQLServerDAL"){ Response.Write("display:none;");}%>">数据库压缩 </li>
        </ul>
        <div class="newxiu_bot">
        <div class="dis_zzjs_net" id="Div1">
        ...
        <% if (YSCMS.Config.UIConfig.WebDAL == "YSCMS.SQLServerDAL")
         { 
      %>
      <div  class="undis_zzjs_net" id="Div2">
      ...
      <% }
         ...
         {
      %>
      <div class="undis_zzjs_net" id="Div3">
        <table align="center" width="98%" cellpadding="2" border="0" style=" margin:0 auto;">
          <tr>
            <td><font size="2">数据库备份(只针对Access数据库)</font></td>
          </tr>
          <tr>
            <td height="40"><select id="Select1" runat="server" visible="false">
      ...
      <% } %>
      <div  class="undis_zzjs_net" id="Div4">
        <table align="center" width="98%" cellpadding="2" border="0"  style=" margin:0 auto;">
          <tr>
