<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WindLogin.aspx.cs" Inherits="YSCMS.PageView.Manage.Sys.WindLogin" %>
...
<div class="mian_wei">
  ...
  <table class="nxb_table">
    <tr>
      <td colspan="2" ><span class="span1"></span>注意：配置文件密码默认为<b style="font-weight:100; color:#F00;">yscms.net</b>,管理员请进入配置文件,修改密码。</td>
    </tr>
    <tr>
