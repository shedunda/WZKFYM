...
{
    public partial class Statistics : YSCMS.PageBasic.ManagePage
    {
        ...
        protected void ClassList(int PageIndex)//显示详细记录
        {
            ...
            DataTable dt = YSCMS.CMS.Pagination.GetPage("Manage_Stat_View_1_aspx", PageIndex, num, out i, out j, null);
