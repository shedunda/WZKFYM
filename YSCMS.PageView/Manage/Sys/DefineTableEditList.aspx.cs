...
{
    public partial class DefineTableEditList : YSCMS.PageBasic.ManagePage
    {
        ...
        protected void btnData_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)//判断页面是否通过验证
            {
                ...
                else
                {
                    ...
                    string Str_DefName = YSCMS.Common.Input.Filter(this.DefName.Text.Trim());//名称
                    string Str_DefEname = YSCMS.Common.Input.Filter(this.DefEname.Text.Trim());
                    ...
                    string Str_DefColumns = YSCMS.Common.Input.Filter(this.DefColumns.Text.Trim());
                    string Str_DefExpr = YSCMS.Common.Input.Filter(this.DefExpr.Text.Trim());
                    #region 刷新页面
