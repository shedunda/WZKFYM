...
{
    public partial class General_Manage : YSCMS.PageBasic.ManagePage
    {
        ...
        protected void GenManageList(int PageIndex)
        {
            ...
            if (key != null && key != "")
            {
                ...
                dt = YSCMS.CMS.Pagination.GetPage("General_manage_2_aspx", PageIndex, 20, out i, out j, st);
            }
            else
            {
                dt = YSCMS.CMS.Pagination.GetPage("General_manage_1_aspx", PageIndex, 20, out i, out j, null);
            }
