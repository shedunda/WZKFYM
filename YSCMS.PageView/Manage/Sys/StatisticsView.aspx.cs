...
{
    public partial class StatisticsView : YSCMS.PageBasic.ManagePage
    {
        ...
        void ZongHeStat()//综合统计页面数据控制显示代码
        {
            ...
            DataTable dt = sta.sel_2(viewid, YSCMS.Global.Current.SiteID);
            ...
            else
            {
                ...
                DataTable dt1 = sta.sel_3(newtime, viewid, YSCMS.Global.Current.SiteID);
                dv1 = dt1.DefaultView;
                ...
                DataTable dt2 = sta.sel_New(viewid, YSCMS.Global.Current.SiteID);
                dv1 = dt2.DefaultView;
                dv1.Table.AcceptChanges();
                if (dv1.Count != 0)
                {
                ...
                DataTable dt3 = sta.sel_Year(year, viewid, YSCMS.Global.Current.SiteID);
                dv1 = dt3.DefaultView;
                dv1.Table.AcceptChanges();
                ...
                DataTable dt4 = sta.sel_Month(Month, viewid, YSCMS.Global.Current.SiteID);
                dv1 = dt4.DefaultView;
                dv1.Table.AcceptChanges();
        ...
        protected void StatList(int PageIndex)//显示详细记录
        {
            ...
            DataTable dt = YSCMS.CMS.Pagination.GetPage("Manage_Stat_View_2_aspx", PageIndex, num, out i, out j, sts);
        ...
        string GetCodeUse()//显示代码调用页面
        {
            ...
            liststr = liststr + "<td width=\"88%\"><SPAN class=\"small2\">&lt;script language=&quot;JavaScript&quot; src=&quot;" + YSCMS.Common.Public.GetSiteDomain() + "/stat/mystat.aspx?code=1&id=" + statid + "&quot; type=&quot;text/JavaScript&quot;&gt;&lt;/script&gt;</SPAN></td>\r";
            liststr = liststr + "</tr>\r";

            liststr = liststr + "<tr>\r";
            liststr = liststr + "<td width='12%'><div align=\"center\">图标统计样式</div></td>\r";
            liststr = liststr + "<td width=\"89%\"><SPAN class=\"small2\">&lt;script language=&quot;JavaScript&quot; src=&quot;" + YSCMS.Common.Public.GetSiteDomain() + "/stat/mystat.aspx?code=2&id=" + statid + "&quot; type=&quot;text/JavaScript&quot;&gt;&lt;/script&gt;</SPAN></td>\r";
            liststr = liststr + "</tr>\r";

            liststr = liststr + "<tr>\r";
            liststr = liststr + "<td width='12%'><div align=\"center\">文字统计样式</div></td>\r";
            liststr = liststr + "<td width=\"88%\"><SPAN class=\"small2\">&lt;script language=&quot;JavaScript&quot; src=&quot;" + YSCMS.Common.Public.GetSiteDomain() + "/stat/mystat.aspx?code=0&id=" + statid + "&quot; type=&quot;text/JavaScript&quot;&gt;&lt;/script&gt;</SPAN></td>\r";
            liststr = liststr + "</tr>\r";
