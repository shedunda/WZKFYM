...
{
    public partial class AdminGroupEdit : YSCMS.PageBasic.ManagePage
    {
        ...
        protected void UpdateGroupInfo(string ID)
        {
            ...
            agci.SpecialList = YSCMS.Common.Input.Filter(Request.Form["Sp_List"]);
            agci.channelList = "0";
            ...
            if (result == 1)
                YSCMS.Common.MessageBox.ShowAndRedirect(this, "修改管理员组信息成功!", "AdminiGroupList.aspx");
            else
                YSCMS.Common.MessageBox.Show(this, "修改管理员组信息失败!");
        }
    }
}