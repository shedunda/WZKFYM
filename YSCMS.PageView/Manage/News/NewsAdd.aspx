<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewsAdd.aspx.cs" Inherits="YSCMS.PageView.Manage.News.NewsAdd" %>
...
<script type="text/javascript" language="javascript">
    ...
    KindEditor.ready(function (K) {
        ...
        K('input[name=insertHtml]').click(function (e) {
            ...
            if (str != "") {
                editor.insertHtml('[YS:PAGE=' + str + '$]');
            }
            else {
                editor.insertHtml('[YS:PAGE]');                
            }
            K('#PageTitle').val("");
        });     
