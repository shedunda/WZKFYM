...
{
    public partial class NewsPage : YSCMS.PageBasic.ManagePage
    {
        /// <summary>
        /// 权限设置
        /// </summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                try
                {
                    if (YSCMS.Common.Input.IsInteger(YSCMS.Config.UIConfig.splitPageCount))
                        this.TxtPageCount.Text = YSCMS.Config.UIConfig.splitPageCount;
                }
                catch
                {
                ...
                {
                    YSCMS.Common.MessageBox.ShowAndRedirect(this, "参数错误!", "NewsClassList.aspx");
                }
                else
                {
                    if (Action == "Edit")
                    {
                        ...
                        YSCMS.Model.NewsClass NewsClassModel = NewsClassCMS.GetModel(ClassId);
                    ...
                    else
                    {
                        ...
                        TPath.Text = "/" + YSCMS.Config.UIConfig.dirHtml + "/" + YSCMS.Common.Rand.Str_char(5).ToLower() + ".html";
                        this.TOrder.Text = "0";
                    }
                }
            }
        ...
        protected void Buttonsave_Click(object sender, EventArgs e)
        {
            ...
            if (TParentId.Text.Trim() != "0")
            {
                ...
                {
                    YSCMS.Common.MessageBox.Show(this, "找不到栏目数据！");
                    return;
                }
            }
            ...
            if (!this.zt.Checked)
            {
                ...
                if (Content.Trim() == "")
                {
                    YSCMS.Common.MessageBox.Show(this, "输入内容");
                    return;
                }
            ...
            NewsClassModel.ClassEName = YSCMS.Common.Rand.Str_char(10).ToLower();
            ...
            YSCMS.Common.MessageBox.ShowAndRedirect(this, "保存数据成功!", "NewsClassList.aspx");
        }
    }
}