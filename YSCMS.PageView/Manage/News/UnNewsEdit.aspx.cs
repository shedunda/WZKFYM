...
{
    public partial class UnNewsEdit : YSCMS.PageBasic.ManagePage
    {
        public UnNewsEdit()
        {
            Authority_Code = "C050";
        ...
        {
            String OldNewsId = YSCMS.Common.Input.Filter(Request.Form["NewsID"]);
            String[] Arr_OldNewsId;
            String NewsID, NewsTitle, NewsRow, NewsTable, SubCSS;

            NewsID = Request.Form["TopNewsID"];
            string unName = YSCMS.Common.Input.Filter(this.unName.Text);
            ...
            string unNewsids = YSCMS.Common.Rand.Number(12);
            ...
            {
                NewsTitle = YSCMS.Common.Input.Filter(Request.Form["NewsTitle" + Arr_OldNewsId[For_Num]]);
                NewsRow = YSCMS.Common.Input.Filter(Request.Form["Row" + Arr_OldNewsId[For_Num]]);
                NewsTable = YSCMS.Common.Input.Filter(Request.Form["NewsTable" + Arr_OldNewsId[For_Num]]);
                SubCSS = YSCMS.Common.Input.Filter(Request.Form["SubCSS" + Arr_OldNewsId[For_Num]]);
