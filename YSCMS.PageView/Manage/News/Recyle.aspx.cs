...
{
    public partial class Recyle : YSCMS.PageBasic.ManagePage
    {
        public Recyle()
        {
            Authority_Code = "Q027";
        }
        YSCMS.CMS.Recyle RecyleCMS = new YSCMS.CMS.Recyle();
        ...
        protected string GetMenu(string type)
        {
            ...
            YSCMS.CMS.AdminGroup ac = new YSCMS.CMS.AdminGroup();
            if (type == "NList")
            {
            ...
            if (Optype != null && Optype != "")
            {
                switch (Optype)
                {
                    ...
                    case "PR":  //批量恢复
                        this.Authority_Code = "Q027";
                        this.CheckAdminAuthority();
                        PR(type, YSCMS.Common.Input.CutComma(CheckID(IdList)));
                        break;
                    case "PD":  //批量删除
                        this.Authority_Code = "Q027";
                        this.CheckAdminAuthority();
                        PD(type, YSCMS.Common.Input.CutComma(CheckID(IdList)));
                        break;
                }
            }
        }
        ...
        {
            idlist = YSCMS.Common.Input.Losestr(idlist);
            if (idlist == "IsNull")
                YSCMS.Common.MessageBox.Show(this, "请选择要批量操作的内容!");
            return idlist;
        }
        ...
        {
            YSCMS.CMS.Recyle rc = new YSCMS.CMS.Recyle();
            rc.RallNCList();
            YSCMS.Common.MessageBox.Show(this, "恢复全部新闻栏目成功!");
        }
        ...
        {
            RecyleCMS.RallCList();
            YSCMS.Common.MessageBox.Show(this, "恢复全部频道成功!");
        }
        ...
        {
            RecyleCMS.RallSList();
            YSCMS.Common.MessageBox.Show(this, "恢复全部专题成功!");
        }
        ...
        protected void RallLCList()
        {
            ...
            YSCMS.Common.MessageBox.Show(this, "恢复全部标签栏目成功!");
        }
        ...
        protected void RallLList()
        {
            string ClassID = Request.QueryString["className"];
            if (ClassID == "" || ClassID == null || ClassID == string.Empty)
                YSCMS.Common.MessageBox.Show(this, "请选择要将标签恢复到那个栏目!");
            else
            {
                RecyleCMS.RallLList(ClassID);
                YSCMS.Common.MessageBox.Show(this, "恢复全部标签成功!");
            }
        }
        ...
        protected void RallStCList()
        {
            ...
            YSCMS.Common.MessageBox.Show(this, "恢复全部样式栏目成功!");
        }
        ...
        protected void RallStList()
        {
            string ClassID = Request.QueryString["className"];
            if (ClassID == "" || ClassID == null || ClassID == string.Empty)
                YSCMS.Common.MessageBox.Show(this, "请选择要将样式恢复到那个栏目!");
            else
            {
                RecyleCMS.RallStList(ClassID);
                YSCMS.Common.MessageBox.Show(this, "恢复全部样式成功!");
            }
        }
        ...
        protected void DallNCList()
        {
            YSCMS.CMS.Recyle rc = new YSCMS.CMS.Recyle();
            rc.DallNCList();
            YSCMS.Common.MessageBox.Show(this, "删除全部新闻栏目成功!");
        }
        ...
        {
            RecyleCMS.DallNList();
            YSCMS.Common.MessageBox.Show(this, "删除全部新闻成功!");
        }
        ...
        {
            RecyleCMS.DallCList();
            YSCMS.Common.MessageBox.Show(this, "删除全部频道成功!");
        }
        ...
        {
            RecyleCMS.DallSList();
            YSCMS.Common.MessageBox.Show(this, "删除全部专题成功!");
        }
        ...
        protected void DallLCList()
        {
            ...
            YSCMS.Common.MessageBox.Show(this, "删除全部标签栏目成功!");
        }
        ...
        {
            RecyleCMS.DallLList();
            YSCMS.Common.MessageBox.Show(this, "删除全部标签成功!");
        }
        ...
        protected void DallStCList()
        {
            ...
            YSCMS.Common.MessageBox.Show(this, "删除全部样式栏目成功!");
        }
        ...
        protected void DallStList()
        {
            ...
            YSCMS.Common.MessageBox.Show(this, "删除全部样式成功!");
        }
        ...
        protected void PRNCList(string idlist)
        {
            ...
            YSCMS.Common.MessageBox.Show(this, "批量恢复新闻栏目成功!");
        }
        ...
        protected void PRNList(string idlist)
        {
            string ClassID = Request.QueryString["className"];
            if (ClassID == "" || ClassID == null || ClassID == string.Empty)
                YSCMS.Common.MessageBox.Show(this, "请选择要将新闻恢复到那个栏目!");
            else
            {
                RecyleCMS.PRNList(ClassID, idlist);
                YSCMS.Common.MessageBox.Show(this, "批量恢复新闻成功!");
            }
        }
        ...
        protected void PRCList(string idlist)
        {
            ...
            YSCMS.Common.MessageBox.Show(this, "批量恢复频道成功!");
        }
        ...
        protected void PRSList(string idlist)
        {
            ...
            YSCMS.Common.MessageBox.Show(this, "批量恢复专题成功!");
        }
        ...
        protected void PRStCList(string idlist)
        {
            ...
            YSCMS.Common.MessageBox.Show(this, "批量恢复样式栏目成功!");
        }
        ...
        protected void PRStList(string idlist)
        {
            ...
            else
            {
                ...
                YSCMS.Common.MessageBox.Show(this, "批量恢复样式成功!");
            }
        }
        ...
        protected void PRLCList(string idlist)
        {
            ...
            YSCMS.Common.MessageBox.Show(this, "批量恢复标签栏目成功!");
        }
        ...
        protected void PRLList(string idlist)
        {
            ...
            else
            {
                ...
                YSCMS.Common.MessageBox.Show(this, "批量恢复标签成功!");
            }
        }
        ...
        protected void PDNCList(string idlist)
        {
            ...
            YSCMS.Common.MessageBox.Show(this, "批量删除新闻栏目成功!");
        }
        ...
        protected void PDNList(string idlist)
        {
            ...
            YSCMS.Common.MessageBox.Show(this, "批量删除新闻成功!");
        }
        ...
        protected void PDCList(string idlist)
        {
            ...
            YSCMS.Common.MessageBox.Show(this, "批量删除频道成功!");
        }
        ...
        protected void PDSList(string idlist)
        {
            ...
            YSCMS.Common.MessageBox.Show(this, "批量删除专题成功!");
        }
        ...
        protected void PDStCList(string idlist)
        {
            ...
            YSCMS.Common.MessageBox.Show(this, "批量删除样式栏目成功!");
        }
        ...
        protected void PDStList(string idlist)
        {
            ...
            YSCMS.Common.MessageBox.Show(this, "批量删除样式成功!");
        }
        ...
        protected void PDLCList(string idlist)
        {
            ...
            YSCMS.Common.MessageBox.Show(this, "批量删除标签栏目成功");
        }
        ...
        protected void PDLList(string idlist)
        {
            ...
            YSCMS.Common.MessageBox.Show(this, "批量删除标签成功");
        }
