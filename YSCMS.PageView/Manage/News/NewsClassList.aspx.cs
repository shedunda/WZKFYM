...
{
    public partial class NewsClassList : YSCMS.PageBasic.ManagePage
    {
        ...
        YSCMS.CMS.RootPublic RootPublicCMS = new CMS.RootPublic();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (stat != "" && stat != null)
                {
                    ...
                    string Classid = YSCMS.Common.Input.Filter(Request.QueryString["id"]);
                    NewsClassCMS.SetLock(Classid);
                    RootPublicCMS.SaveUserAdminLogs(0, 1, UserNum, "锁定/解锁操作", "锁定/解锁操作栏目.ClassID:" + Request.Form["Checkbox1"] + "");
                    YSCMS.Common.MessageBox.ShowAndRedirect(this, "锁定/解锁操作栏目成功!", "NewsClassList.aspx");
                }
        ...
        protected void UpdateOrder(string ClassID, int OrderID)
        {
            ...
            YSCMS.Common.MessageBox.ShowAndRedirect(this, "更新权重成功!", "NewsClassList.aspx");
        }
        //数据初始化
        protected void StartLoad(int pageIndex)
        {
            ...
            int RecordCount = 0;
            int PageCount = 0;
            DataTable dt = NewsClassCMS.GetPage(SiteID, YSCMS.Config.UIConfig.GetPageSize(), pageIndex, out RecordCount, out PageCount);
            if (dt != null)
            {
        ...
        protected void LinkButton1_Click(object sender, EventArgs e)
        {
            ...
            YSCMS.Common.MessageBox.ShowAndRedirect(this, "操作成功,此操作对锁定栏目无效!", "NewsClassList.aspx");
        }
        ...
        protected void del_allClass(object sender, EventArgs e)
        {
            ...
            //此处进行静态文件的删除
            YSCMS.Common.MessageBox.ShowAndRedirect(this, "初始化栏成功!", "NewsClassList.aspx");
        }
        ...
        protected void Lock_Click(object sender, EventArgs e)
        {
            ...
            {
                YSCMS.Common.MessageBox.Show(this, "请至少选择一项!");
            }
            else
            {
                ...
                RootPublicCMS.SaveUserAdminLogs(0, 1, UserNum, "锁定/解锁操作", "锁定/解锁操作栏目.ClassID:" + Request.Form["Checkbox1"] + "");
                //此处进行静态文件的删除
                YSCMS.Common.MessageBox.ShowAndRedirect(this, "锁定/解锁操作栏目成功,请返回继续操作!", "NewsClassList.aspx");
            }
        }
        ...
        protected void AllDel_Click(object sender, EventArgs e)
        {
            ...
            if (Str == null || Str == String.Empty)
            {
                YSCMS.Common.MessageBox.Show(this, "请先选择删除项!");
            }
            else
            {
                ...
                for (int i = 0; i < Checkbox.Length; i++)
                {
                    ...
                    if (dtcount.Select("ClassID='" + Checkbox[i].ToString() + "'").Length == 0)
                    {
                        ...
                        {
                            YSCMS.Common.MessageBox.ShowAndRedirect(this, "删除数据到回收站失败!此栏目下有子栏目,不能删除!", "NewsClassList.aspx");
                        }
                    }
                    else
                    {
                        YSCMS.Common.MessageBox.ShowAndRedirect(this, "删除数据到回收站失败!栏目下的新闻不能删除!", "NewsClassList.aspx");
                    }
                }
                RootPublicCMS.SaveUserAdminLogs(1, 1, UserNum, "删除栏目", "删除栏目到回收站.ClassID:" + Request.Form["Checkbox1"] + "");
                YSCMS.Common.MessageBox.ShowAndRedirect(this, "删除数据到回收站成功,请返回继续操作!", "NewsClassList.aspx");
            }
        }
        ...
        protected void Selected_del_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                for (int i = 0; i < Checkbox.Length; i++)
                {
                    ...
                    {
                        YSCMS.Common.MessageBox.ShowAndRedirect(this, "彻底删除栏目失败!原因:此栏目下有新闻!", "NewsClassList.aspx");
                    }
                }
                RootPublicCMS.SaveUserAdminLogs(1, 1, UserNum, "删除栏目", "彻底删除栏目.ClassID:" + Request.Form["Checkbox1"] + "");
                //此处进行静态文件的删除
                YSCMS.Common.MessageBox.ShowAndRedirect(this, "彻底删除栏目成功!", "NewsClassList.aspx");
            }
        }
        ...
        protected void MakeXML(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                for (int i = 0; i < Checkbox.Length; i++)
                {
                    if (YSCMS.Publish.General.PublishXML(Checkbox[i]))
                    {
                        j++;
                    }
                }
                YSCMS.Common.MessageBox.ShowAndRedirect(this, "生成" + j + "个XML成功!", "NewsClassList.aspx");
            }
        }
        ...
        protected void MakeHTML(object sender, EventArgs e)
        {
            ...
            {
                YSCMS.Common.HProgressBar.Start();
                YSCMS.Publish.General PG = new YSCMS.Publish.General();
                try
                {
                    YSCMS.Common.HProgressBar.Roll("正在发布栏目", 0);
                    ...
                    for (int i = 0; i < m; i++)
                    {
                        ...
                        else
                        {
                            if (publishType == "0")
                            {
                                if (YSCMS.Publish.General.PublishPage(Checkboxs[i].ToString()))
                                {
                                    j++;
                                }
                            }
                        ...
                        YSCMS.Common.HProgressBar.Roll("共生成" + m + "个栏目，正在发布" + (i + 1) + "个。", ((i + 1) * 100 / m));
                    }
                    YSCMS.Common.HProgressBar.Roll("发布栏目成功,成功" + j + "个,<a href=\"../Publish/error/geterror.aspx?\">失败" + (Checkboxs.Length - j) + "个(可能有栏目有浏览权限)</a>. &nbsp;<a href=\"NewsClassList.aspx\">返回</a>", 100);
                }
                catch (Exception ex)
                {
                    YSCMS.Common.Public.savePublicLogFiles("□□□发布栏目", "【错误描述：】\r\n" + ex.ToString(), UserName);
                    YSCMS.Common.HProgressBar.Roll("发布栏目失败。<a href=\"../publish/error/geterror.aspx?\">查看日志</a>", 0);
                }
                Response.End();
            }
        }
        ...
        protected void MakeClassIndex(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                for (int i = 0; i < Checkboxs.Length; i++)
                {
                    if (NewsClassCMS.GetClassPage(Checkboxs[i]) == 0)
                    {
                        if (YSCMS.Publish.General.PublishClassIndex(Checkboxs[i]))
                        {
                            j++;
                        }
                        else
        ...
        protected void ClearNewsInfo(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                YSCMS.Common.MessageBox.ShowAndRedirect(this, "清除数据成功!", "NewsClassList.aspx");
            }
        }
