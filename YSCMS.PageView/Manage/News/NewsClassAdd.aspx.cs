...
{
    public partial class NewsClassAdd : YSCMS.PageBasic.ManagePage
    {
        /// <summary>
        /// 权限设置
        /// </summary>
        ...
        YSCMS.CMS.DefineData DefineDataCMS = new DefineData();
        public string dirm = YSCMS.Config.UIConfig.dirDumm;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (GetSiteID == null)
                {
                    YSCMS.Common.MessageBox.Show(this, "错误的参数,请先选择频道!");
                }
                ...
                if (Action != null && Action != "")
                {
                    ...
                    {
                        YSCMS.Common.MessageBox.ShowAndRedirect(this, "参数不正确,请返回正确操作!", "NewsClassList.aspx");
                    }
                }
                else
                {
        ...
        protected void ChangeStatic(string classId)
        {
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                ...
                HtmlPhrasing.Text = YSCMS.Common.Input.ToTxt(dt.Rows[0]["NaviPosition"].ToString());
                NewsHtmlPhrasing.Text = YSCMS.Common.Input.ToTxt(dt.Rows[0]["NewsPosition"].ToString());
                Hidden.Value = "Add";
            ...
            {
                YSCMS.Common.MessageBox.ShowAndRedirects(this, "参数不正确,请正确操作!", "NewsClassList.aspx");
            }
        ...
        protected void SatratData(string Pram)
        {
            ...
            if (Pram != "yscms")
            {
                ...
                if (dt != null)
                {
                    ...
                    {
                        YSCMS.Common.MessageBox.ShowAndRedirects(this, "传入的参数不正确!", "NewsClassList.aspx");
                    }
                }
                else
                {
            ...
            if (Page.IsValid)
            {
                ...
                switch (VclassId)
                {
                    ...
                    case "Add":
                        ...
                        break;
                    default:
                        YSCMS.Common.MessageBox.ShowAndRedirects(this, "参数不正确,请重新正确操作!", "NewsClassList.aspx");
                        break;
                }
            }
            #endregion
        ...
        protected void SaveData(int interChar)
        {
            if (Page.IsValid)                       //判断是否验证成功
            {
                ...
                if (interChar == 0)
                {
                    ClassID = YSCMS.Common.Rand.Number(12);
                    ...
                    {
                        YSCMS.Common.MessageBox.Show(this, "栏目的英文名称在站点中已经存在!");
                        return;
                    }
                }
                else
                ...
                YSCMS.Model.NewsClass NewsClassModel = new YSCMS.Model.NewsClass();
                ...
                if (NewsClassModel.IsURL == 1)
                {
                    ...
                    {
                        YSCMS.Common.MessageBox.Show(this, "请正确外部连接地址!");
                        return;
                    }
                }
                ...
                if (NewsClassModel.Domain != null && NewsClassModel.Domain != "")
                {
                    ...
                    {
                        YSCMS.Common.MessageBox.Show(this, "请正确填写域名地址!");
                        return;
                    }
                }
                ...
                {
                    YSCMS.Common.MessageBox.Show(this, "文件名规则必须填写文件名!");
                    return;
                }
                ...
                if (this.draw.Checked == true)
                {
                    ...
                    {
                        YSCMS.Common.MessageBox.Show(this, "请正确填写画中画内容!");
                        return;
                    }
                    if (((this.drawWith.Text).ToString()).Length < 1)
                    {
                        YSCMS.Common.MessageBox.Show(this, "请正确填写画中画图片(Flash)，代码的宽度!");
                        return;
                    }
                    if (((this.drawHeight.Text).ToString()).Length < 1)
                    {
                        YSCMS.Common.MessageBox.Show(this, "请正确填写画中画图片(Flash),代码的高度!");
                        return;
                    }
                }
                ...
                YSCMS.Common.Public.SaveClassXML(NewsClassModel.ClassEName);
                if (interChar == 0)
                {
                    ...
                    YSCMS.Common.MessageBox.ShowAndRedirect(this, "添加栏目成功!", "NewsClassList.aspx");
                }
                else
                {
                    ...
                    DropTempletCMS.AddTemplet(ClassID, dTemplet.Text, dListTemplets.Text, "1");
                    YSCMS.Common.MessageBox.ShowAndRedirect(this, "修改栏目成功!", "NewsClassList.aspx");
                }
                #endregion 得到表单值
        ...
        protected string GetClassSavePath()
        {
            ...
            {
                ClassSavePath = YSCMS.Config.UIConfig.dirHtml;
            }
