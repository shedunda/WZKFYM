...
{
    public partial class SpecialAdd : YSCMS.PageBasic.ManagePage
    {
        public SpecialAdd()
        {
            Authority_Code = "C099";
        ...
        public string DirHtml = YSCMS.Config.UIConfig.dirHtml;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (SiteID != "0") { DirHtml = YSCMS.Config.UIConfig.dirSite; }
                ...
                if (parentID != null && parentID != "")
                {
                    ...
                    YSCMS.Model.NewsSpecial NewsSpecialModel = NewsSpecialCMS.GetModel(parentID);
                ...
                this.S_SavePath.Text = "/" + YSCMS.Config.UIConfig.dirHtml + "/special";
            }
        }
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                //-----------------取得表单内容
                YSCMS.Model.NewsSpecial NewsSpecialModel = new YSCMS.Model.NewsSpecial();
                ...
                string DirPath = YSCMS.CMS.CommStr.FileRandName(Request.Form["S_DirRule"]);
                string SaveTP = Request.Form["S_SavePath"].Replace("{@dirHtml}", YSCMS.Config.UIConfig.dirHtml);
                string fName = YSCMS.CMS.CommStr.FileRandName(Request.Form["S_FileRule"]).Replace("{@EName}", Request.Form["S_Ename"]);
                ...
                string SpecialId = YSCMS.Common.Rand.Number(12);
                ...
                if (arr_result[0].ToString() == "1")
                {
                    ...
                    YSCMS.Common.MessageBox.ShowAndRedirect(this, "添加专题成功!", "SpecialList.aspx");
                }
                else
                    YSCMS.Common.MessageBox.Show(this, result);
            }
        }
    }
}