...
{
    public partial class SortPage : YSCMS.PageBasic.ManagePage
    {
        ...
        protected void StartLoad(int PageIndex)
        {
            ...
            //string _tmp = "";
            //string _tmp1 = "";
            //DataTable dt = YSCMS.CMS.Pagination.GetPage(this.GetType().Name, PageIndex, 20, out i, out j, null);
        ...
        protected void LandCheand()
        {
            ...
            //Page.RegisterStartupScript("yscms", "<script>document.getElementById(\"uniteTable\").style.display=\"\";</script>");
            //初始化源栏目控件
        ...
        protected void Btc_Click(object sender, EventArgs e)
        {
            ...
            if (Source_ == Target_)
                YSCMS.Common.MessageBox.ShowAndRedirect(this, "源栏目与目标栏目相同,操作失败!", "SortPage.aspx?Acton=unite");

            if (HiddSize == "unite")
            {
                if (Source_ == null || Target_ == null || Source_ == "" || Target_ == "")
                {
                    YSCMS.Common.MessageBox.ShowAndRedirect(this, "合并栏目出现异常错误!", "SortPage.aspx?Acton=unite");
                }
                else
                {
                    //删除源栏目
                    ...
                    YSCMS.Common.MessageBox.ShowAndRedirect(this, "合并数据成功!", "SortPage.aspx?Acton=unite");
                }
            }
            else
            {
                if (Source_ == null || Target_ == null || Source_ == "" || Target_ == "")
                {
                    YSCMS.Common.MessageBox.ShowAndRedirect(this, "转移栏目出现异常错误!", "SortPage.aspx?Acton=allmove");
                }
                else
                {
                    //更改源栏目父ID
                    ...
                    YSCMS.Common.MessageBox.ShowAndRedirect(this, "数据转移成功!", "SortPage.aspx?Acton=allmove");
                }
