<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewsList.aspx.cs" Inherits="YSCMS.PageView.Manage.News.NewsList" %>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function XMLRefresh() {
         ...
         function ClickHandler(obj) {
             ...
             location.href = "NewsManage.aspx?Option=" + obj + "&ids=" + strn + "&dbtab=<%Response.Write(YSCMS.Config.UIConfig.dataRe); %>news";
        }
         ...
         <table class="nwelie_table" align="center" cellspacing="1">
            ...
            <tr  class="off" onmouseover="this.className='on'"onmouseout="this.className='off'">
               ...
               <td align="center"><a href="Newslist.aspx?ClassID=<%#((DataRowView)Container.DataItem)["ClassID"]%>&Editor=<%#((DataRowView)Container.DataItem)["Editor"]%>" title="查看此编辑/会员的文章" class="xa3">
							<%#((DataRowView)Container.DataItem)["Editor"]%></a><a href="../../<%Response.Write(YSCMS.Config.UIConfig.dirUser); %>/showuser-<%#((DataRowView)Container.DataItem)["Editor"]%>.aspx" target="_blank">&nbsp;<img src="../imges/lie_78.gif" alt="" /></a></td>
               <td align="center">
