<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="YSCMS.PageView.Install.Index" %>
                                ...
                                <tr>
                                    <td background="image/01.jpg">
                                        <font color="#ffffff">欢迎安装
                                            <%=YSCMS.Install.Config.producename%>
                                        </font>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td style="line-height:24px; padding-top:30px; font-size:12px">
                                        <p style="padding:0; margin:0; font-size:12px;">
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 欢迎您选择安装<%=YSCMS.Install.Config.producename%></p>
                                        <p style="padding:0; margin:0; font-size:12px;">
