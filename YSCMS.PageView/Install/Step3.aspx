<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="step3.aspx.cs" Inherits="YSCMS.PageView.Install.Step3" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title><%=YSCMS.Install.Config.title%></title>
...
<body bgcolor="#016AA9" onload="SelectChange('Access')">
						...
						<td width="520" valign="top">
							...
							<table cellspacing="0" cellpadding="8" width="98%" border="0" style="background-color: #f5f5f5; font-size:12px;">
								...
								<tr id="tr2" style="display: none">
									...
									<td>
										<asp:TextBox ID="initialcatalog" runat="server" Text="YSCMSv3" Width="150" Enabled="true"></asp:TextBox>
                                        <font color="red"> * </font>
                                        <span id="msg2"></span>
									</td>
								</tr>
								...
								<tr id="tr4" style="display: none">
									<td width="150" align="right" class="auto-style1">
										数据库用户口令:
									</td>
								...
								<tr id="tr5">
									...
									<td>
										<asp:TextBox ID="SN" runat="server" Text="" Width="250" Enabled="true" MaxLength="30"></asp:TextBox>
                                        <font color="red"> * </font>
                                        <span id="Span1"></span>
									</td>
								</tr>
								<tr id="tr6" style="display: none;">
									...
									<td align="left" valign="middle">
										<asp:TextBox ID="yscmsPath" runat="server" Text="/YS_Data/YSCMSv3.mdb" Width="250" Enabled="true" MaxLength="30"></asp:TextBox>
                                        <font color="red"> * </font>
                                        <span id="msg5"></span>
									</td>
								</tr>
								<tr id="tr8" style="display: none;">
									...
									<td align="left" valign="middle">
										<asp:TextBox ID="helpkeypath" runat="server" Text="/YS_Data/ys_help.mdb" Width="250" Enabled="true" MaxLength="30"></asp:TextBox>
                                        <font color="red"> * </font>
                                        <span id="Span2"></span>
									</td>
								</tr>
								<tr id="tr9" style="display: none;">
									...
									<td align="left" valign="middle">
										<asp:TextBox ID="collectpath" runat="server" Text="/YS_Data/ys_collect.mdb" Width="250" Enabled="true" MaxLength="30"></asp:TextBox>
                                        <font color="red"> * </font>
                                        <span id="Span3"></span>
									</td>
								</tr>
								...
								<tr id="tabfix" style="display: block">
									<td width="150" align="right">
										数据库表名称前缀:
									</td>
									<td>
										<asp:TextBox ID="tableprefix" runat="server" Width="150" Enabled="true" Text="Ys_" onblur="checkid(this,'tableprefix')"></asp:TextBox>
                                        <font color="red"> * </font>
	...
	<div style="margin-top:10px; font-size:12px; line-height:24px; color:#FFF;"><%=YSCMS.Install.Config.corpRight%></div>
</body>
</html>
<script type="text/javascript">
	...
	function showLoading() {
		...
		var yscmsPath = document.getElementById("yscmsPath");
		...
		if (gDbType.value.toLowerCase() == "access") {
			...
			var action = "SN=" + gSN.value + "&set=1&yscmsPath=" + yscmsPath.value + "&helpkeyPath=" + helpkeyPath.value + "&collectPath=" + collectPath.value;
		...
		var Action = 'sn=' + gSN.value + '&set=1&DbType=' + gDbType.value + '&datasource=' + gdatasource.value + '&initialcatalog=' + ginitialcatalog.value + '&userid=' + guserid.value + '&password=' + gpassword.value + '&gtableprefix=ys_';
		$.get('step3.aspx?' + Action + '&no-cache=' + Math.random(), function (returnvalue) {
		    if (returnvalue.indexOf("??") > -1)
		        document.getElementById("MessageID").innerHTMLL = '发生错误';
		    else
