<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Step4.aspx.cs" Inherits="YSCMS.PageView.Install.Step4" %>
							...
							<table cellspacing="0" cellpadding="8" width="98%" border="0" style="background-color: #f5f5f5; font-size:12px; padding-bottom:30px;">
								...
								<tr>
                                   <td width="150" align="right"></td>
									<td width="568">
										<asp:Button ID="btnCreate" runat="server" Text="创建管理员" OnClick="btnCreate_Click" style="width:100px;height:21px;line-height:21px;border:medium none;margin:0;padding:0; background:url(../CSS/blue/imges/subite.gif) no-repeat;"/>
									</td>
								</tr>
							</table>
						</td>
