<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="step1.aspx.cs" Inherits="YSCMS.PageView.Install.Step1" %>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="8">
                                <tr>
                                    <td background="image/01.jpg">
                                        <font color="#ffffff">
                                            <%=YSCMS.Install.Config.producename%> 安装协议
                                        </font>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table id="Table2" cellspacing="1" cellpadding="1" width="90%" align="center" border="0">
                                <tr>
                                    <td style="line-height:24px; font-size:12px">
                                        <%=YSCMS.Install.Config.regprotocol%>
                                    </td>
                                </tr>
                            </table>
                            <p>
