<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="step2.aspx.cs" Inherits="YSCMS.PageView.Install.Step2" %>
							...
							<table id="Table2" cellspacing="1" cellpadding="1" width="90%" align="center" border="0">
								<tr>
									<td style="line-height:24px; font-size:12px">
										...
										<%
											bool err = false;
											string result = YSCMS.Install.Config.InitialSystemValidCheck(ref err);
