...
<script language="c#" runat="server">
    ...
    /// <param name="str_ys_url">当前地址</param>
    ...
    str_ys_url = ServerVariables["URL"].ToString();
    str_ys_url = str_ys_url.Substring(0, str_ys_url.IndexOf("mystat.aspx", 0, str_ys_url.Length));
    str_ys_url = "http://" + ServerVariables["HTTP_HOST"].ToString() + str_ys_url;
    //-------------------------------------------------------------------------------
    }
</script>
<!-------------------打出各个变量（code,strtheurl）--------------------------------->
document.write("<script>var code = '<%=code%>'; var url = '<%=str_ys_url%>'; var statid = '<%=statid %>'</script>")
