...
{
    public partial class TopNews : YSCMS.PageBasic.BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            str_masscontent = str_masscontent.Replace("YS:LabelType=TopNews", "YS:LabelType=TopNews1");
            ...
            YSCMS.Publish.LabelMass labelmass = new YSCMS.Publish.LabelMass(str_masscontent, str_currentclassid, str_currentspecialid, str_currentnewsid, str_ChID, str_currentchclassid, str_currentchspecialid, str_currentchnewsid);
            labelmass.TemplateType = (YSCMS.Publish.TempType)(int.Parse(str_templatetype));
