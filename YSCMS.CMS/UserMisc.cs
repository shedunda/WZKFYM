...
namespace YSCMS.CMS
{
    public class UserMisc
    {
        ...
        public void InsertManageMenu(YSCMS.Model.UserInfo7 uc)
        {
        ...
        public void EditManageMenu(YSCMS.Model.UserInfo7 uc)
        {
            dal.EditManageMenu(uc);
        }

        public void EditManageMenu1(YSCMS.Model.UserInfo7 uc)
        {
        ...
        public void InsertQMenu(YSCMS.Model.UserInfo8 uc)
        {
            dal.InsertQMenu(uc);
        }

        public void UpdateQMenu(YSCMS.Model.UserInfo8 uc)
        {
            dal.UpdateQMenu(uc);
        }
        ...
        public void UpdateUserInfoContact1(YSCMS.Model.UserInfo2 uc)
        {
            dal.UpdateUserInfoContact1(uc);
        }

        public void UpdateUserInfoContact2(YSCMS.Model.UserInfo2 uc)
        {
        ...
        public void InsertGroup(YSCMS.Model.UserInfo4 uc)
        {
            dal.InsertGroup(uc);
        }
        ...
        public void updateGroupEdit(YSCMS.Model.UserInfo4 uc)
        {
        ...
        public void InsertAnnounce(YSCMS.Model.UserInfo5 uc)
        {
            dal.InsertAnnounce(uc);
        }

        public void UpdateAnnounce(YSCMS.Model.UserInfo5 uc)
        {
        ...
        public void UpdateOnlinePay(YSCMS.Model.UserInfo6 uc)
        {
