...
namespace YSCMS.CMS
{
    ...
    public partial class NewsJS
    {
        ...
        /// 增加一条数据
        /// </summary>
        public string Add(YSCMS.Model.NewsJS model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public string Update(YSCMS.Model.NewsJS model)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public YSCMS.Model.NewsJS GetModel(string jsID)
        {

            return dal.GetModel(jsID);
        }
        public YSCMS.Model.NewsJS GetModel(int id)
        {
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public YSCMS.Model.NewsJS GetModelByCache(string jsID)
        {
            ...
            return (YSCMS.Model.NewsJS)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSCMS.Model.NewsJS> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSCMS.Model.NewsJS> DataTableToList(DataTable dt)
        {
            List<YSCMS.Model.NewsJS> modelList = new List<YSCMS.Model.NewsJS>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                YSCMS.Model.NewsJS model;
                for (int n = 0; n < rowsCount; n++)
                {
                    model = new YSCMS.Model.NewsJS();
