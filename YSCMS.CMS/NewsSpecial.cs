...
namespace YSCMS.CMS
{
    ...
    public partial class NewsSpecial
    {
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public YSCMS.Model.NewsSpecial GetModelByCache(string SpecialID)
        {
            ...
            return (YSCMS.Model.NewsSpecial)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSCMS.Model.NewsSpecial> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSCMS.Model.NewsSpecial> DataTableToList(DataTable dt)
        {
            List<YSCMS.Model.NewsSpecial> modelList = new List<YSCMS.Model.NewsSpecial>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                YSCMS.Model.NewsSpecial model;
                for (int n = 0; n < rowsCount; n++)
                {
                    model = new YSCMS.Model.NewsSpecial();
