...
namespace YSCMS.CMS
{
    ...
    {
        private readonly YSCMS.IDAL.INewsClass dal = DataAccess.CreateNewsClass();
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public YSCMS.Model.NewsClass GetModelByCache(string ClassID)
        {
            ...
            return (YSCMS.Model.NewsClass)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSCMS.Model.NewsClass> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSCMS.Model.NewsClass> DataTableToList(DataTable dt)
        {
            List<YSCMS.Model.NewsClass> modelList = new List<YSCMS.Model.NewsClass>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                YSCMS.Model.NewsClass model;
                for (int n = 0; n < rowsCount; n++)
                {
                    model = new YSCMS.Model.NewsClass();
