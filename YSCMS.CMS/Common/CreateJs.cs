...
public class CreateJs {
	private static string SessionID = YSCMS.Global.Current.SiteID;
	private static string DirMana = YSCMS.Config.UIConfig.dirDumm;
    private static string Rootpath = YSCMS.Common.ServerInfo.GetRootPath();
    private static string SiteDomain = YSCMS.Common.Public.GetSiteDomain();
	...
	public static string ReplaceDirfile(string picpath) {
		string str_Temppath = picpath.Replace("{@dirfile}", YSCMS.Config.UIConfig.dirFile);
		return str_Temppath;
	}
