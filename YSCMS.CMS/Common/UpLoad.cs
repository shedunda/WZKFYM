            ...
            if (PostedFile != null)
            {
                ...
                try
                {
                    ...
                    if (isAdmin != 1)
                    {
                        ...
                        DataTable dt = pd.GetGroupUpInfo(YSCMS.Global.Current.UserNum);
                    ...
                    YSCMS.CMS.Attachments AttachmentsCMS = new Attachments();
                    YSCMS.Model.Attachments AttachmentsModel = new Model.Attachments();
