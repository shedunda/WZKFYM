...
namespace YSCMS.CMS
{
    ...
    public partial class NewsJSTemplet
    {
        ...
        /// 增加一条数据
        /// </summary>
        public bool Add(YSCMS.Model.NewsJSTemplet model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(YSCMS.Model.NewsJSTemplet model)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public YSCMS.Model.NewsJSTemplet GetModel(string templetID)
        {

            return dal.GetModel(templetID);
        }

        public YSCMS.Model.NewsJSTemplet GetModel(int id)
        {
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public YSCMS.Model.NewsJSTemplet GetModelByCache(string templetID)
        {
            ...
            return (YSCMS.Model.NewsJSTemplet)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSCMS.Model.NewsJSTemplet> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSCMS.Model.NewsJSTemplet> DataTableToList(DataTable dt)
        {
            List<YSCMS.Model.NewsJSTemplet> modelList = new List<YSCMS.Model.NewsJSTemplet>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                YSCMS.Model.NewsJSTemplet model;
                for (int n = 0; n < rowsCount; n++)
                {
                    model = new YSCMS.Model.NewsJSTemplet();
