...
namespace YSCMS.CMS
{
    ...
    public partial class DefineData
    {
        ...
        /// 增加一条数据
        /// </summary>
        public bool Add(YSCMS.Model.DefineData model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(YSCMS.Model.DefineData model)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public YSCMS.Model.DefineData GetModel(int id)
        {
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public YSCMS.Model.DefineData GetModelByCache(int id)
        {
            ...
            return (YSCMS.Model.DefineData)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSCMS.Model.DefineData> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSCMS.Model.DefineData> DataTableToList(DataTable dt)
        {
            List<YSCMS.Model.DefineData> modelList = new List<YSCMS.Model.DefineData>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                YSCMS.Model.DefineData model;
                for (int n = 0; n < rowsCount; n++)
                {
                    model = new YSCMS.Model.DefineData();
