...
namespace YSCMS.CMS
{
    ...
    public partial class NewsJSTempletClass
    {
        ...
        /// 增加一条数据
        /// </summary>
        public bool Add(YSCMS.Model.NewsJSTempletClass model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(YSCMS.Model.NewsJSTempletClass model)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public YSCMS.Model.NewsJSTempletClass GetModel(string classID)
        {
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public YSCMS.Model.NewsJSTempletClass GetModelByCache(string classID)
        {
            ...
            return (YSCMS.Model.NewsJSTempletClass)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSCMS.Model.NewsJSTempletClass> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSCMS.Model.NewsJSTempletClass> DataTableToList(DataTable dt)
        {
            List<YSCMS.Model.NewsJSTempletClass> modelList = new List<YSCMS.Model.NewsJSTempletClass>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                YSCMS.Model.NewsJSTempletClass model;
                for (int n = 0; n < rowsCount; n++)
                {
                    model = new YSCMS.Model.NewsJSTempletClass();
