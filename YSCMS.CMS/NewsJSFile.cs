...
namespace YSCMS.CMS
{
    ...
    public partial class NewsJSFile
    {
        ...
        /// 增加一条数据
        /// </summary>
        public bool Add(YSCMS.Model.NewsJSFile model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(YSCMS.Model.NewsJSFile model)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public YSCMS.Model.NewsJSFile GetModel(string jsID)
        {
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public YSCMS.Model.NewsJSFile GetModelByCache(string jsID)
        {
            ...
            return (YSCMS.Model.NewsJSFile)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSCMS.Model.NewsJSFile> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSCMS.Model.NewsJSFile> DataTableToList(DataTable dt)
        {
            List<YSCMS.Model.NewsJSFile> modelList = new List<YSCMS.Model.NewsJSFile>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                YSCMS.Model.NewsJSFile model;
                for (int n = 0; n < rowsCount; n++)
                {
                    model = new YSCMS.Model.NewsJSFile();
