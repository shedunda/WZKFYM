...
namespace YSCMS.CMS
{
    ...
    public partial class Navi
    {
        ...
        /// 增加一条数据
        /// </summary>
        public bool Add(YSCMS.Model.Navi model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(YSCMS.Model.Navi model)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public YSCMS.Model.Navi GetModel(string am_ID)
        {
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public YSCMS.Model.Navi GetModelByCache(string am_ID)
        {
            ...
            return (YSCMS.Model.Navi)objModel;
        }
        /// <summary>
        /// 获得数据列表
        /// </summary>
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSCMS.Model.Navi> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSCMS.Model.Navi> DataTableToList(DataTable dt)
        {
            List<YSCMS.Model.Navi> modelList = new List<YSCMS.Model.Navi>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                YSCMS.Model.Navi model;
                for (int n = 0; n < rowsCount; n++)
                {
                    model = new YSCMS.Model.Navi();
