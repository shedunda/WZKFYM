...
namespace YSCMS.CMS
{
    public class SearchEngine
    {
        ...
        /// 得到虚拟目录
        /// </summary>
        private static string _dirdumm = YSCMS.Config.UIConfig.dirDumm;
        ...
        public static void RefreshBaidu()
        {
            ...
            string website = "www.yuesisoft.com";
            string webmaster = "service@yuesisoft.com";
                    ...
                    if (dt.Rows.Count > i)
                    {
                        try
                        {
                            ...
                            if (drs.Read())
                            {
                                ...
                                if (drs["PicURL"].ToString().Trim() != "" && drs["PicURL"].ToString().Trim() != null) { sw.WriteLine("      <image>http://" + website + _dirdumm + (drs["PicURL"].ToString()).Replace("{@dirfile}", YSCMS.Config.UIConfig.dirFile) + "</image>"); }
