...
namespace YSCMS.CMS
{
	public class Label
	{
		...
		//string Label_Name = YSCMS.Common.Public.getXmlValue(xmlPath, "labelname");
		//string Label_Content = YSCMS.Common.Public.getXmlValue(xmlPath, "labelcontent");
		//string Description = YSCMS.Common.Public.getXmlValue(xmlPath, "labeldescription");
		//string CreatTime = YSCMS.Common.Public.getXmlValue(xmlPath, "labelcreattime");
		//string isSys = YSCMS.Common.Public.getXmlValue(xmlPath, "labelissys");
		//string SiteID = YSCMS.Global.Current.SiteID;
