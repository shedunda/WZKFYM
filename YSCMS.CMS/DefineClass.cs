...
namespace YSCMS.CMS
{
    ...
    public partial class DefineClass
    {
        ...
        /// 增加一条数据
        /// </summary>
        public bool Add(YSCMS.Model.DefineClass model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(YSCMS.Model.DefineClass model)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public YSCMS.Model.DefineClass GetModel(string defineInfoId)
        {
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public YSCMS.Model.DefineClass GetModelByCache(string defineInfoId)
        {
            ...
            return (YSCMS.Model.DefineClass)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSCMS.Model.DefineClass> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSCMS.Model.DefineClass> DataTableToList(DataTable dt)
        {
            List<YSCMS.Model.DefineClass> modelList = new List<YSCMS.Model.DefineClass>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                YSCMS.Model.DefineClass model;
                for (int n = 0; n < rowsCount; n++)
                {
                    model = new YSCMS.Model.DefineClass();
