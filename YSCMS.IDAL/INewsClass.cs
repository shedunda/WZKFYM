...
namespace YSCMS.IDAL
{
    ...
    public interface INewsClass
    {
        ...
        /// 增加一条数据
        /// </summary>
        int Add(YSCMS.Model.NewsClass model);
        /// <summary>
        /// 更新一条数据
        /// </summary>
        bool Update(YSCMS.Model.NewsClass model);
        /// <summary>
        /// 删除一条数据
        /// </summary>
        bool Delete(int Id);
        ...
        /// 得到一个对象实体
        /// </summary>
        YSCMS.Model.NewsClass GetModel(string ClassID);
        /// <summary>
        /// 获得数据列表
        /// </summary>
        ...
        void UpdatePage(YSCMS.Model.NewsClass NewsClassModel);

        /// <summary>
        /// 添加单页面
        /// </summary>
        /// <param name="NewsClassModel"></param>
        void InsertPage(YSCMS.Model.NewsClass NewsClassModel);
        #endregion  成员方法
    } 
}
