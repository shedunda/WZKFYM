...
namespace YSCMS.IDAL
{
    ...
    public interface INews
    {
        ...
        /// 增加一条数据
        /// </summary>
        void Add(YSCMS.Model.News model);
        /// <summary>
        /// 更新一条数据
        /// </summary>
        bool Update(YSCMS.Model.News model);
        /// <summary>
        /// 复制新闻
        /// </summary>
        ...
        /// 得到一个对象实体
        /// </summary>
        YSCMS.Model.News GetModel(string NewsID);
        /// <summary>
        /// 获得数据列表
        /// </summary>
       ...
       /// <param name="NewsID">新闻的NewsID</param>
        ...
        void UpdateNewsContent(YSCMS.Model.News uc);
         /// <summary>
        /// 插入新记录
        /// </summary>
        /// <param name="uc2"></param>
        void InsertNewsContent(YSCMS.Model.News uc);
        /// <summary>
        /// 得到不规则新闻
        /// </summary>
        /// <param name="UnID"></param>
        ...
        /// </summary>
        /// <param name="uc2"></param>
        void IntsertTT(YSCMS.Model.NewsContentTT uc);    
        /// <summary>
        /// 更新头条
        /// </summary>
        /// <param name="uc2"></param>
        void UpdateTT(YSCMS.Model.NewsContentTT uc);
        #region 归档新闻
        /// <summary>
        /// 批量删除归档新闻
        /// </summary>
        ...
        /// <param name="ci"></param>
        /// <returns></returns>
        int AddComment(YSCMS.Model.Comment ci);
