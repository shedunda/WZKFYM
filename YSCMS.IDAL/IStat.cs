...
namespace YSCMS.IDAL
{
    public interface IStat
    {
        ...
        void Update(int str_ys_today, int str_ys_yesterday, string str_ys_content_data, int str_ys_all, int str_ys_heigh, string str_ys_heightime, string strclassid, string siteID, string strclassids);
        #endregion 
