...
namespace YSCMS.IDAL
{
    ...
    public interface INewsJSTemplet
    {
        ...
        /// 增加一条数据
        /// </summary>
        bool Add(YSCMS.Model.NewsJSTemplet model);
        /// <summary>
        /// 更新一条数据
        /// </summary>
        bool Update(YSCMS.Model.NewsJSTemplet model);
        /// <summary>
        /// 删除一条数据
        /// </summary>
        bool Delete(int id);
        ...
        /// 得到一个对象实体
        /// </summary>
        YSCMS.Model.NewsJSTemplet GetModel(string templetID);
        YSCMS.Model.NewsJSTemplet GetModel(int id);
        /// <summary>
        /// 获得数据列表
        /// </summary>
