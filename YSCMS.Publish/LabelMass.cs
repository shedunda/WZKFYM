namespace YSCMS.Publish
{
    ...
    public class LabelMass
    {
        ...
        public string Analse_ReadNews()
        {
            ...
            string id = Regex.Match(input, @"\[\#YS:StyleID=(?<sid>[^\]]+)]", RegexOptions.Compiled).Groups["sid"].Value.Trim();
            if (id != string.Empty)
            {
        ...
        {
            string paramValue = this.GetParamValue("YS:JSID");
        ...
        public string Analyse_ChannelClassList(int ChID)
        {
            ...
            string input = this.Mass_Inserted;
            string s = Regex.Match(input, @"\[\#YS:StyleID=(?<sid>[^\]]+)]", RegexOptions.Compiled).Groups["sid"].Value.Trim();
            ...
            string paramValue = this.GetParamValue("YS:Type");
            if (!int.TryParse(this.GetParamValue("YS:Cols"), out num))
            {
                num = 1;
            }
            if (num < 1)
            ...
            string str5 = this.GetParamValue("YS:Desc");
            string str6 = this.GetParamValue("YS:OrderBy");
            if (str6 == null)
            {
                str6 = "id";
            }
            string isDiv = this.GetParamValue("YS:isDiv");
            if (isDiv == null)
            {
                isDiv = "true";
            }
            string str8 = this.GetParamValue("YS:bfStr");
            string str9 = this.GetParamValue("YS:isPic");
            string str10 = this.GetParamValue("YS:TitleNumer");
            string showNavi = this.GetParamValue("YS:ShowNavi");
            string naviCSS = this.GetParamValue("YS:NaviCSS");
            string str13 = this.GetParamValue("YS:ColbgCSS");
            string str14 = this.GetParamValue("YS:PageStyle");
            int num2 = 0;
            int num3 = 100;
            string str15 = "";
            string str16 = "";
            ...
            str20 = "{$YS:P0}{Page:" + str21 + "$" + str22 + "$" + str23 + "}";
            ...
            str26 = "{Yuesi:NewsLIST}" + this.News_List_Head(isDiv, "", "", "");
            string str27 = "";
            if (isDiv != "true")
            {
        ...
        public string Analyse_ChannelFlash(int ChID)
        {
            ...
            string paramValue = this.GetParamValue("YS:ClassID");
            string input = this.GetParamValue("YS:Flashweight");
            string str5 = this.GetParamValue("YS:Flashheight");
            string str6 = this.GetParamValue("YS:FlashBG");
            string str7 = this.GetParamValue("YS:ShowTitle");
        ...
        public string Analyse_ChannellList(string Tags, int ChID)
        {
            ...
            string paramValue = this.GetParamValue("YS:Type");
            string str5 = this.GetParamValue("YS:ClassID");
            string str6 = this.GetParamValue("YS:SpecialID");
            if (!int.TryParse(this.GetParamValue("YS:Cols"), out num))
            {
                num = 1;
            }
            ...
            string str7 = this.GetParamValue("YS:Desc");
            string str8 = this.GetParamValue("YS:OrderBy");
            string isDiv = this.GetParamValue("YS:isDiv");
            string str10 = this.GetParamValue("YS:isPic");
            string str11 = this.GetParamValue("YS:TitleNumer");
            string str12 = this.GetParamValue("YS:ClickNumber");
            string str13 = this.GetParamValue("YS:ShowDateNumer");
            string showNavi = this.GetParamValue("YS:ShowNavi");
            string naviCSS = this.GetParamValue("YS:NaviCSS");
            string str16 = this.GetParamValue("YS:ColbgCSS");
            string str17 = " [ID] ";
            ...
            if ((str13 != null) && (str13 != ""))
            {
                if (UIConfig.WebDAL.ToLower() == "yscms.accessdal")
                {
        ...
        public string Analyse_ChannelSearch(int ChID)
        {
            ...
            string paramValue = this.GetParamValue("YS:Type");
            string str3 = this.GetParamValue("YS:Cols");
        ...
        public string Analyse_ChRead(int ID, int TitleNumer, string str_Style, string StyleID, int NewsTF, string DTable, int ChID)
        {
            ...
            if (NewsTF == 1)
            {
                ...
                string s = Regex.Match(str_Style, @"\[\#YS:StyleID=(?<sid>[^\]]+)]", RegexOptions.Compiled).Groups["sid"].Value.Trim();
                if (s != string.Empty)
                {
            ...
            if (str_Style.IndexOf("{CH#Content$") > -1)
            {
                ...
                if (NewsTF == 0)
                {
                    ...
                    str_Style = str_Style.Replace("{CH#Content$" + str7 + "}", content.Replace("[YS:PAGE]", "").Replace("[YS:PAGE", "").Replace("$]", ""));
                }
                else if ((((str_Style.IndexOf("{CH#PageTitle_select}") > -1) || (str_Style.IndexOf("{CH#PageTitle_textdouble}") > -1)) || (str_Style.IndexOf("{CH#PageTitle_textsinge}") > -1)) || (str_Style.IndexOf("{CH#PageTitle_textcols}") > -1))
                {
                    ...
                    if ((str10.IndexOf("[YS:PAGE=") > -1) && (str10.IndexOf("$]") > -1))
                    {
                        string str13 = @"\[YS:PAGE=(?<p>[\s\S]+?)\$\]";
                        ...
                        input = regex2.Replace(input, "[YS:PAGE]");
                ...
                str_Style = str_Style.Replace("{CH#Content$" + str7 + "}", "<!-YS:STAR=" + input + "YS:END->");
            }
            ...
            return this.Mass_Inserted.Replace("[#YS:StyleID=" + StyleID + "]", str_Style);
        }
        ...
        public string Analyse_ClassInfoList()
        {
            ...
            if (styleByID.StartsWith("[#YS:StyleID="))
            {
                string str2 = styleByID.Replace("[#YS:StyleID=", "").Replace("]", "");
            ...
            string paramValue = this.GetParamValue("YS:ClassID");
            string str4 = this.GetParamValue("YS:Number");
            string str5 = this.GetParamValue("YS:Desc");
            string str6 = this.GetParamValue("YS:DescType");
            string str7 = this.GetParamValue("YS:TitleNumer");
            string str8 = this.GetParamValue("YS:NaviNumber");
            int result = 0;
            int num2 = 0;
        ...
        public string Analyse_ClassList()
        {
            ...
            string paramValue = this.GetParamValue("YS:LabelType");
            string str4 = this.GetParamValue("YS:ListType");
            string str5 = this.GetParamValue("YS:isSub");
            string str6 = this.GetParamValue("YS:SubNews");
            if (!int.TryParse(this.GetParamValue("YS:Cols"), out num))
            {
                num = 1;
            }
            ...
            string str7 = this.GetParamValue("YS:Desc");
            string str8 = this.GetParamValue("YS:DescType");
            string isDiv = this.GetParamValue("YS:isDiv");
            string str10 = this.GetParamValue("YS:TabCSS");
            string ulID = this.GetParamValue("YS:ulID");
            string ulClass = this.GetParamValue("YS:ulClass");
            string str13 = this.GetParamValue("YS:bfStr");
            string str14 = this.GetParamValue("YS:isPic");
            string str15 = this.GetParamValue("YS:NaviNumber");
            string str16 = this.GetParamValue("YS:TitleNumer");
            string str17 = this.GetParamValue("YS:ContentNumber");
            string showNavi = this.GetParamValue("YS:ShowNavi");
            string naviCSS = this.GetParamValue("YS:NaviCSS");
            string str20 = this.GetParamValue("YS:ColbgCSS");
            string str21 = this.GetParamValue("YS:PageLinksCSS");
            string naviPic = this.GetParamValue("YS:NaviPic");
            string str23 = this.GetParamValue("YS:PageStyle");
            int num2 = 0;
            int num3 = 100;
            string str24 = "";
            string str25 = "";
            ...
            if (publicType == "0")
            {
                ...
                str30 = "{$YS:P0}{Page:" + str31 + "$" + str32 + "$" + str33 + "}";
            }
        ...
        Label_0728:
            ...
            str37 = "{Yuesi:NewsLIST}" + this.News_List_Head(isDiv, ulID, ulClass, "class=\"" + str10 + "\"");
            string str38 = "";
            int num10 = 0;
            string newValue = "";
            ...
            {
                str37 = str37 + "{YS:PageLinksStyle=" + str21 + "}";
            }
            return (str37 + "{/Yuesi:NewsLIST}");
        }
        ...
        public string Analyse_ClassNavi()
        {
            string parentID;
            string paramValue = this.GetParamValue("YS:ClassID");
            string str2 = this.GetParamValue("YS:NaviCSS");
            string str3 = this.GetParamValue("YS:NaviChar");
            string str4 = this.GetParamValue("YS:Mapp");
            if (str2 != null)
            {
                str2 = "class=\"" + str2 + "\"";
            }
        ...
        {
            string str8;
            string str = this.GetParamValue("YS:ClassID") ?? "0";
            string paramValue = this.GetParamValue("YS:ClassTitleNumber");
            string s = this.GetParamValue("YS:ClassNaviTitleNumber");
            string classId = "";
            if (str != "0")
            {
                classId = str;
        ...
        {
            string str = "暂无幻灯新闻";
            string paramValue = this.GetParamValue("YS:FlashType");
            string classID = this.GetParamValue("YS:ClassID");
            string str4 = this.GetParamValue("YS:Flashweight");
            string str5 = this.GetParamValue("YS:Flashheight");
            string str6 = this.GetParamValue("YS:FlashBG");
            string str7 = this.GetParamValue("YS:ShowTitle");
            string str8 = this.GetParamValue("YS:isSub");
            string s = this.GetParamValue("YS:TitleNumber");
            if (str4 == null)
            {
                str4 = "200";
            }
        ...
        public string Analyse_FormList()
        {
            ...
            int recordCount = 0;
            string input = this.Mass_Inserted;
            string paramValue = this.GetParamValue("YS:PageSize");
            string tablename = this.GetParamValue("YS:FormTableName");
            string id = Regex.Match(input, @"\[\#YS:StyleID=(?<sid>[^\]]+)]", RegexOptions.Compiled).Groups["sid"].Value.Trim();
            if (!id.Equals(string.Empty))
            {
                string str5 = string.Empty;
        ...
        public string Analyse_FormList(int pageindex, string context)
        {
            ...
            if (!id.Equals(string.Empty))
            {
                ...
                string str6 = "<div class=\"yuesi_customform_list\">" + str5 + "</div>";
                if (num <= 1)
                {
                    return str6;
                }
                str6 = str6 + "<div style=\"padding-top:15px;\" class=\"yuesi_pagebox\">";
                if (pageindex < 6)
                {
                    str6 = str6 + "<span class=\"yuesi_pagebox_num\">上五页</span>";
                }
                else
                {
                    obj2 = str6;
                ...
                {
                    str6 = str6 + "<span class=\"yuesi_pagebox_num\">上一页</span>";
                }
                for (int i = num3; i < (((num3 + 5) > num) ? (num + 1) : (num3 + 5)); i++)
                {
                    ...
                    {
                        obj2 = str6;
                        str6 = string.Concat(new object[] { obj2, "<span class=\"yuesi_pagebox_num_nonce\">", i, "</span>" });
                    }
                    else
                    {
                        obj2 = str6;
                ...
                if (pageindex >= num)
                {
                    str6 = str6 + "<span class=\"yuesi_pagebox_num\">下一页</span>";
                }
                else
                {
                    obj2 = str6;
                ...
                if (pageindex > (num - 5))
                {
                    str6 = str6 + "<span class=\"yuesi_pagebox_num\">下五页</span>";
                }
                else
                {
                    obj2 = str6;
        ...
        public string Analyse_FrindList()
        {
            ...
            string paramValue = this.GetParamValue("YS:Cols");
            string input = this.GetParamValue("YS:FType");
            string str3 = this.GetParamValue("YS:isAdmin");
            string str4 = this.GetParamValue("YS:isDiv");
            string classId = this.GetParamValue("YS:TypeClassID");
            ...
            string str7 = DataAccess.CreateFrindLink().ParamStart().Rows[0]["ArrSize"].ToString();
            if (string.IsNullOrEmpty(str7))
            {
                str7 = "80,30";
            }
        ...
        public string Analyse_GroupMember()
        {
            ...
            string paramValue = this.GetParamValue("YS:GroupType");
            string isDiv = this.GetParamValue("YS:isDiv");
            if (isDiv == null)
            {
                isDiv = "true";
            }
            string str4 = this.GetParamValue("YS:CSS");
            string ulID = this.GetParamValue("YS:ulID");
            string ulClass = this.GetParamValue("YS:ulClass");
            string str7 = this.GetParamValue("YS:TitleNumer");
            string str8 = this.GetParamValue("YS:ShowM");
            string showNavi = this.GetParamValue("YS:ShowNavi");
            string naviPic = this.GetParamValue("YS:NaviPic");
            string naviCSS = this.GetParamValue("YS:NaviCSS");
            string str12 = "";
        ...
        {
            string paramValue = this.GetParamValue("YS:IsDate");
            string str2 = this.GetParamValue("YS:ShowDate");
        ...
        {
            string str = "";
            string paramValue = this.GetParamValue("YS:ShowNavi");
            string str3 = this.GetParamValue("YS:CSS");
            string str4 = this.GetParamValue("YS:ShowDate");
            string naviPic = this.GetParamValue("YS:NaviPic");
            string naviCSS = this.GetParamValue("YS:NaviCSS");
            string str7 = this.GetParamValue("YS:TitleNumer");
            if (str3 != null)
        ...
        public string Analyse_List(string Tags, string isConstr)
        {
            ...
            string paramValue = this.GetParamValue("YS:NewsType");
            string str4 = this.GetParamValue("YS:SubNews");
            string classID = this.GetParamValue("YS:ClassID");
            string str6 = this.GetParamValue("YS:SpecialID");
            if (!int.TryParse(this.GetParamValue("YS:Cols"), out num))
            {
            ...
            string str7 = this.GetParamValue("YS:Desc");
            string str8 = this.GetParamValue("YS:DescType");
            string str9 = this.GetParamValue("YS:isDiv");
            if (str9 == null)
            {
                str9 = "true";
            }
            string str10 = this.GetParamValue("YS:TabCSS");
            string str11 = this.GetParamValue("YS:isPic");
            string str12 = this.GetParamValue("YS:TitleNumer");
            string str13 = this.GetParamValue("YS:ContentNumber");
            string str14 = this.GetParamValue("YS:NaviNumber");
            string str15 = this.GetParamValue("YS:ClickNumber");
            string str16 = this.GetParamValue("YS:ShowDateNumer");
            string str17 = this.GetParamValue("YS:isSub");
            string str18 = this.GetParamValue("YS:ShowNavi");
            string str19 = this.GetParamValue("YS:NaviCSS");
            string str20 = this.GetParamValue("YS:ColbgCSS");
            string str21 = this.GetParamValue("YS:NaviPic");
            string str22 = this.GetParamValue("YS:HashNaviContent");
            string str23 = this.GetParamValue("YS:ClassStyleID");
            string str24 = this.GetParamValue("YS:ColumnNumber");
            string str25 = this.GetParamValue("YS:ColumnCss");
            string str26 = this.GetParamValue("YS:ColumnNewsCss");
            string str27 = this.GetParamValue("YS:More");
        ...
        Label_0829:
            ...
            {
                flag = true;
                if (this.GetParamValue("YS:SubNaviCSS") != null)
                {
                    str33 = this.GetParamValue("YS:SubNaviCSS");
                }
            }
            string sql = string.Empty;
        ...
        {
            string paramValue = this.GetParamValue("YS:MetaContent");
        ...
        public string Analyse_NewUser()
        {
            ...
            string naviCSS = this.GetParamValue("YS:NaviCSS");
            string str4 = this.GetParamValue("YS:CSS");
            string str5 = this.GetParamValue("YS:ShowDate");
            string str6 = "";
            if (str4 != null)
            {
                str6 = " class=\"" + str4 + "\"";
        ...
        public string Analyse_NorFilt()
        {
            string str = "";
            string paramValue = this.GetParamValue("YS:ClassID");
            string str3 = this.GetParamValue("YS:isSub");
            string str4 = this.GetParamValue("YS:TitleNumer");
            string str5 = this.GetParamValue("YS:WCSS");
            string str6 = this.GetParamValue("YS:ShowTitle");
            string str7 = this.GetParamValue("YS:FlashSize");
            string str8 = this.GetParamValue("YS:Target");
        ...
        {
            string paramValue = this.GetParamValue("YS:prefix");
            string str3 = "0";
            string str4 = "";
        ...
        public string Analyse_Position(int ChID)
        {
            string classID;
            string str = string.Empty;
            string paramValue = this.GetParamValue("YS:DynChar");
            if (paramValue == null)
            {
                paramValue = " >> ";
            }
            ...
            switch (this.TemplateType.ToString())
            {
                ...
                {
                    classID = null;
                    YSCMS.Model.News news = CommonData.getNewsInfoById(this.Param_CurrentNewsID);
                    if (news != null)
                    {
        ...
        {
            string str44;
            YSCMS.Model.News news = new YSCMS.Model.News();
            ...
            {
                str_Style = this.Mass_Inserted;
                string str2 = Regex.Match(str_Style, @"\[\#YS:StyleID=(?<sid>[^\]]+)]", RegexOptions.Compiled).Groups["sid"].Value.Trim();
            ...
            if (str_Style.IndexOf("{#Content}") > -1)
            {
                ...
                if (NewsTF == 0)
                {
                    ...
                    if ((str12.IndexOf("[YS:PAGE") > -1) && (str12.IndexOf("$]") > -1))
                    {
                        str12 = Input.LostPage(str12);
                    }
                    if ((str12.IndexOf("[YS:unLoop") > -1) && (str12.IndexOf("[/YS:unLoop]") > -1))
                    {
                        str12 = Input.LostVoteStr(str12);
                    }
                    content = Input.GetSubString(str12, ContentNumber) + "...";
                    str_Style = str_Style.Replace("{#Content}", content.Replace("[YS:PAGE]", "").Replace("[YS:PAGE", "").Replace("$]", ""));
                }
                else if (NewsTF == 1)
                {
                    string str13 = "";
                    ...
                    if (NewsTF == 1)
                    {
                        if ((((str_Style.IndexOf("{#PageTitle_select}") > -1) || (str_Style.IndexOf("{#PageTitle_textdouble}") > -1)) || (str_Style.IndexOf("{#PageTitle_textsinge}") > -1)) || (str_Style.IndexOf("{#PageTitle_textcols}") > -1))
                        {
                            ...
                            string str24 = string.Empty;
                            if ((input.IndexOf("[YS:PAGE=") > -1) && (input.IndexOf("$]") > -1))
                            {
                                string str25 = @"\[YS:PAGE(?<p>[\s\S]*?)\]";
                                ...
                                str11 = regex.Replace(str11, "[YS:PAGE]");
                    ...
                    str_Style = str_Style.Replace("{#Content}", "<!-YS:STAR=" + str11 + "YS:END->");
                }
            }
            ...
            string pattern = @"\{\#YS:define=(?<dname>[^\}]+)}";
            int result = 0;
            string str39 = "";
            ...
            for (Match match3 = regex3.Match(str_Style); match3.Success; match3 = match3.NextMatch())
            {
                ...
                str_Style = str_Style.Replace("{#YS:define=" + str39 + "}", definedValue);
            }
            if (StyleID.Equals(string.Empty))
            {
                return str_Style;
        ...
        {
            string paramValue = this.GetParamValue("YS:SpecialID");
            string specialid = "";
            if (paramValue != null)
            {
        ...
        public string Analyse_Search()
        {
            ...
            string paramValue = this.GetParamValue("YS:SearchType");
            string str4 = this.GetParamValue("YS:ShowDate");
            string str5 = this.GetParamValue("YS:ShowClass");
        ...
        public string Analyse_Sitemap()
        {
            ...
            if (Convert.ToInt32(this.GetParamValue("YS:isSubCols")) < 1)
            {
            }
            string paramValue = this.GetParamValue("YS:MapTitleCSS");
            if (paramValue != null)
            {
                paramValue = " class=\"" + paramValue + "\"";
            }
            string str4 = this.GetParamValue("YS:SubCSS");
            if (str4 != null)
            {
                str4 = " class=\"" + str4 + "\"";
            }
            string str5 = this.GetParamValue("YS:Mapp");
            if (str5 == null)
            {
                str5 = "true";
            }
            ...
            string str7 = this.GetParamValue("YS:MapNavi");
            string str8 = this.GetParamValue("YS:MapNaviPic");
            string str9 = this.GetParamValue("YS:MapsubNavi");
            string str10 = this.GetParamValue("YS:MapsubNaviText");
            string str11 = this.GetParamValue("YS:MapsubNaviPic");
            if ((str8 == "true") && (str8 != null))
            {
                str8 = "<img src=\"" + str8 + "\" border=\"0\" />".Replace("{@dirfile}", dirDumm + dirFile);
            }
            string str12 = this.GetParamValue("YS:MapNaviText");
        ...
        {
            string str = "";
            string paramValue = this.GetParamValue("YS:NaviCSS");
            string str3 = this.GetParamValue("YS:NaviChar");
            string str4 = this.GetParamValue("YS:isDiv");
            string str5 = str3;
            int num = 0;
        ...
        public string Analyse_SpeicalNaviRead()
        {
            ...
            string paramValue = this.GetParamValue("YS:SpecialID");
            string s = this.GetParamValue("YS:SpecialTitleNumber");
            string str4 = this.GetParamValue("YS:SpecialNaviTitleNumber");
            string specialid = "";
            if (paramValue != null)
            {
                specialid = paramValue;
        ...
        {
            string paramValue = this.GetParamValue("YS:JSID");
            string str2 = this.GetParamValue("YS:statShowType");
            string str3 = "";
            if (paramValue != null)
            {
        ...
        {
            string input = this.Mass_Inserted;
            string paramValue = this.GetParamValue("YS:FormID");
            string id = Regex.Match(input, @"\[\#YS:StyleID=(?<sid>[^\]]+)]", RegexOptions.Compiled).Groups["sid"].Value.Trim();
            if (!id.Equals(string.Empty))
            {
                input = LabelStyle.GetStyleByID(id);
        ...
        {
            string str = string.Empty;
            string paramValue = this.GetParamValue("YS:TodayPicID");
            string str3 = this.GetParamValue("YS:TCHECK");
            string s = this.GetParamValue("YS:TNUM");
            int topNum = 3;
            if (s != null)
            {
                topNum = int.Parse(s);
            }
            string str5 = this.GetParamValue("YS:TSCHAR");
            string str6 = this.GetParamValue("YS:TECHAR");
            ...
            if (str3 == "true")
            {
                ...
                for (int i = 0; i < textSubNews.Rows.Count; i++)
                {
                    ...
                    YSCMS.Model.News news = CommonData.getNewsInfoById(row["getNewsID"].ToString());
                    PubClassInfo classById = CommonData.GetClassById(news.ClassID);
        ...
        public string Analyse_TodayWord()
        {
            string str = "";
            string paramValue = this.GetParamValue("YS:ClassID");
            string str3 = this.GetParamValue("YS:isBIGT");
            string str4 = this.GetParamValue("YS:BigCSS");
            string str5 = this.GetParamValue("YS:TSCHAR");
            string str6 = this.GetParamValue("YS:TECHAR");
            string input = this.GetParamValue("YS:bigTitleNumber");
            if (str5 != null)
            {
            ...
            string str8 = this.GetParamValue("YS:isSub");
            string s = this.GetParamValue("YS:Cols");
            string str10 = this.GetParamValue("YS:TitleNumer");
            string str11 = this.GetParamValue("YS:ContentNumber");
            string str12 = this.GetParamValue("YS:WNum");
            int num = 5;
            if ((str12 != null) && Input.IsInteger(str12))
            {
                num = int.Parse(str12);
            }
            string str13 = this.GetParamValue("YS:WCSS");
        ...
        public string Analyse_TopNews1()
        {
            ...
            string paramValue = this.GetParamValue("YS:TopNewsType");
            string str4 = this.GetParamValue("YS:SubNews");
            string classID = this.GetParamValue("YS:ClassID");
            if (!int.TryParse(this.GetParamValue("YS:Cols"), out num))
            {
            ...
            string str10 = this.GetParamValue("YS:TitleNumer");
            string str11 = this.GetParamValue("YS:ContentNumber");
            string str12 = this.GetParamValue("YS:NaviNumber");
            string str13 = this.GetParamValue("YS:isSub");
            bool flag = false;
            if ((str4 != null) && (str4 == "true"))
            {
                flag = true;
            ...
            {
                case "Hour":
                    if (!(UIConfig.WebDAL == "yscms.accessdal"))
                    {
        ...
        {
            IDataReader reader;
            string paramValue = this.GetParamValue("YS:TopUserType");
            string showNavi = this.GetParamValue("YS:ShowNavi");
            string naviCSS = this.GetParamValue("YS:NaviCSS");
            string naviPic = this.GetParamValue("YS:NaviPic");
            string str5 = this.GetParamValue("YS:CSS");
            string str6 = this.GetParamValue("YS:PointParam");
            string str7 = "";
            if (str5 != null)
            {
                str7 = " class=\"" + str5 + "\"";
        ...
        {
            string str = string.Empty;
            string paramValue = this.GetParamValue("YS:RuleID");
            string str3 = this.GetParamValue("YS:STitle");
            string inputStr = this.GetParamValue("YS:unNavi");
            string str5 = string.Empty;
            string unID = "0";
            if (inputStr != null)
            {
            ...
            if ((unRule != null) && (unRule.Rows.Count > 0))
            {
                ...
                for (int i = 0; i < unRule.Rows.Count; i++)
                {
                    ...
                    YSCMS.Model.News news = CommonData.getNewsInfoById(unRule.Rows[i]["ONewsID"].ToString());
                    string uRLaddress = "";
                    if (news != null)
                    {
                        PubClassInfo classById = CommonData.GetClassById(news.ClassID);
        ...
        public string Analyse_UserLogin()
        {
            ...
            string paramValue = this.GetParamValue("YS:LoginP");
            string str2 = this.GetParamValue("YS:FormCSS");
            string str3 = this.GetParamValue("YS:LoginCSS");
            string input = this.GetParamValue("YS:RegCSS");
            string str5 = this.GetParamValue("YS:PassCSS");
            string str6 = this.GetParamValue("YS:StyleID");
        ...
        {
            string domain = null;
            YSCMS.Model.News news = CommonData.getNewsInfoById(NewsID);
            if (news != null)
            {
                PubClassInfo classById = CommonData.GetClassById(news.ClassID);
                if (classById != null)
        ...
        protected YSCMS.Model.News getNewsInfo(int ID, string NewsID)
        {
            if ((ID == 0) && string.IsNullOrEmpty(NewsID))
            {
                return new YSCMS.Model.News();
            }
            if (ID > 0)
            {
        ...
        Label_0211:
            ...
            if ((str_SubNews != null) && (str_SubNews == "true"))
            {
                ...
                if (this.GetParamValue("YS:SubNaviCSS") != null)
                {
                    paramValue = this.GetParamValue("YS:SubNaviCSS");
                }
            }
            string[] strArray = null;
            bool flag2 = false;
            ...
            if (str_isDiv == "true")
            {
                if (this.GetParamValue("YS:ColumnCss") != null)
                {
                    str9 = " class=\"" + this.GetParamValue("YS:ColumnCss") + "\"";
                }
                else
                {
            ...
            else if (this.GetParamValue("YS:ColumnCss") != null)
            {
                str9 = " class=\"" + this.GetParamValue("YS:ColumnCss") + "\"";
            }
            else
            ...
            if (this.GetParamValue("YS:ColumnNewsCss") != null)
            {
                columnNewsCssValue = " class=\"" + this.GetParamValue("YS:ColumnNewsCss") + "\"";
            }
            if (str_isDiv == "false")
            {
        ...
        {
            YSCMS.CMS.Label label = new YSCMS.CMS.Label();
        ...
        private void ParsePrimary()
        {
            if (this.Mass_Primary.IndexOf(",") > 0)
            {
                ...
                if (strArray[0].Equals("YS:Loop"))
                {
                    this.Param_Loop = 1;
                }
                else if (strArray[0].Equals("YS:unLoop"))
                {
                    this.Param_Loop = 0;
                }
                else
                {
                    ...
                    this.InvalidInfo = "标签内容不是以[YS:unLoop或[YS:Loop开始";
                }
                ...
                for (int i = 1; i < length; i++)
                {
                    ...
                    if (index >= 0)
                    {
                        ...
                        if (this.Param_Loop.Equals(1))
                        {
                            ...
                            {
                                this.FormatValid = false;
                                this.InvalidInfo = "YS:Number的值不是有效的数字";
                            }
                        }
                ...
                Label_01BA:
                    ...
                    {
                        this.FormatValid = false;
                        this.InvalidInfo = "YS:LabelType指定的类型不存在";
                    }
                    continue;
                Label_01FB:
                    this.AddParameter(parameter, ref list);
        ...
        {
            DataTable table = new YSCMS.CMS.Label().searchValues(tablename, pageindex, pagesize, out recordCount, out pageCount);
            string str = string.Empty;
