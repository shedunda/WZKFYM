namespace YSCMS.Publish
{
    ...
    public class FreeLabel : Label
    {
        ...
        {
            string str = Regex.Match(this.LabelSQL, @"^select\ +(top\ +\d+\ +)?(?<flds>.+)\ +from\ +.+", RegexOptions.Compiled).Groups["flds"].Value.Trim();
        ...
        protected string ReplaceField(string Input, string FieldName, string FieldValue)
        {
            ...
            if (match.Success)
            {
                ...
                FieldValue = YSCMS.Common.Input.GetSubString(FieldValue, num);
        ...
        protected string testTable(string FieldName)
        {
            ...
            str = str.ToLower();
            str3 = str3.ToLower();
            if ((str == "ys_news_class") && (str3 == "classid"))
            {
                return "ys_news_class";
            }
            if ((str == "ys_news") && (str3 == "newsid"))
            {
                return "ys_news";
            }
            return "";
