	...
	public class ManagePage : BasePage {
		...
		protected void CheckAdminAuthority() {
			...
			if (state != EnumLoginState.Succeed) {
				...
				_UserNum = YSCMS.Global.Current.UserNum;
				_SiteID = YSCMS.Global.Current.SiteID.Trim();
				_UserName = YSCMS.Global.Current.UserName;
				_adminLogined = YSCMS.Global.Current.adminLogined;
			}
		}
		/// <summary>
		/// 检查权限
		...
		protected override void Logout() {
			...
			string TmpPath = YSCMS.Config.UIConfig.dirUser + "/";
			if ((_dirDumm).Trim() != "") { _dirDumm = "/" + _dirDumm; }
			TmpPath = YSCMS.Config.UIConfig.dirMana + "/";
