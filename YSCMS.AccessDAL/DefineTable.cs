...
namespace YSCMS.AccessDAL
{
    public class DefineTable : DbBase, IDefineTable
    {
        ...
        {
            string Sql = "Select DefineInfoId,DefineName,ParentInfoId From " + Pre + "define_class where SiteID='" + YSCMS.Global.Current.SiteID + "' order by DefineId desc";
            return DbHelper.ExecuteTable(CommandType.Text, Sql, null);
        }
        public DataTable Sel_ParentInfoId(string PID)
        {
            OleDbParameter param = new OleDbParameter("@ParentInfoId",PID);
            string Sql = "Select DefineInfoId,DefineName,ParentInfoId From " + Pre + "define_class where ParentInfoId=@ParentInfoId and SiteID='" + YSCMS.Global.Current.SiteID + "'";
        ...
        public int Add(string Str_ColumnsType, string defCname, string defEname, int definSelected, int Isnull, string defColumns, string defExp, string definedvalue)
        {
            ...
            string Sql = "Insert Into " + Pre + "Define_Data(defineInfoId,DefineCname,DefineColumns,defineType,IsNull,defineValue," +
                         ...
                         "@defExp,'" + YSCMS.Global.Current.SiteID + "',@definedvalue)";
        ...
        public int Add2(string rand, string _NewText, string _PraText)
        {
            ...
            string Sql = "Insert Into " + Pre + "Define_Class(DefineInfoId,DefineName,ParentInfoId,SiteID) values(@DefineInfoId,@DefineName,@ParentInfoId,'" + YSCMS.Global.Current.SiteID + "')";
            return DbHelper.ExecuteNonQuery(CommandType.Text, Sql, param);
        }
        ...
        {
            string Sql = "";
            if (YSCMS.Global.Current.SiteID == "0") { Sql = "Delete From " + Pre + "define_class"; }
            else { Sql = "Delete From " + Pre + "define_class where SiteID='" + YSCMS.Global.Current.SiteID + "'"; }
            return DbHelper.ExecuteNonQuery(CommandType.Text, Sql, null);
        }
        ...
        public int Delete7()
        {
            ...
            else { Sql = "Delete From " + Pre + "define_data where SiteID='" + YSCMS.Global.Current.SiteID + "'"; }
            return DbHelper.ExecuteNonQuery(CommandType.Text, Sql, null);
        }
