...
namespace YSCMS.AccessDAL
{
    ...
    public partial class NewsSpecial : DbBase, INewsSpecial
    {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(YSCMS.Model.NewsSpecial sci)
        {
        ...
        public YSCMS.Model.NewsSpecial GetModel(string SpecialID)
        {
            ...
            string str_Sql = "Select Id,SpecialID,SpecialCName,specialEName,ParentID,[Domain],isDelPoint,Gpoint,iPoint,GroupNumber,FileName," +
                             ...
                             Pre + "news_special Where SiteID='" + YSCMS.Global.Current.SiteID + "' And SpecialID='" + SpecialID + "'";
        ...
        {
            string sqlArray = "update " + Pre + "news_special set isRecyle=iif(isRecyle=1,0,1) where SpecialID in (" + specialId + ") and SiteID='" + YSCMS.Global.Current.SiteID + "'";
        ...
        private OleDbParameter[] GetSpecialParameters(YSCMS.Model.NewsSpecial sc)
        {
        ...
        {
            string str_Sql = "Select SpecialID,ParentID From " + Pre + "news_special Where SiteID='" + YSCMS.Global.Current.SiteID + "'";
            DataTable dt = DbHelper.ExecuteTable(CommandType.Text, str_Sql, null);
