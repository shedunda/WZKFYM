...
namespace YSCMS.AccessDAL
{
    public class AdminGroup : DbBase, IAdminGroup
    {
        ...
        /// <returns></returns>
        public int Add(YSCMS.Model.AdminGroup agci)
        {
            string checkSql = "";
            int recordCount = 0;
        ...
        public int Edit(YSCMS.Model.AdminGroup model)
        {
        ...
        private OleDbParameter[] GetAdminGroupParameters(YSCMS.Model.AdminGroup model)
        {
