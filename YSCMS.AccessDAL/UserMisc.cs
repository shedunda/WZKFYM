...
namespace YSCMS.AccessDAL
{
    public class UserMisc : DbBase, IUserMisc
    {
        ...
        public List<Dictionary<string, object>> GetAdminMenuStruct(string parentId)
        {
            ...
            if (parentId == "0")
            {
                string sqlText = "select * from ys_sys_navi where n_isshow = 1 and  n_ParentID is null order by n_orderId,n_Id";
                data = DbHelper.ExecuteTable(CommandType.Text, sqlText, null);
            }
            else
            {
                string sqlText = "select * from ys_sys_navi where n_isshow = 1 and n_ParentID=@ParentID order by n_orderId,n_Id";
        ...
        {
            string getS = "";
            string SQLTF = "select am_ID from " + Pre + "api_Navi where am_position='99999' and siteID='" + YSCMS.Global.Current.SiteID + "' ";
            object obj = DbHelper.ExecuteScalar(CommandType.Text, SQLTF, null);
            if (obj != null)
            {
                getS = " and SiteID='" + YSCMS.Global.Current.SiteID + "'";
            }
            else
            {
                getS = " and SiteID='0'";
        ...
        public DataTable calendar(string UserNum)
        {
            ...
            string Sql = "Select id,logID,Title,Content,userNum,LogDateTime From " + Pre + "user_userlogs Where (DATEDIFF('d', LogDateTime, Now())<=datenum) and Usernum=@UserNum and SiteID='" + YSCMS.Global.Current.SiteID + "'";
        ...
        public IDataReader menuNavilist(string stype, string UserNum)
        {
            ...
            string getS = "";
            string SQLTF = "select am_ID from " + Pre + "api_Navi where am_ParentID=@stype and siteID='" + YSCMS.Global.Current.SiteID + "' ";
        ...
        {
            string Sql = "Select * From " + Pre + "API_Navi where  SiteID='" + YSCMS.Global.Current.SiteID + "' order by am_orderID desc,am_id asc";
            DataTable rdr = DbHelper.ExecuteTable(CommandType.Text, Sql, null);
            return rdr;
        }
        /// <summary>
        ...
        public DataTable ManagechildmenuNavilist(string pID)
        {
            ...
            string Sql = "Select am_id,api_IdentID,am_ClassID,Am_position,am_Name,Am_Ename,am_FilePath,am_target,am_ParentID,am_type,am_orderID,isSys From " + Pre + "API_Navi where am_ParentID=@pID and SiteID='" + YSCMS.Global.Current.SiteID + "' order by am_orderID desc,am_id asc";
            DataTable rdr = DbHelper.ExecuteTable(CommandType.Text, Sql, param);
            return rdr;
        }
        ...
        public DataTable getManageChildNaviRecord(string am_ClassID)
        {
            ...
            string Sql = "Select am_ClassID From " + Pre + "API_Navi Where am_ClassID=@am_ClassID and SiteID='" + YSCMS.Global.Current.SiteID + "'";
            DataTable rdr = DbHelper.ExecuteTable(CommandType.Text, Sql, param);
            return rdr;
        }
        ...
        public DataTable GetNaviEditID(int nID)
        {
            ...
            string Sql = "Select * From " + Pre + "API_Navi where am_id=@nID and SiteID='" + YSCMS.Global.Current.SiteID + "' order by am_orderID desc,am_id desc";
            DataTable rdr = DbHelper.ExecuteTable(CommandType.Text, Sql, param);
            return rdr;
        }
        ...
        {
            string Sql = "Select am_id,api_IdentID,am_ClassID,Am_position,am_Name,Am_Ename,am_FilePath,am_target,am_ParentID,am_type,am_orderID,isSys,popCode From " + Pre + "API_Navi where Am_position='00000' and SiteID='" + YSCMS.Global.Current.SiteID + "' order by am_orderID desc,am_id desc";
            DataTable rdr = DbHelper.ExecuteTable(CommandType.Text, Sql, null);
            return rdr;
        }
        ...
        {
            OleDbParameter param = new OleDbParameter("@pID", pID);
            string Sql = "Select am_id,api_IdentID,am_ClassID,Am_position,am_Name,Am_Ename,am_FilePath,am_target,am_ParentID,am_type,am_orderID,isSys,popCode From " + Pre + "API_Navi where am_ParentID=@pID and SiteID='" + YSCMS.Global.Current.SiteID + "' order by am_orderID desc,am_id desc";
            DataTable rdr = DbHelper.ExecuteTable(CommandType.Text, Sql, param);
            return rdr;
        }
        /// <summary>
        ...
        public void InsertManageMenu(YSCMS.Model.UserInfo7 model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into ys_api_navi(");
        ...
        /// </summary>
        /// <param name="uc2"></param>
        public void EditManageMenu(YSCMS.Model.UserInfo7 model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update ys_api_navi set ");
        ...
        /// </summary>
        /// <param name="uc2"></param>
        public void EditManageMenu1(YSCMS.Model.UserInfo7 uc2)
        {
        ...
        /// <returns></returns>
        private OleDbParameter[] InsertManageMenuParameters2(YSCMS.Model.UserInfo7 uc1)
        {
        ...
        public void Shortcutdel(int Qid)
        {
            ...
            string str_sql = "delete From " + Pre + "API_Navi where am_id=@Qid and UserNum='" + YSCMS.Global.Current.UserNum + "' and SiteID='" + YSCMS.Global.Current.SiteID + "'";
        ...
        public void Shortcutde2(string ClassID)
        {
            ...
            string str_sql = "delete From " + Pre + "API_Navi where am_ParentID=@ClassID and UserNum='" + YSCMS.Global.Current.UserNum + "' and SiteID='" + YSCMS.Global.Current.SiteID + "'";
            DbHelper.ExecuteNonQuery(CommandType.Text, str_sql, param);
        }
        ...
        {
            string Sql = "Select * From " + Pre + "API_Navi where SiteID='" + YSCMS.Global.Current.SiteID + "' " + _str + " order by am_orderID asc,am_ID desc";
            DataTable rdr = DbHelper.ExecuteTable(CommandType.Text, Sql, null);
            return rdr;
        }
        ...
        {
            string str_sql = "delete From " + Pre + "API_Qmenu where id=" + Qid + " and UserNum='" + YSCMS.Global.Current.UserNum + "' and ismanage=" + _num + " and SiteID='" + YSCMS.Global.Current.SiteID + "'";
        ...
        {
            string Sql = "Select id,QMID,qName,FilePath,usernum,siteid,orderid From " + Pre + "API_Qmenu where (UserNum='" + YSCMS.Global.Current.UserNum + "' or UserNum='0') and ismanage=" + _num + " and SiteID='" + YSCMS.Global.Current.SiteID + "' order by OrderID desc,id desc";
            return DbHelper.ExecuteReader(CommandType.Text, Sql, null);
        }
        ...
        {
            string Sql = "Select QmID,qName,FilePath,Ismanage,OrderID,usernum,siteID From " + Pre + "API_Qmenu Where ID=" + QID + " and UserNum = '" + YSCMS.Global.Current.UserNum + "' and SiteID='" + YSCMS.Global.Current.SiteID + "'";
            DataTable rdr = DbHelper.ExecuteTable(CommandType.Text, Sql, null);
            return rdr;
        }
        /// <summary>
        ...
        {
            string Sql = "Select QmID From " + Pre + "API_Qmenu Where UserNum='" + YSCMS.Global.Current.UserNum + "' and ismanage=" + num + " and SiteID='" + YSCMS.Global.Current.SiteID + "'";
            DataTable rdr = DbHelper.ExecuteTable(CommandType.Text, Sql, null);
            return rdr;
        }
        ...
        /// </summary>
        /// <param name="uc2"></param>
        public void InsertQMenu(YSCMS.Model.UserInfo8 uc2)
        {
            string Sql = "insert into " + Pre + "API_Qmenu (";
            Sql += "QmID,qName,FilePath,Ismanage,OrderID,usernum,SiteID";
            Sql += ") values (";
            Sql += "@QmID,@qName,@FilePath,@Ismanage,@OrderID,@usernum,'" + YSCMS.Global.Current.SiteID + "')";
        ...
        /// </summary>
        /// <param name="uc2"></param>
        public void UpdateQMenu(YSCMS.Model.UserInfo8 uc2)
        {
            string Sql = "Update " + Pre + "API_Qmenu set qName=@qName,FilePath=@FilePath,OrderID=@OrderID where ID=" + uc2.Id + " and UserNum='" + YSCMS.Global.Current.UserNum + "' and SiteID='" + YSCMS.Global.Current.SiteID + "'";
        ...
        /// <param name="uc1"></param>
        /// <returns></returns>
        private OleDbParameter[] InsertQMenuParameters(YSCMS.Model.UserInfo8 uc1)
        {
        ...
        /// <param name="uc1"></param>
        /// <returns></returns>
        private OleDbParameter[] InsertQMenuParameters1(YSCMS.Model.UserInfo8 uc1)
        {
            OleDbParameter[] param = new OleDbParameter[4];
        ...
        {
            int intflg = 0;
            string Sql = "select isAdmin from " + Pre + "sys_User where UserNum='" + YSCMS.Global.Current.UserNum + "'";
        ...
        /// </summary>
        /// <param name="uc"></param>
        public void UpdateUserInfoBase(YSCMS.Model.UserInfo uc)
        {
        ...
        /// <param name="uc"></param>
        /// <returns></returns>
        private OleDbParameter[] GetUserInfoParameters(YSCMS.Model.UserInfo uc)
        {
        ...
        /// </summary>
        /// <param name="uc1"></param>
        public void UpdateUserInfoBase1(YSCMS.Model.UserInfo1 uc1)
        {
        ...
        /// </summary>
        /// <param name="uc2"></param>
        public void UpdateUserInfoBase2(YSCMS.Model.UserInfo1 uc2)
        {
        ...
        /// <param name="uc1"></param>
        /// <returns></returns>
        private OleDbParameter[] GetUserInfoParameters1(YSCMS.Model.UserInfo1 uc1)
        {
        ...
        /// </summary>
        /// <param name="uc1"></param>
        public void UpdateUserInfoContact1(YSCMS.Model.UserInfo2 uc1)
        {
        ...
        /// </summary>
        /// <param name="uc2"></param>
        public void UpdateUserInfoContact2(YSCMS.Model.UserInfo2 uc2)
        {
            string Sql = "insert into " + Pre + "sys_userfields (";
        ...
        private OleDbParameter[] GetUserInfoContactParameters1(YSCMS.Model.UserInfo2 uc1)
        {
        ...
        /// </summary>
        /// <param name="uc2"></param>
        public void UpdateUserInfoBaseStat(YSCMS.Model.UserInfo3 uc)
        {
        ...
        private OleDbParameter[] GetUserInfoBaseStatParameters1(YSCMS.Model.UserInfo3 uc1)
        {
        ...
        {
            string Sql = "select BindTF from " + Pre + "sys_User where UserNum='" + YSCMS.Global.Current.UserNum + "'";
            DataTable rdr = DbHelper.ExecuteTable(CommandType.Text, Sql, null);
            return rdr;
        }
        ...
        public void updateMobile(string _MobileNumber, int BindTF)
        {
            ...
            string Sql = "Update " + Pre + "sys_User set mobile=@Mobile,BindTF=" + BindTF + " where UserNum='" + YSCMS.Global.Current.UserNum + "'";
        ...
        /// </summary>
        /// <param name="uc2"></param>
        public void InsertGroup(YSCMS.Model.UserInfo4 uc2)
        {
        ...
        /// <param name="uc1"></param>
        /// <returns></returns>
        private OleDbParameter[] InsertGroupParameters(YSCMS.Model.UserInfo4 uc1)
        {
        ...
        /// </summary>
        /// <param name="uc2"></param>
        public void updateGroupEdit(YSCMS.Model.UserInfo4 uc2)
        {
        ...
        /// <param name="uc1"></param>
        /// <returns></returns>
        private OleDbParameter[] updateGroupEditParameters(YSCMS.Model.UserInfo4 uc1)
        {
        ...
        /// </summary>
        /// <param name="uc2"></param>
        public void InsertAnnounce(YSCMS.Model.UserInfo5 uc2)
        {
        ...
        /// <param name="uc1"></param>
        /// <returns></returns>
        private OleDbParameter[] GetAnnounceParameters(YSCMS.Model.UserInfo5 uc1)
        {
            OleDbParameter[] param = new OleDbParameter[9];
        ...
        /// </summary>
        /// <param name="uc2"></param>
        public void UpdateAnnounce(YSCMS.Model.UserInfo5 uc2)
        {
        ...
        /// <param name="uc1"></param>
        /// <returns></returns>
        private OleDbParameter[] UpdateAnnounceParameters(YSCMS.Model.UserInfo5 uc1)
        {
        ...
        public DataTable GetPage(string _islock, string _isuse, string _isbuy, string _timeout, string _SiteID, string cardnumber, string cardpassword, int PageIndex, int PageSize, out int RecordCount, out int PageCount, params SQLConditionInfo[] SqlCondition)
        {
            ...
            {
                if (YSCMS.Global.Current.SiteID == "0")
                {
                    QSQL += " and SiteID='" + _SiteID + "'";
                }
                else
                {
                    QSQL += " and SiteID='" + YSCMS.Global.Current.SiteID + "'";
                }
            }
            else
            {
        ...
        public void insertCardR(YSCMS.Model.IDCARD uc)
        {
        ...
        public void UpdateCardR(YSCMS.Model.IDCARD uc)
        {
            string Sql = "Update " + Pre + "user_card set CardPassWord=@CardPassWord,[Money]=@Money,Point=@Point,isBuy=@isBuy,isUse=@isUse,isLock=@isLock,TimeOutDate=@TimeOutDate where Id=" + uc.Id + " and SiteID='" + YSCMS.Global.Current.SiteID + "'";
        ...
        /// <param name="uc1"></param>
        /// <returns></returns>
        private OleDbParameter[] insertCardRParameters(YSCMS.Model.IDCARD uc1)
        {
        ...
        /// <param name="uc1"></param>
        /// <returns></returns>
        private OleDbParameter[] UpdateCardRParameters(YSCMS.Model.IDCARD uc1)
        {
            OleDbParameter[] param = new OleDbParameter[8];
        ...
        {
            string Sql = "Delete From  " + Pre + "user_card where SiteID = " + YSCMS.Global.Current.SiteID + "";
            DbHelper.ExecuteNonQuery(CommandType.Text, Sql, null);
        }
        public DataTable getmoneylist()
        {
            string Sql = "select DisTinct Money from " + Pre + "user_Card where isBuy=0 and isUse=0 and isLock=0 and SiteID='" + YSCMS.Global.Current.SiteID + "' and TimeOutDate>'" + DateTime.Now + "' and Money>0 order by Money asc";
            DataTable rdr = DbHelper.ExecuteTable(CommandType.Text, Sql, null);
            return rdr;
        }
        ...
        {
            string Sql = "select id,CardNumber,CardPassWord,Money,Point,TimeOutDate,isLock,isUse,isBuy From " + Pre + "user_card where id=" + ID + " and SiteID = '" + YSCMS.Global.Current.SiteID + "'";
            DataTable rdr = DbHelper.ExecuteTable(CommandType.Text, Sql, null);
            return rdr;
        }
        ...
        {
            string Sql = "select onpayType,O_userName,O_key,O_sendurl,O_returnurl,O_md5,O_other1,O_other2,O_other3 from " + Pre + "sys_PramUser where SiteID='" + YSCMS.Global.Current.SiteID + "'";
            DataTable rdr = DbHelper.ExecuteTable(CommandType.Text, Sql, null);
            return rdr;
        }
        ...
        /// </summary>
        /// <param name="uc2"></param>
        public void UpdateOnlinePay(YSCMS.Model.UserInfo6 uc2)
        {
            string Sql = "";
            string SQLTF = "select ID from " + Pre + "sys_PramUser where SiteID='" + YSCMS.Global.Current.SiteID + "'";
            DataTable dt = DbHelper.ExecuteTable(CommandType.Text, SQLTF, null);
            if (dt != null)
            {
                if (dt.Rows.Count > 0)
                {
                    Sql = "Update " + Pre + "sys_PramUser set onpayType=@onpayType,O_userName=@O_userName,o_key=@o_key,O_sendurl=@O_sendurl,O_returnurl=@O_returnurl,O_md5=@O_md5,O_other1=@O_other1,O_other2=@O_other2,O_other3=@O_other3 where SiteID='" + YSCMS.Global.Current.SiteID + "'";
                }
                else
                {
                    Sql = "Insert Into " + Pre + "sys_PramUser(onpayType,O_userName,o_key,O_sendurl,O_returnurl,O_md5,O_other1,O_other2,O_other3,SiteID) Values(@onpayType,@O_userName,@o_key,@O_sendurl,@O_returnurl,@O_md5,@O_other1,@O_other2,@O_other3,'" + YSCMS.Global.Current.SiteID + "')";
                }
            }
        ...
        /// <param name="uc1"></param>
        /// <returns></returns>
        private OleDbParameter[] UpdateOnlinePayParameters(YSCMS.Model.UserInfo6 uc1)
        {
            OleDbParameter[] param = new OleDbParameter[9];
        ...
        public int getPasswordTF(string password)
        {
            ...
            int flg = 1;
            string Sql = "select UserPassword from " + Pre + "sys_User where UserNum='" + YSCMS.Global.Current.UserNum + "' and UserPassword=@password";
            DataTable rdr = DbHelper.ExecuteTable(CommandType.Text, Sql, param);
            if (rdr != null)
            {
                if (rdr.Rows.Count > 0)
        ...
        {
            string Sql = "select isIDcard,IDcardFiles,ID from " + Pre + "sys_User where UserNum='" + YSCMS.Global.Current.UserNum + "'";
            DataTable rdr = DbHelper.ExecuteTable(CommandType.Text, Sql, null);
            return rdr;
        }
        ...
        {
            string Sql = "update  " + Pre + "sys_User set IDcardFiles='',isIDcard=0 where UserNum='" + YSCMS.Global.Current.UserNum + "'";
            DbHelper.ExecuteNonQuery(CommandType.Text, Sql, null);
        }
        ...
        public void SaveDataICard(string f_IDcardFiles)
        {
            ...
            string Sql = "update " + Pre + "sys_User set IDcardFiles=@f_IDcardFiles,isIDcard=0 where UserNum='" + YSCMS.Global.Current.UserNum + "'";
            DbHelper.ExecuteNonQuery(CommandType.Text, Sql, param);
        }
        ...
        public DataTable getConstrID(string ConID, string UserNum)
        {
            ...
            string Sql = "select ID,Title,Content,creatTime,Source,Tags,Author,PicURL from " + Pre + "user_Constr where UserNum=@UserNum and ConID=@ConID and  isuserdel=0 and SiteID='" + YSCMS.Global.Current.SiteID + "' order by id desc";
            DataTable rdr = DbHelper.ExecuteTable(CommandType.Text, Sql, param);
            return rdr;
        }
        ...
        public void updateURL(string URLName, string URL, string URLColor, string ClassID, string Content, int NUM, int ID)
        {
            ...
            if (NUM == 0)
            {
                Sql = "Insert Into " + Pre + "user_URL(URLName,URL,URLColor,ClassID,Content,CreatTime,UserNum) Values(@URLName,@URL,@URLColor,@ClassID,@Content,'" + DateTime.Now + "','" + YSCMS.Global.Current.UserNum + "')";
            }
            else
            {
                Sql = "update " + Pre + "user_URL set URLName=@URLName,URL=@URL,URLColor=@URLColor,ClassID=@ClassID,Content=@Content where id=" + ID + " and UserNum='" + YSCMS.Global.Current.UserNum + "'";
            }
            DbHelper.ExecuteNonQuery(CommandType.Text, Sql, param);
        }
        ...
        public void updateClass(string ClassName, int NUM, int ID)
        {
            ...
            if (NUM == 0)
            {
                Sql = "Insert Into " + Pre + "user_URLClass(ClassName,ParentID,UserNum) Values(@ClassName,0,'" + YSCMS.Global.Current.UserNum + "')";
            }
            else
            {
                Sql = "update " + Pre + "user_URLClass set ClassName=@ClassName where id=" + ID + " and UserNum='" + YSCMS.Global.Current.UserNum + "'";
            }
            DbHelper.ExecuteNonQuery(CommandType.Text, Sql, param);
        }
        ...
        {
            string Sql = "delete from " + Pre + "user_URL where ID =" + ID + " and UserNum='" + YSCMS.Global.Current.UserNum + "'";
            DbHelper.ExecuteNonQuery(CommandType.Text, Sql, null);
        }

        public void delclass(int ID)
        {
            string Sql = "delete from " + Pre + "user_URLClass where ID =" + ID + " and UserNum='" + YSCMS.Global.Current.UserNum + "'";
            DbHelper.ExecuteNonQuery(CommandType.Text, Sql, null);
            string Sql1 = "delete from " + Pre + "user_URL where ClassID =" + ID + " and UserNum='" + YSCMS.Global.Current.UserNum + "'";
