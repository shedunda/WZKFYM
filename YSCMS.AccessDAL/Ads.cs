...
namespace YSCMS.AccessDAL
{
    public class Ads : DbBase, IAds
    {
        ...
        /// <returns></returns>
        public DataTable list(YSCMS.Model.AdsListInfo ali)
        {
            ...
            switch (ali.type)
            {
                case "Ads":
                    switch (ali.showAdsType)
                    {
                        case "showadstype":
                            ...
                            str_Sql = "Select " + Pre + "ads.AdID," + Pre + "ads.adName," + Pre + "ads.adType," + Pre + "ads.creatTime," + Pre + "ads.CusID," + Pre + "ads.isLock,Cname From " + Pre + "ads left join " + Pre + "ads_class on  ys_ads.ClassID=ys_ads_class.AcID Where" +
                        ...
                        case "search":
                            ...
                            {
                                case "adsname":
                                    str_Sql = "Select " + Pre + "ads.AdID," + Pre + "ads.adName," + Pre + "ads.adType," + Pre + "ads.creatTime," + Pre + "ads.CusID," + Pre + "ads.isLock,Cname From " + Pre + "ads left join " + Pre + "ads_class on  ys_ads.ClassID=ys_ads_class.AcID " +
                ...
                case "Stat":
                    ...
                    break;
                case "ClassName":
                    str_Sql = "select " + Pre + "ads.AdID," + Pre + "ads.adName," + Pre + "ads.adType," + Pre + "ads.creatTime," + Pre + "ads.CusID," + Pre + "ads.isLock,Cname from " + Pre + "ads left join " + Pre + "ads_class on  ys_ads.ClassID=ys_ads_class.AcID where Cname like '%" + ali.SearchKey + "%'";
                    break;
            }
        ...
        {
            OleDbConnection Conn = new OleDbConnection(Database.YuesiConnectionString);
            Conn.Open();
        ...
        /// <returns></returns>
        public int AddClass(YSCMS.Model.AdsClassInfo aci)
        {
            string checkSql = "";
            int recordCount = 0;
        ...
        /// <param name="aci"></param>
        /// <returns></returns>
        public int EditClass(YSCMS.Model.AdsClassInfo aci)
        {
        ...
        public string adsAdd(YSCMS.Model.AdsInfo ai)
        {
            string AdID = "";
            string checkSql = "";
            int recordCount = 0;
        ...
        public int adsEdit(YSCMS.Model.AdsInfo ai)
        {
            string checkSql = "";
            int recordCount = 0;
        ...
        {
            string str_Sql = "Select gPoint From " + Pre + "sys_User Where UserNum='" + YSCMS.Global.Current.UserNum + "'";
            return DbHelper.ExecuteTable(CommandType.Text, str_Sql, null);
        }
        public void DelUserG(int Gnum)
        {
            string str_Sql = "Update " + Pre + "sys_User Set gPoint=gPoint-" + Gnum + " Where UserNum='" + YSCMS.Global.Current.UserNum + "'";
            DbHelper.ExecuteNonQuery(CommandType.Text, str_Sql, null);
        }

        private OleDbParameter[] GetAdsParameters(YSCMS.Model.AdsInfo ai)
        {
        ...
        private OleDbParameter[] GetClassParameters(YSCMS.Model.AdsClassInfo aci)
        {
