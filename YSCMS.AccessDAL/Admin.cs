...
namespace YSCMS.AccessDAL
{
    public class Admin : DbBase, IAdmin
    {
        ...
        {
            string str_Sql = "Select adminGroupNumber,GroupName From " + Pre + "sys_AdminGroup where SiteID='" + YSCMS.Global.Current.SiteID + "'";
        ...
        public DataTable GetSiteList()
        {
            ...
            if (YSCMS.Global.Current.SiteID == "0")
                ...
                str_Sql = "Select ChannelID,CName From " + Pre + "news_site Where isRecyle=0 and islock=0 and ParentID='" + YSCMS.Global.Current.SiteID + "' And IsURL=0";
            return DbHelper.ExecuteTable(CommandType.Text, str_Sql, null); ;
        }
        ...
        /// <returns></returns>
        public int Add(YSCMS.Model.AdminInfo ac)
        {
            int result = 0;
            string checkSql = "";
            int recordCount = 0;
        ...
        /// <param name="ac"></param>
        /// <returns></returns>
        public int Edit(YSCMS.Model.AdminInfo ac)
        {
            OleDbParameter[] param = GetAdminParameters(ac);
        ...
        /// <param name="ac"></param>
        /// <returns></returns>
        private OleDbParameter[] GetAdminParameters(YSCMS.Model.AdminInfo ac)
        {
        ...
        {
            string str_Sql = "Select a.ID,a.UserNum,a.isSuper,a.adminGroupNumber,b.UserName From " + Pre + "sys_admin a left join " + Pre + "sys_User b  on a.UserNum=b.UserNum Where b.isAdmin=1 and a.SiteID='" + YSCMS.Global.Current.SiteID + "' order by a.id desc";
            return DbHelper.ExecuteTable(CommandType.Text, str_Sql, null);
        }
    }
}
