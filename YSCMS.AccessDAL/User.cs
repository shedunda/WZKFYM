...
namespace YSCMS.AccessDAL
{
    public class User : DbBase, IUser
    {
        ...
        /// <returns></returns>
        private OleDbParameter[] InsertUserLogsParameters(YSCMS.Model.UserLog1 uc1)
        {
        ...
        public void UpdateUserLogs(YSCMS.Model.UserLog1 uc2)
        {
            ...
            string Sql = "update " + Pre + "user_userlogs set " + Database.GetModifyParam(parm) + " where Id=" + uc2.Id + " and userNum='" + YSCMS.Global.Current.UserNum + "' and SiteID='" + YSCMS.Global.Current.SiteID + "'";
        ...
        /// <param name="uc1"></param>
        /// <returns></returns>
        private OleDbParameter[] UpdateUserLogsParameters(YSCMS.Model.UserLog1 uc1)
        {
        ...
        private OleDbParameter[] getUserGhistory(YSCMS.Model.UserGhistory ugi)
        {
        ...
        private OleDbParameter[] getUuserfields(YSCMS.Model.UserFields ufi)
        {
        ...
        /// <returns></returns>
        public OleDbParameter[] getUserInfo(YSCMS.Model.User ui)
        {
