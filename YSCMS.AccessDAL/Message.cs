...
namespace YSCMS.AccessDAL
{
    public class Message : DbBase, IMessage
    {
        ...
        {
            OleDbParameter param = new OleDbParameter("@Mid", ID);
            string Sql = "update " + Pre + "user_Message set issDel=1 where Mid=@Mid and UserNum='" + YSCMS.Global.Current.UserNum + "'";
            DbHelper.ExecuteNonQuery(CommandType.Text, Sql, param);

            string Sql1 = "update " + Pre + "user_Message set isRdel=1 where Mid=@Mid and Rec_UserNum='" + YSCMS.Global.Current.UserNum + "'";
            DbHelper.ExecuteNonQuery(CommandType.Text, Sql1, param);

            string Sql2 = "update " + Pre + "user_Message set isRdel=1,issDel=1 where SortType=0 and Mid=@Mid and Rec_UserNum='" + YSCMS.Global.Current.UserNum + "'";
        ...
        public void Add(YSCMS.Model.message uc)
        {
        ...
        private OleDbParameter[] addParam(YSCMS.Model.message uc)
        {
