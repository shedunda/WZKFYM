...
namespace YSCMS.AccessDAL
{
    public class Discuss : DbBase, IDiscuss
    {
        ...
        public DataTable getsClasslist(string ClassID)
        {
            ...
            string Sql = "select DcID,Cname from " + Pre + "user_DiscussClass where UserNum='" + YSCMS.Global.Current.UserNum + "' " + _ClassID + " and SiteID='" + YSCMS.Global.Current.SiteID + "'";
            return DbHelper.ExecuteTable(CommandType.Text, Sql, param);
        }
        ...
        public void getsClassDel(string ID)
        {
            ...
            string Sql = "delete from " + Pre + "user_DiscussClass where UserNum='" + YSCMS.Global.Current.UserNum + "' and DcID=@DcID and SiteID='" + YSCMS.Global.Current.SiteID + "'";
        ...
        {
            OleDbParameter param = new OleDbParameter("@DcID", ID);
            string Sql = " delete " + Pre + "User_DiscussClass where DcID=@DcID and  SiteID=" + YSCMS.Global.Current.SiteID + "";
        ...
        public int Delete_2(string ID)
        {
            ...
            string Sql = "delete " + Pre + "user_Discuss where DisID=@DisID and  SiteID=" + YSCMS.Global.Current.SiteID + "";
            return (int)DbHelper.ExecuteNonQuery(CommandType.Text, Sql, param);
        }
        #endregion
        ...
        public int Delete_8(string ID)
        {
            ...
            string Sql = " delete " + Pre + "user_DiscussMember where Member=@Member and UserNum='" + YSCMS.Global.Current.UserNum + "'";
            return DbHelper.ExecuteNonQuery(CommandType.Text, Sql, param);
        }
        #endregion
        ...
        {
            OleDbParameter param = new OleDbParameter("@DisID", DisID);
            string Sql = "Select PhotoalbumName,PhotoalbumID From " + Pre + "User_Photoalbum where isDisPhotoalbum=1 And DisID=@DisID and UserName='" + YSCMS.Global.Current.UserNum + "'";
            return DbHelper.ExecuteTable(CommandType.Text, Sql, param);
        }
        #endregion
        ...
        public int Add_5(string DcID, string Cname, string Content, string indexnumber)
        {
            ...
            param[3] = new OleDbParameter("@indexnumber", OleDbType.VarWChar, 50);
            param[3].Value  = indexnumber;
            string Sql = "insert into " + Pre + "User_DiscussClass(DcID,Cname,Content,indexnumber,SiteID,UserNum) values(@DcID,@Cname,@Content,@indexnumber,'" + YSCMS.Global.Current.SiteID + "','" + YSCMS.Global.Current.UserNum + "')";
            return DbHelper.ExecuteNonQuery(CommandType.Text, Sql, param);
        }
        #endregion
        ...
        public void Add_9(YSCMS.Model.STADDDiscuss uc)
        {
        ...
        private OleDbParameter[] Add_9_Parameters(YSCMS.Model.STADDDiscuss uc1)
        {
            OleDbParameter[] param = new OleDbParameter[7];
            param[0] = new OleDbParameter("@DtID", OleDbType.VarWChar, 12);
        ...
        {
            OleDbParameter param = new OleDbParameter("@DtID", DtID);
            string Sql = "Select DtID,title,Content,creatTime,UserNum From " + Pre + "User_DiscussTopic where DtID=@DtID and UserNum='" + YSCMS.Global.Current.UserNum + "'";
            return DbHelper.ExecuteTable(CommandType.Text, Sql, param);
        }
        ...
        public void updateTopicDtID(string DtID, string title, string content)
        {
            ...
            param[2] = new OleDbParameter("@content", OleDbType.VarWChar);
            param[2].Value = content;
            string Sql = "update " + Pre + "User_DiscussTopic set title=@title,content=@content where DtID=@DtID and UserNum='" + YSCMS.Global.Current.UserNum + "'";
            DbHelper.ExecuteNonQuery(CommandType.Text, Sql, param);
        }
        #endregion
        ...
        {
            OleDbParameter param = new OleDbParameter("@DisID", DisIDs);
            string Sql = "select UserNum from " + Pre + "User_DiscussTopic where DisID=@DisID and UserNum='" + YSCMS.Global.Current.UserNum + "'";
            return DbHelper.ExecuteTable(CommandType.Text, Sql, param);
        }
        ...
        {
            OleDbParameter param = new OleDbParameter("@DtID", DtID);
            string Sql = "delete " + Pre + "User_DiscussTopic where DtID=@DtID and UserNum='" + YSCMS.Global.Current.UserNum + "'";
            return DbHelper.ExecuteNonQuery(CommandType.Text, Sql, param);
        }
