...
namespace YSCMS.AccessDAL
{
    public class Label : DbBase, ILabel
    {
        ...
        {
            string str_Sql = "Select ClassID,ClassName From " + Pre + "sys_LabelClass Where isRecyle=0 And ClassID<>'99999999' and ClassID<>'88888888' and SiteID ='" + YSCMS.Global.Current.SiteID + "'";
            DataTable dt = DbHelper.ExecuteTable(CommandType.Text, str_Sql, null);
            return dt;
        }
        ...
        private OleDbParameter[] GetLabelClassParameters(YSCMS.Model.LabelClassInfo lbcc)
        {
        ...
        private OleDbParameter[] GetLabelParameters(YSCMS.Model.LabelInfo lbc)
        {
