...
namespace YSCMS.AccessDAL
{
    public class FrindLink : DbBase, IFrindLink
    {
        ...
        {
            string Sql = "Select ClassID,ClassCName,ParentID From " + Pre + "friend_class where SiteID='" + YSCMS.Global.Current.SiteID + "'";
        ...
        public int Update_Pram(int open, int IsReg, int isLok, string Str_ArrSize, string Str_Content)//修改参数设置
        {
            ...
            string Str_InSql = "Update " + Pre + "friend_pram Set IsOpen=" + open + ",IsRegister=" + IsReg + ",isLock = " + isLok + ",ArrSize=@ArrSize,Content=@Content,SiteID=" + YSCMS.Global.Current.SiteID + "";
        ...
        public DataTable GetChildClassList(string classid)
        {
            ...
            string Str = "Select id,ClassID,ClassCName,Content,ParentID From " + Pre + "friend_class Where ParentID=@classid and SiteID='" + YSCMS.Global.Current.SiteID + "'";
        ...
        public int IsExitClassName(string Str_ClassID)
        {
            ...
            string Str = " Select count(ClassID) From " + Pre + "friend_class where ClassID=@ClassID and SiteID='" + YSCMS.Global.Current.SiteID + "'";
        ...
        public int ISExitNam(string name)
        {
            ...
            string Str_CheckSql = "Select count(ClassCName) From " + Pre + "friend_class Where ClassCName=@ClassCName and SiteID='" + YSCMS.Global.Current.SiteID + "'"; ;
        ...
        public int Insert_Class(string Str_ClassID, string Str_ClassCName, string Str_ClassEName, string Str_Description, string parentid)
        {
            ...
            string Str_InSql = "Insert into " + Pre + "friend_class (ClassID,ClassCName,ClassEName,Content,ParentID,SiteID) Values(@ClassID,@ClassCName,@ClassEName,@Content,@ParentID,'" + YSCMS.Global.Current.SiteID + "')";
            return DbHelper.ExecuteNonQuery(CommandType.Text, Str_InSql, param);
        ...
        public int Del_oneClass_1(string fid)
        {
            ...
            string Str_FriSql = "Delete From " + Pre + "friend_class where ClassID=@ClassID and SiteID='" + YSCMS.Global.Current.SiteID + "'";
        ...
        public int Del_oneClass_2(string fid)
        {
            ...
            string Str_Fri_child_Sql = "Delete From " + Pre + "friend_class where ParentID=@ParentID and SiteID='" + YSCMS.Global.Current.SiteID + "'";
        ...
        public int Del_onelink(int fid)
        {
            ...
            string Str_FriSql = "Delete From " + Pre + "friend_link where ID=@ID and SiteID='" + YSCMS.Global.Current.SiteID + "'";
            return DbHelper.ExecuteNonQuery(CommandType.Text, Str_FriSql, param);
        }
        public int Suo_onelink(int fid)
        {
            OleDbParameter param = new OleDbParameter("@id", fid);
            string Str_FriSql = "Update " + Pre + "friend_link Set Lock = 1 where id=@id and SiteID='" + YSCMS.Global.Current.SiteID + "'";
            return DbHelper.ExecuteNonQuery(CommandType.Text, Str_FriSql, param);
        }
        public int Unsuo_onelink(int fid)
        {
            OleDbParameter param = new OleDbParameter("@id", fid);
            string Str_FriSql = "Update " + Pre + "friend_link Set Lock = 0 where id=@@id and SiteID='" + YSCMS.Global.Current.SiteID + "'";
            return DbHelper.ExecuteNonQuery(CommandType.Text, Str_FriSql, param);
        }
        public DataTable EditClass(string classid)
        {
            OleDbParameter param = new OleDbParameter("@ClassID", classid);
            string Str_FriSql = "Select id,ClassID,ClassCName,ClassEName,Content,ParentID From " + Pre + "friend_class where ClassID=@ClassID and SiteID='" + YSCMS.Global.Current.SiteID + "'";
        ...
        public int EditClick(string FID, string Str_ClassNameE, string Str_EnglishE, string Str_Descript)
        {
            ...
            param[3].Value = FID;
            string Str_UpdateSql = "Update " + Pre + "friend_class Set ClassCName=@ClassCName,ClassEName=@ClassEName,Content=@Content where ClassID=@ClassID and SiteID='" + YSCMS.Global.Current.SiteID + "'";
            return DbHelper.ExecuteNonQuery(CommandType.Text, Str_UpdateSql, param);
        }
        public int DelPClass(string boxs)
        {
            string Fri_Sql = "Delete From " + Pre + "friend_class where ClassID in('" + boxs + "') and SiteID='" + YSCMS.Global.Current.SiteID + "'";
            return DbHelper.ExecuteNonQuery(CommandType.Text, Fri_Sql, null);
        }
        public int DelPClass2(string boxs)
        {
            string Str_Fri_child_Sql = "Delete From " + Pre + "friend_class where ParentID in('" + boxs + "') and SiteID='" + YSCMS.Global.Current.SiteID + "'";
            return DbHelper.ExecuteNonQuery(CommandType.Text, Str_Fri_child_Sql, null);
        }
        public int DelAllClass()
        {
            string Str_Fri_Sql = "Delete From " + Pre + "friend_class where SiteID='" + YSCMS.Global.Current.SiteID + "'";
            return DbHelper.ExecuteNonQuery(CommandType.Text, Str_Fri_Sql, null);
        }
        public int LockP_Link(string boxs)
        {
            string F_Link_Sql = "Update " + Pre + "friend_link  Set Lock=1 where id in(" + boxs + ") and SiteID='" + YSCMS.Global.Current.SiteID + "'";
            return DbHelper.ExecuteNonQuery(CommandType.Text, F_Link_Sql, null);
        }
        public int UnLockP_Link(string boxs)
        {
            string F_Link_Sql = "Update " + Pre + "friend_link  Set Lock=0 where id in(" + boxs + ") and SiteID='" + YSCMS.Global.Current.SiteID + "'";
            return DbHelper.ExecuteNonQuery(CommandType.Text, F_Link_Sql, null);
        }
        public int DelP_Link(string boxs)
        {
            string F_Link_Sql = "Delete From " + Pre + "friend_link  where id in(" + boxs + ") and SiteID='" + YSCMS.Global.Current.SiteID + "'";
            return DbHelper.ExecuteNonQuery(CommandType.Text, F_Link_Sql, null);
        }
        public int DelAll_Link()
        {
            string Str_Fri_Sql = "Delete From " + Pre + "friend_link where SiteID='" + YSCMS.Global.Current.SiteID + "'";
            return DbHelper.ExecuteNonQuery(CommandType.Text, Str_Fri_Sql, null);
        }
        public int ExistName_Link(string Str_Name)
        {
            OleDbParameter param = new OleDbParameter("@Name", Str_Name);
            string Str_CheckSql = "Select count(Name) From " + Pre + "friend_link Where Name=@Name and SiteID='" + YSCMS.Global.Current.SiteID + "'";
            return (int)DbHelper.ExecuteScalar(CommandType.Text, Str_CheckSql, param);
        }
        public int _LinkSave(string Str_Class, string Str_Name, string Str_Type, string Str_Url, string Str_Content, string Str_PicUrl, string Str_Author, string Str_Mail, string Str_ContentFor, string Str_LinkContent, string Str_Addtime, int Isuser, int isLok)
        {
            ...
            string Str_InSql = "Insert into " + Pre + "friend_link (" + Database.GetParam(param) + ",SiteID) Values(" + Database.GetAParam(param) + ",'" + YSCMS.Global.Current.SiteID + "')";
            return DbHelper.ExecuteNonQuery(CommandType.Text, Str_InSql, param);
        }
        public DataTable Start_Link(int fid)
        {
            OleDbParameter param = new OleDbParameter("@ID", fid);
            string Str_FriSql = "Select id,Name,Type,Url,Content,PicUrl,Lock,IsUser,Author,Mail,ContentFor,LinkContent,Addtime,ClassID From " + Pre + "friend_link where ID=@ID and SiteID='" + YSCMS.Global.Current.SiteID + "'";
            return DbHelper.ExecuteTable(CommandType.Text, Str_FriSql, param);
        }
        ...
        {
            string Str_FriSql = "Select UserNum From " + Pre + "sys_User where UserNum='" + YSCMS.Global.Current.UserNum + "' and isAdmin=1 and SiteID='" + YSCMS.Global.Current.SiteID + "'";
            return DbHelper.ExecuteTable(CommandType.Text, Str_FriSql, null);
        }
        public DataTable CClas(string ClassID)
        {
            OleDbParameter param = new OleDbParameter("@ClassID", ClassID);
            string Class_Sql = "Select ClassCName From " + Pre + "friend_class where ClassID=@ClassID and SiteID='" + YSCMS.Global.Current.SiteID + "'";
        ...
        public DataTable USerSess(string Authorr)
        {
            ...
            string Str_UserNum_Sql = "Select UserName,isAdmin From " + Pre + "sys_User where userNum=@Authorr and SiteID='" + YSCMS.Global.Current.SiteID + "'";
