    ...
    public partial class NewsClass : DbBase, INewsClass
    {
        ...
        public void UpdateReplaceNavi(string classID)
        {
            ...
            try
            {
                ...
                string NewsPosition = "";
                string url = "";
                string dim = YSCMS.Config.UIConfig.dirDumm;
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(YSCMS.Model.NewsClass model)
        {
        ...
        /// <param name="uc"></param>
        /// <returns></returns>
        private OleDbParameter[] GetNewsClassParameter(YSCMS.Model.NewsClass uc)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(YSCMS.Model.NewsClass model)
        {
            OleDbParameter[] parm = GetNewsClassParameter(model);
        ...
        /// 得到一个对象实体
        /// </summary>
        public YSCMS.Model.NewsClass GetModel(string ClassID)
        {
            ...
            YSCMS.Model.NewsClass model = new YSCMS.Model.NewsClass();
        ...
        {
            int row = 0;
            string Sql = "delete from " + Pre + "news where SiteID='" + YSCMS.Global.Current.SiteID + "'";
            row += DbHelper.ExecuteNonQuery(CommandType.Text, Sql, null);
            Sql = "delete from " + Pre + "news_class where SiteID='" + YSCMS.Global.Current.SiteID + "'";
            row += DbHelper.ExecuteNonQuery(CommandType.Text, Sql, null);
            return row;
        }
        ...
        public int SetClassAttribute(string classId, string classTemplet, string readNewTemplet, bool isUpdate)
        {
            ...
            if (classId.IndexOf(",") > -1)
            {
                ...
                {
                    sqlArray = "update " + Pre + "news_class set ClassTemplet='" + classTemplet + "',ReadNewsTemplet='" + readNewTemplet + "' where ClassId='" + id + "' and SiteID=" + YSCMS.Global.Current.SiteID + "'";
                    DbHelper.ExecuteNonQuery(CommandType.Text, sqlArray, null);
                }
            }
            else
            {
                sqlArray = "update " + Pre + "news_class set ClassTemplet='" + classTemplet + "',ReadNewsTemplet='" + readNewTemplet + "' where ClassId='" + classId + "' and SiteID='" + YSCMS.Global.Current.SiteID + "'";
                DbHelper.ExecuteNonQuery(CommandType.Text, sqlArray, null);
            }
            return row;
        }
        ...
        public int SetLock(string classId)
        {
            ...
            if (classId.IndexOf(",") > -1)
            {
                ...
                foreach (string id in classIds)
                {
                    sqlArray = "update " + Pre + "news_class set isLock=iif(isLock=1,0,1) where ClassId='" + id + "' and SiteID='" + YSCMS.Global.Current.SiteID + "'";
                    DbHelper.ExecuteNonQuery(CommandType.Text, sqlArray, null);
                }
            }
            else
            {
                sqlArray = "update " + Pre + "news_class set isLock=iif(isLock=1,0,1) where ClassId='" + classId + "' and SiteID='" + YSCMS.Global.Current.SiteID + "'";
                DbHelper.ExecuteNonQuery(CommandType.Text, sqlArray, null);
            }
            return row;
        }
        ...
        public int SetRecyle(string classId)
        {
            ...
            if (classId.IndexOf(",") > -1)
            {
                ...
                foreach (string id in classIds)
                {
                    sqlArray = "update " + Pre + "news_class set isRecyle=iif(isRecyle=1,0,1) where ClassId='" + id + "' and SiteID='" + YSCMS.Global.Current.SiteID + "'";
                    DbHelper.ExecuteNonQuery(CommandType.Text, sqlArray, null);
                }
            }
            else
            {
                sqlArray = "update " + Pre + "news_class set isRecyle=iif(isRecyle=1,0,1) where ClassId='" + classId + "' and SiteID='" + YSCMS.Global.Current.SiteID + "'";
                DbHelper.ExecuteNonQuery(CommandType.Text, sqlArray, null);
            }
            return row;
        }
        ...
        public int ClearNews(string classId)
        {
            ...
            if (classId.IndexOf(",") > -1)
            {
                ...
                foreach (string id in classIds)
                {
                    sqlArray = "delete from " + Pre + "news where ClassId='" + id + "' and SiteID='" + YSCMS.Global.Current.SiteID + "'";
                    DbHelper.ExecuteNonQuery(CommandType.Text, sqlArray, null);
                }
            }
            else
            {
                sqlArray = "delete from " + Pre + "news where ClassId='" + classId + "' and SiteID=" + YSCMS.Global.Current.SiteID + "'";
                DbHelper.ExecuteNonQuery(CommandType.Text, sqlArray, null);
            }
            return row;
        }
        ...
        {
            string Sql = "Select ClassID,ClassCName,ParentID From " + Pre + "news_Class where SiteID='" + YSCMS.Global.Current.SiteID + "' and IsURL=0";
            DataTable rdr = DbHelper.ExecuteTable(CommandType.Text, Sql, null);
            return rdr;
        }
        ...
        {
            string str_sql = "Delete From " + Pre + "news_Class Where ClassID='" + classID + "' and SiteID = '" + YSCMS.Global.Current.SiteID + "'";
            DbHelper.ExecuteNonQuery(CommandType.Text, str_sql, null);
        }
        ...
        public void UpdateSouce(string sClassID, string tClassID)
        {
            ...
            string str_sql = "Update " + Pre + "News Set ClassID='" + tClassID + "' Where ClassID='" + sClassID + "' and SiteID = '" + YSCMS.Global.Current.SiteID + "'";
            DbHelper.ExecuteNonQuery(CommandType.Text, str_sql, null);
        }
        ...
        {
            string str_sql = "Update " + Pre + "News_Class Set ParentID='" + tClassID + "' Where ClassID='" + sClassID + "'  and SiteID = '" + YSCMS.Global.Current.SiteID + "'";
            DbHelper.ExecuteNonQuery(CommandType.Text, str_sql, null);
        }
        ...
        {
            string Sql = "Select ClassID,ClassCname,ParentID From " + Pre + "News_Class where SiteID='" + YSCMS.Global.Current.SiteID + "' order by OrderID desc,id desc";
            DataTable rdr = DbHelper.ExecuteTable(CommandType.Text, Sql, null);
            return rdr;
        }
        ...
        {
            string Sql = "Select isLock From " + Pre + "news_Class Where ClassID='" + classID + "' and SiteID='" + YSCMS.Global.Current.SiteID + "'";
            DataTable rdr = DbHelper.ExecuteTable(CommandType.Text, Sql, null);
            return rdr;
        }
        ...
        public void UpdatePage(YSCMS.Model.NewsClass NewsClassModel)
        {
            OleDbParameter[] parm = GetNewsClassParameter(NewsClassModel);
            string Sql = "Update " + Pre + "News_Class set " + Database.GetModifyParam(parm) + ",[PageContent]='" + NewsClassModel.PageContent + "',InHitoryDay=0,ContentPicTF=0,Checkint=0,ModelID='0' where ClassID='" + NewsClassModel.ClassID + "' and SiteID='" + YSCMS.Global.Current.SiteID + "'";
        ...
        /// </summary>
        /// <param name="NewsClassModel"></param>
        public void InsertPage(YSCMS.Model.NewsClass NewsClassModel)
        {
        ...
        /// <param name="uc"></param>
        /// <returns></returns>
        private OleDbParameter[] GetPageContentParameters(YSCMS.Model.NewsClass uc)
        {
